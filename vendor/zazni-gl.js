	...
	if ( coord.x >= 1.0 ) {
...
}`,co=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){let s=new Ue,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new ue({vertexShader:Zm,fragmentShader:Jm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new he(new Ci(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},ho=class extends wn{constructor(t,e){super();let n=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,f=null,p=null,g=null,_=new co,m=e.getContextAttributes(),d=null,T=null,b=[],M=[],O=new rt,C=null,R=new Me;R.viewport=new ae;let N=new Me;N.viewport=new ae;let E=[R,N],y=new lo,A=null,Z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(z){let K=b[z];return K===void 0&&(K=new qi,b[z]=K),K.getTargetRaySpace()},this.getControllerGrip=function(z){let K=b[z];return K===void 0&&(K=new qi,b[z]=K),K.getGripSpace()},this.getHand=function(z){let K=b[z];return K===void 0&&(K=new qi,b[z]=K),K.getHandSpace()};function H(z){let K=M.indexOf(z.inputSource);if(K===-1)return;let ft=b[K];ft!==void 0&&(ft.update(z.inputSource,z.frame,c||a),ft.dispatchEvent({type:z.type,data:z.inputSource}))}function G(){s.removeEventListener("select",H),s.removeEventListener("selectstart",H),s.removeEventListener("selectend",H),s.removeEventListener("squeeze",H),s.removeEventListener("squeezestart",H),s.removeEventListener("squeezeend",H),s.removeEventListener("end",G),s.removeEventListener("inputsourceschange",j);for(let z=0;z<b.length;z++){let K=M[z];K!==null&&(M[z]=null,b[z].disconnect(K))}A=null,Z=null,_.reset(),t.setRenderTarget(d),p=null,f=null,u=null,s=null,T=null,Pt.stop(),n.isPresenting=!1,t.setPixelRatio(C),t.setSize(O.width,O.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(z){r=z,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(z){o=z,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(z){c=z},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return u},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(z){if(s=z,s!==null){if(d=t.getRenderTarget(),s.addEventListener("select",H),s.addEventListener("selectstart",H),s.addEventListener("selectend",H),s.addEventListener("squeeze",H),s.addEventListener("squeezestart",H),s.addEventListener("squeezeend",H),s.addEventListener("end",G),s.addEventListener("inputsourceschange",j),m.xrCompatible!==!0&&await e.makeXRCompatible(),C=t.getPixelRatio(),t.getSize(O),s.renderState.layers===void 0){let K={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,e,K),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),T=new be(p.framebufferWidth,p.framebufferHeight,{format:We,type:un,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil})}else{let K=null,ft=null,at=null;m.depth&&(at=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,K=m.stencil?wi:vi,ft=m.stencil?Ti:Wn);let Ct={colorFormat:e.RGBA8,depthFormat:at,scaleFactor:r};u=new XRWebGLBinding(s,e),f=u.createProjectionLayer(Ct),s.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),T=new be(f.textureWidth,f.textureHeight,{format:We,type:un,depthTexture:new er(f.textureWidth,f.textureHeight,ft,void 0,void 0,void 0,void 0,void 0,void 0,K),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),Pt.setContext(s),Pt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function j(z){for(let K=0;K<z.removed.length;K++){let ft=z.removed[K],at=M.indexOf(ft);at>=0&&(M[at]=null,b[at].disconnect(ft))}for(let K=0;K<z.added.length;K++){let ft=z.added[K],at=M.indexOf(ft);if(at===-1){for(let Lt=0;Lt<b.length;Lt++)if(Lt>=M.length){M.push(ft),at=Lt;break}else if(M[Lt]===null){M[Lt]=ft,at=Lt;break}if(at===-1)break}let Ct=b[at];Ct&&Ct.connect(ft)}}let W=new I,B=new I;function U(z,K,ft){W.setFromMatrixPosition(K.matrixWorld),B.setFromMatrixPosition(ft.matrixWorld);let at=W.distanceTo(B),Ct=K.projectionMatrix.elements,Lt=ft.projectionMatrix.elements,It=Ct[14]/(Ct[10]-1),Gt=Ct[14]/(Ct[10]+1),$=(Ct[9]+1)/Ct[5],it=(Ct[9]-1)/Ct[5],w=(Ct[8]-1)/Ct[0],At=(Lt[8]+1)/Lt[0],nt=It*w,yt=It*At,ct=at/(-w+At),Dt=ct*-w;if(K.matrixWorld.decompose(z.position,z.quaternion,z.scale),z.translateX(Dt),z.translateZ(ct),z.matrixWorld.compose(z.position,z.quaternion,z.scale),z.matrixWorldInverse.copy(z.matrixWorld).invert(),Ct[10]===-1)z.projectionMatrix.copy(K.projectionMatrix),z.projectionMatrixInverse.copy(K.projectionMatrixInverse);else{let xt=It+ct,S=Gt+ct,x=nt-Dt,F=yt+(at-Dt),q=$*Gt/S*xt,tt=it*Gt/S*xt;z.projectionMatrix.makePerspective(x,F,q,tt,xt,S),z.projectionMatrixInverse.copy(z.projectionMatrix).invert()}}function J(z,K){K===null?z.matrixWorld.copy(z.matrix):z.matrixWorld.multiplyMatrices(K.matrixWorld,z.matrix),z.matrixWorldInverse.copy(z.matrixWorld).invert()}this.updateCamera=function(z){if(s===null)return;let K=z.near,ft=z.far;_.texture!==null&&(_.depthNear>0&&(K=_.depthNear),_.depthFar>0&&(ft=_.depthFar)),y.near=N.near=R.near=K,y.far=N.far=R.far=ft,(A!==y.near||Z!==y.far)&&(s.updateRenderState({depthNear:y.near,depthFar:y.far}),A=y.near,Z=y.far),R.layers.mask=z.layers.mask|2,N.layers.mask=z.layers.mask|4,y.layers.mask=R.layers.mask|N.layers.mask;let at=z.parent,Ct=y.cameras;J(y,at);for(let Lt=0;Lt<Ct.length;Lt++)J(Ct[Lt],at);Ct.length===2?U(y,R,N):y.projectionMatrix.copy(R.projectionMatrix),et(z,y,at)};function et(z,K,ft){ft===null?z.matrix.copy(K.matrixWorld):(z.matrix.copy(ft.matrixWorld),z.matrix.invert(),z.matrix.multiply(K.matrixWorld)),z.matrix.decompose(z.position,z.quaternion,z.scale),z.updateMatrixWorld(!0),z.projectionMatrix.copy(K.projectionMatrix),z.projectionMatrixInverse.copy(K.projectionMatrixInverse),z.isPerspectiveCamera&&(z.fov=$i*2*Math.atan(1/z.projectionMatrix.elements[5]),z.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(z){l=z,f!==null&&(f.fixedFoveation=z),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=z)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(y)};let lt=null;function _t(z,K){if(h=K.getViewerPose(c||a),g=K,h!==null){let ft=h.views;p!==null&&(t.setRenderTargetFramebuffer(T,p.framebuffer),t.setRenderTarget(T));let at=!1;ft.length!==y.cameras.length&&(y.cameras.length=0,at=!0);for(let Lt=0;Lt<ft.length;Lt++){let It=ft[Lt],Gt=null;if(p!==null)Gt=p.getViewport(It);else{let it=u.getViewSubImage(f,It);Gt=it.viewport,Lt===0&&(t.setRenderTargetTextures(T,it.colorTexture,f.ignoreDepthValues?void 0:it.depthStencilTexture),t.setRenderTarget(T))}let $=E[Lt];$===void 0&&($=new Me,$.layers.enable(Lt),$.viewport=new ae,E[Lt]=$),$.matrix.fromArray(It.transform.matrix),$.matrix.decompose($.position,$.quaternion,$.scale),$.projectionMatrix.fromArray(It.projectionMatrix),$.projectionMatrixInverse.copy($.projectionMatrix).invert(),$.viewport.set(Gt.x,Gt.y,Gt.width,Gt.height),Lt===0&&(y.matrix.copy($.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),at===!0&&y.cameras.push($)}let Ct=s.enabledFeatures;if(Ct&&Ct.includes("depth-sensing")){let Lt=u.getDepthInformation(ft[0]);Lt&&Lt.isValid&&Lt.texture&&_.init(t,Lt,s.renderState)}}for(let ft=0;ft<b.length;ft++){let at=M[ft],Ct=b[ft];at!==null&&Ct!==void 0&&Ct.update(at,K,c||a)}lt&&lt(z,K),K.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:K}),g=null}let Pt=new Fc;Pt.setAnimationLoop(_t),this.setAnimationLoop=function(z){lt=z},this.dispose=function(){}}},On=new dn,$m=new re;nr=class{constructor(t={}){let{canvas:e=nu(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reverseDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=a;let g=new Uint32Array(4),_=new Int32Array(4),m=null,d=null,T=[],b=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=De,this.toneMapping=bn,this.toneMappingExposure=1;let M=this,O=!1,C=0,R=0,N=null,E=-1,y=null,A=new ae,Z=new ae,H=null,G=new Ot(0),j=0,W=e.width,B=e.height,U=1,J=null,et=null,lt=new ae(0,0,W,B),_t=new ae(0,0,W,B),Pt=!1,z=new js,K=!1,ft=!1,at=new re,Ct=new re,Lt=new I,It=new ae,Gt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},$=!1;function it(){return N===null?U:1}let w=n;function At(v,L){return e.getContext(v,L)}try{let v={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine","three.js r170"),e.addEventListener("webglcontextlost",Q,!1),e.addEventListener("webglcontextrestored",gt,!1),e.addEventListener("webglcontextcreationerror",pt,!1),w===null){let L="webgl2";if(w=At(L,v),w===null)throw At(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw console.error("THREE.WebGLRenderer: "+v.message),v}let nt,yt,ct,Dt,xt,S,x,F,q,tt,Y,bt,ut,vt,Wt,st,Mt,Ut,Nt,St,qt,kt,Qt,P;function dt(){nt=new pp(w),nt.init(),kt=new qm(w,nt),yt=new lp(w,nt,t,kt),ct=new Gm(w,nt),yt.reverseDepthBuffer&&f&&ct.buffers.depth.setReversed(!0),Dt=new _p(w),xt=new Pm,S=new Xm(w,nt,ct,xt,yt,kt,Dt),x=new hp(M),F=new fp(M),q=new bu(w),Qt=new ap(w,q),tt=new mp(w,q,Dt,Qt),Y=new vp(w,tt,q,Dt),Nt=new xp(w,yt,S),st=new cp(xt),bt=new Rm(M,x,F,nt,yt,Qt,st),ut=new Km(M,xt),vt=new Lm,Wt=new Bm(nt),Ut=new rp(M,x,F,ct,Y,p,l),Mt=new km(M,Y,yt),P=new Qm(w,Dt,yt,ct),St=new op(w,nt,Dt),qt=new gp(w,nt,Dt),Dt.programs=bt.programs,M.capabilities=yt,M.extensions=nt,M.properties=xt,M.renderLists=vt,M.shadowMap=Mt,M.state=ct,M.info=Dt}dt();let X=new ho(M,w);this.xr=X,this.getContext=function(){return w},this.getContextAttributes=function(){return w.getContextAttributes()},this.forceContextLoss=function(){let v=nt.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){let v=nt.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return U},this.setPixelRatio=function(v){v!==void 0&&(U=v,this.setSize(W,B,!1))},this.getSize=function(v){return v.set(W,B)},this.setSize=function(v,L,V=!0){if(X.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}W=v,B=L,e.width=Math.floor(v*U),e.height=Math.floor(L*U),V===!0&&(e.style.width=v+"px",e.style.height=L+"px"),this.setViewport(0,0,v,L)},this.getDrawingBufferSize=function(v){return v.set(W*U,B*U).floor()},this.setDrawingBufferSize=function(v,L,V){W=v,B=L,U=V,e.width=Math.floor(v*V),e.height=Math.floor(L*V),this.setViewport(0,0,v,L)},this.getCurrentViewport=function(v){return v.copy(A)},this.getViewport=function(v){return v.copy(lt)},this.setViewport=function(v,L,V,k){v.isVector4?lt.set(v.x,v.y,v.z,v.w):lt.set(v,L,V,k),ct.viewport(A.copy(lt).multiplyScalar(U).round())},this.getScissor=function(v){return v.copy(_t)},this.setScissor=function(v,L,V,k){v.isVector4?_t.set(v.x,v.y,v.z,v.w):_t.set(v,L,V,k),ct.scissor(Z.copy(_t).multiplyScalar(U).round())},this.getScissorTest=function(){return Pt},this.setScissorTest=function(v){ct.setScissorTest(Pt=v)},this.setOpaqueSort=function(v){J=v},this.setTransparentSort=function(v){et=v},this.getClearColor=function(v){return v.copy(Ut.getClearColor())},this.setClearColor=function(){Ut.setClearColor.apply(Ut,arguments)},this.getClearAlpha=function(){return Ut.getClearAlpha()},this.setClearAlpha=function(){Ut.setClearAlpha.apply(Ut,arguments)},this.clear=function(v=!0,L=!0,V=!0){let k=0;if(v){let D=!1;if(N!==null){let ot=N.texture.format;D=ot===Wo||ot===Go||ot===Ho}if(D){let ot=N.texture.type,mt=ot===un||ot===Wn||ot===Ji||ot===Ti||ot===Vo||ot===ko,Et=Ut.getClearColor(),Tt=Ut.getClearAlpha(),Ft=Et.r,zt=Et.g,wt=Et.b;mt?(g[0]=Ft,g[1]=zt,g[2]=wt,g[3]=Tt,w.clearBufferuiv(w.COLOR,0,g)):(_[0]=Ft,_[1]=zt,_[2]=wt,_[3]=Tt,w.clearBufferiv(w.COLOR,0,_))}else k|=w.COLOR_BUFFER_BIT}L&&(k|=w.DEPTH_BUFFER_BIT),V&&(k|=w.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),w.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Q,!1),e.removeEventListener("webglcontextrestored",gt,!1),e.removeEventListener("webglcontextcreationerror",pt,!1),vt.dispose(),Wt.dispose(),xt.dispose(),x.dispose(),F.dispose(),Y.dispose(),Qt.dispose(),P.dispose(),bt.dispose(),X.dispose(),X.removeEventListener("sessionstart",el),X.removeEventListener("sessionend",nl),In.stop()};function Q(v){v.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),O=!0}function gt(){console.log("THREE.WebGLRenderer: Context Restored."),O=!1;let v=Dt.autoReset,L=Mt.enabled,V=Mt.autoUpdate,k=Mt.needsUpdate,D=Mt.type;dt(),Dt.autoReset=v,Mt.enabled=L,Mt.autoUpdate=V,Mt.needsUpdate=k,Mt.type=D}function pt(v){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function Bt(v){let L=v.target;L.removeEventListener("dispose",Bt),se(L)}function se(v){ge(v),xt.remove(v)}function ge(v){let L=xt.get(v).programs;L!==void 0&&(L.forEach(function(V){bt.releaseProgram(V)}),v.isShaderMaterial&&bt.releaseShaderCache(v))}this.renderBufferDirect=function(v,L,V,k,D,ot){L===null&&(L=Gt);let mt=D.isMesh&&D.matrixWorld.determinant()<0,Et=th(v,L,V,k,D);ct.setMaterial(k,mt);let Tt=V.index,Ft=1;if(k.wireframe===!0){if(Tt=tt.getWireframeAttribute(V),Tt===void 0)return;Ft=2}let zt=V.drawRange,wt=V.attributes.position,Yt=zt.start*Ft,jt=(zt.start+zt.count)*Ft;ot!==null&&(Yt=Math.max(Yt,ot.start*Ft),jt=Math.min(jt,(ot.start+ot.count)*Ft)),Tt!==null?(Yt=Math.max(Yt,0),jt=Math.min(jt,Tt.count)):wt!=null&&(Yt=Math.max(Yt,0),jt=Math.min(jt,wt.count));let te=jt-Yt;if(te<0||te===1/0)return;Qt.setup(D,k,Et,V,Tt);let Ee,Zt=St;if(Tt!==null&&(Ee=q.get(Tt),Zt=qt,Zt.setIndex(Ee)),D.isMesh)k.wireframe===!0?(ct.setLineWidth(k.wireframeLinewidth*it()),Zt.setMode(w.LINES)):Zt.setMode(w.TRIANGLES);else if(D.isLine){let Rt=k.linewidth;Rt===void 0&&(Rt=1),ct.setLineWidth(Rt*it()),D.isLineSegments?Zt.setMode(w.LINES):D.isLineLoop?Zt.setMode(w.LINE_LOOP):Zt.setMode(w.LINE_STRIP)}else D.isPoints?Zt.setMode(w.POINTS):D.isSprite&&Zt.setMode(w.TRIANGLES);if(D.isBatchedMesh)if(D._multiDrawInstances!==null)Zt.renderMultiDrawInstances(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount,D._multiDrawInstances);else if(nt.get("WEBGL_multi_draw"))Zt.renderMultiDraw(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount);else{let Rt=D._multiDrawStarts,je=D._multiDrawCounts,Jt=D._multiDrawCount,Be=Tt?q.get(Tt).bytesPerElement:1,jn=xt.get(k).currentProgram.getUniforms();for(let we=0;we<Jt;we++)jn.setValue(w,"_gl_DrawID",we),Zt.render(Rt[we]/Be,je[we])}else if(D.isInstancedMesh)Zt.renderInstances(Yt,te,D.count);else if(V.isInstancedBufferGeometry){let Rt=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,je=Math.min(V.instanceCount,Rt);Zt.renderInstances(Yt,te,je)}else Zt.render(Yt,te)};function Kt(v,L,V){v.transparent===!0&&v.side===Ge&&v.forceSinglePass===!1?(v.side=Te,v.needsUpdate=!0,os(v,L,V),v.side=Tn,v.needsUpdate=!0,os(v,L,V),v.side=Ge):os(v,L,V)}this.compile=function(v,L,V=null){V===null&&(V=v),d=Wt.get(V),d.init(L),b.push(d),V.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(d.pushLight(D),D.castShadow&&d.pushShadow(D))}),v!==V&&v.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(d.pushLight(D),D.castShadow&&d.pushShadow(D))}),d.setupLights();let k=new Set;return v.traverse(function(D){if(!(D.isMesh||D.isPoints||D.isLine||D.isSprite))return;let ot=D.material;if(ot)if(Array.isArray(ot))for(let mt=0;mt<ot.length;mt++){let Et=ot[mt];Kt(Et,V,D),k.add(Et)}else Kt(ot,V,D),k.add(ot)}),b.pop(),d=null,k},this.compileAsync=function(v,L,V=null){let k=this.compile(v,L,V);return new Promise(D=>{function ot(){if(k.forEach(function(mt){xt.get(mt).currentProgram.isReady()&&k.delete(mt)}),k.size===0){D(v);return}setTimeout(ot,10)}nt.get("KHR_parallel_shader_compile")!==null?ot():setTimeout(ot,10)})};let Oe=null;function Qe(v){Oe&&Oe(v)}function el(){In.stop()}function nl(){In.start()}let In=new Fc;In.setAnimationLoop(Qe),typeof self<"u"&&In.setContext(self),this.setAnimationLoop=function(v){Oe=v,X.setAnimationLoop(v),v===null?In.stop():In.start()},X.addEventListener("sessionstart",el),X.addEventListener("sessionend",nl),this.render=function(v,L){if(L!==void 0&&L.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(O===!0)return;if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),X.enabled===!0&&X.isPresenting===!0&&(X.cameraAutoUpdate===!0&&X.updateCamera(L),L=X.getCamera()),v.isScene===!0&&v.onBeforeRender(M,v,L,N),d=Wt.get(v,b.length),d.init(L),b.push(d),Ct.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),z.setFromProjectionMatrix(Ct),ft=this.localClippingEnabled,K=st.init(this.clippingPlanes,ft),m=vt.get(v,T.length),m.init(),T.push(m),X.enabled===!0&&X.isPresenting===!0){let ot=M.xr.getDepthSensingMesh();ot!==null&&Pr(ot,L,-1/0,M.sortObjects)}Pr(v,L,0,M.sortObjects),m.finish(),M.sortObjects===!0&&m.sort(J,et),$=X.enabled===!1||X.isPresenting===!1||X.hasDepthSensing()===!1,$&&Ut.addToRenderList(m,v),this.info.render.frame++,K===!0&&st.beginShadows();let V=d.state.shadowsArray;Mt.render(V,v,L),K===!0&&st.endShadows(),this.info.autoReset===!0&&this.info.reset();let k=m.opaque,D=m.transmissive;if(d.setupLights(),L.isArrayCamera){let ot=L.cameras;if(D.length>0)for(let mt=0,Et=ot.length;mt<Et;mt++){let Tt=ot[mt];sl(k,D,v,Tt)}$&&Ut.render(v);for(let mt=0,Et=ot.length;mt<Et;mt++){let Tt=ot[mt];il(m,v,Tt,Tt.viewport)}}else D.length>0&&sl(k,D,v,L),$&&Ut.render(v),il(m,v,L);N!==null&&(S.updateMultisampleRenderTarget(N),S.updateRenderTargetMipmap(N)),v.isScene===!0&&v.onAfterRender(M,v,L),Qt.resetDefaultState(),E=-1,y=null,b.pop(),b.length>0?(d=b[b.length-1],K===!0&&st.setGlobalState(M.clippingPlanes,d.state.camera)):d=null,T.pop(),T.length>0?m=T[T.length-1]:m=null};function Pr(v,L,V,k){if(v.visible===!1)return;if(v.layers.test(L.layers)){if(v.isGroup)V=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(L);else if(v.isLight)d.pushLight(v),v.castShadow&&d.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||z.intersectsSprite(v)){k&&It.setFromMatrixPosition(v.matrixWorld).applyMatrix4(Ct);let mt=Y.update(v),Et=v.material;Et.visible&&m.push(v,mt,Et,V,It.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||z.intersectsObject(v))){let mt=Y.update(v),Et=v.material;if(k&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),It.copy(v.boundingSphere.center)):(mt.boundingSphere===null&&mt.computeBoundingSphere(),It.copy(mt.boundingSphere.center)),It.applyMatrix4(v.matrixWorld).applyMatrix4(Ct)),Array.isArray(Et)){let Tt=mt.groups;for(let Ft=0,zt=Tt.length;Ft<zt;Ft++){let wt=Tt[Ft],Yt=Et[wt.materialIndex];Yt&&Yt.visible&&m.push(v,mt,Yt,V,It.z,wt)}}else Et.visible&&m.push(v,mt,Et,V,It.z,null)}}let ot=v.children;for(let mt=0,Et=ot.length;mt<Et;mt++)Pr(ot[mt],L,V,k)}function il(v,L,V,k){let D=v.opaque,ot=v.transmissive,mt=v.transparent;d.setupLightsView(V),K===!0&&st.setGlobalState(M.clippingPlanes,V),k&&ct.viewport(A.copy(k)),D.length>0&&as(D,L,V),ot.length>0&&as(ot,L,V),mt.length>0&&as(mt,L,V),ct.buffers.depth.setTest(!0),ct.buffers.depth.setMask(!0),ct.buffers.color.setMask(!0),ct.setPolygonOffset(!1)}function sl(v,L,V,k){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[k.id]===void 0&&(d.state.transmissionRenderTarget[k.id]=new be(1,1,{generateMipmaps:!0,type:nt.has("EXT_color_buffer_half_float")||nt.has("EXT_color_buffer_float")?Ye:un,minFilter:Gn,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Xt.workingColorSpace}));let ot=d.state.transmissionRenderTarget[k.id],mt=k.viewport||A;ot.setSize(mt.z,mt.w);let Et=M.getRenderTarget();M.setRenderTarget(ot),M.getClearColor(G),j=M.getClearAlpha(),j<1&&M.setClearColor(16777215,.5),M.clear(),$&&Ut.render(V);let Tt=M.toneMapping;M.toneMapping=bn;let Ft=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),d.setupLightsView(k),K===!0&&st.setGlobalState(M.clippingPlanes,k),as(v,V,k),S.updateMultisampleRenderTarget(ot),S.updateRenderTargetMipmap(ot),nt.has("WEBGL_multisampled_render_to_texture")===!1){let zt=!1;for(let wt=0,Yt=L.length;wt<Yt;wt++){let jt=L[wt],te=jt.object,Ee=jt.geometry,Zt=jt.material,Rt=jt.group;if(Zt.side===Ge&&te.layers.test(k.layers)){let je=Zt.side;Zt.side=Te,Zt.needsUpdate=!0,rl(te,V,k,Ee,Zt,Rt),Zt.side=je,Zt.needsUpdate=!0,zt=!0}}zt===!0&&(S.updateMultisampleRenderTarget(ot),S.updateRenderTargetMipmap(ot))}M.setRenderTarget(Et),M.setClearColor(G,j),Ft!==void 0&&(k.viewport=Ft),M.toneMapping=Tt}function as(v,L,V){let k=L.isScene===!0?L.overrideMaterial:null;for(let D=0,ot=v.length;D<ot;D++){let mt=v[D],Et=mt.object,Tt=mt.geometry,Ft=k===null?mt.material:k,zt=mt.group;Et.layers.test(V.layers)&&rl(Et,L,V,Tt,Ft,zt)}}function rl(v,L,V,k,D,ot){v.onBeforeRender(M,L,V,k,D,ot),v.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),D.onBeforeRender(M,L,V,k,v,ot),D.transparent===!0&&D.side===Ge&&D.forceSinglePass===!1?(D.side=Te,D.needsUpdate=!0,M.renderBufferDirect(V,L,k,D,v,ot),D.side=Tn,D.needsUpdate=!0,M.renderBufferDirect(V,L,k,D,v,ot),D.side=Ge):M.renderBufferDirect(V,L,k,D,v,ot),v.onAfterRender(M,L,V,k,D,ot)}function os(v,L,V){L.isScene!==!0&&(L=Gt);let k=xt.get(v),D=d.state.lights,ot=d.state.shadowsArray,mt=D.state.version,Et=bt.getParameters(v,D.state,ot,L,V),Tt=bt.getProgramCacheKey(Et),Ft=k.programs;k.environment=v.isMeshStandardMaterial?L.environment:null,k.fog=L.fog,k.envMap=(v.isMeshStandardMaterial?F:x).get(v.envMap||k.environment),k.envMapRotation=k.environment!==null&&v.envMap===null?L.environmentRotation:v.envMapRotation,Ft===void 0&&(v.addEventListener("dispose",Bt),Ft=new Map,k.programs=Ft);let zt=Ft.get(Tt);if(zt!==void 0){if(k.currentProgram===zt&&k.lightsStateVersion===mt)return ol(v,Et),zt}else Et.uniforms=bt.getUniforms(v),v.onBeforeCompile(Et,M),zt=bt.acquireProgram(Et,Tt),Ft.set(Tt,zt),k.uniforms=Et.uniforms;let wt=k.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(wt.clippingPlanes=st.uniform),ol(v,Et),k.needsLights=nh(v),k.lightsStateVersion=mt,k.needsLights&&(wt.ambientLightColor.value=D.state.ambient,wt.lightProbe.value=D.state.probe,wt.directionalLights.value=D.state.directional,wt.directionalLightShadows.value=D.state.directionalShadow,wt.spotLights.value=D.state.spot,wt.spotLightShadows.value=D.state.spotShadow,wt.rectAreaLights.value=D.state.rectArea,wt.ltc_1.value=D.state.rectAreaLTC1,wt.ltc_2.value=D.state.rectAreaLTC2,wt.pointLights.value=D.state.point,wt.pointLightShadows.value=D.state.pointShadow,wt.hemisphereLights.value=D.state.hemi,wt.directionalShadowMap.value=D.state.directionalShadowMap,wt.directionalShadowMatrix.value=D.state.directionalShadowMatrix,wt.spotShadowMap.value=D.state.spotShadowMap,wt.spotLightMatrix.value=D.state.spotLightMatrix,wt.spotLightMap.value=D.state.spotLightMap,wt.pointShadowMap.value=D.state.pointShadowMap,wt.pointShadowMatrix.value=D.state.pointShadowMatrix),k.currentProgram=zt,k.uniformsList=null,zt}function al(v){if(v.uniformsList===null){let L=v.currentProgram.getUniforms();v.uniformsList=Mi.seqWithValue(L.seq,v.uniforms)}return v.uniformsList}function ol(v,L){let V=xt.get(v);V.outputColorSpace=L.outputColorSpace,V.batching=L.batching,V.batchingColor=L.batchingColor,V.instancing=L.instancing,V.instancingColor=L.instancingColor,V.instancingMorph=L.instancingMorph,V.skinning=L.skinning,V.morphTargets=L.morphTargets,V.morphNormals=L.morphNormals,V.morphColors=L.morphColors,V.morphTargetsCount=L.morphTargetsCount,V.numClippingPlanes=L.numClippingPlanes,V.numIntersection=L.numClipIntersection,V.vertexAlphas=L.vertexAlphas,V.vertexTangents=L.vertexTangents,V.toneMapping=L.toneMapping}function th(v,L,V,k,D){L.isScene!==!0&&(L=Gt),S.resetTextureUnits();let ot=L.fog,mt=k.isMeshStandardMaterial?L.environment:null,Et=N===null?M.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:Ii,Tt=(k.isMeshStandardMaterial?F:x).get(k.envMap||mt),Ft=k.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,zt=!!V.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),wt=!!V.morphAttributes.position,Yt=!!V.morphAttributes.normal,jt=!!V.morphAttributes.color,te=bn;k.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(te=M.toneMapping);let Ee=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,Zt=Ee!==void 0?Ee.length:0,Rt=xt.get(k),je=d.state.lights;if(K===!0&&(ft===!0||v!==y)){let Ie=v===y&&k.id===E;st.setState(k,v,Ie)}let Jt=!1;k.version===Rt.__version?(Rt.needsLights&&Rt.lightsStateVersion!==je.state.version||Rt.outputColorSpace!==Et||D.isBatchedMesh&&Rt.batching===!1||!D.isBatchedMesh&&Rt.batching===!0||D.isBatchedMesh&&Rt.batchingColor===!0&&D.colorTexture===null||D.isBatchedMesh&&Rt.batchingColor===!1&&D.colorTexture!==null||D.isInstancedMesh&&Rt.instancing===!1||!D.isInstancedMesh&&Rt.instancing===!0||D.isSkinnedMesh&&Rt.skinning===!1||!D.isSkinnedMesh&&Rt.skinning===!0||D.isInstancedMesh&&Rt.instancingColor===!0&&D.instanceColor===null||D.isInstancedMesh&&Rt.instancingColor===!1&&D.instanceColor!==null||D.isInstancedMesh&&Rt.instancingMorph===!0&&D.morphTexture===null||D.isInstancedMesh&&Rt.instancingMorph===!1&&D.morphTexture!==null||Rt.envMap!==Tt||k.fog===!0&&Rt.fog!==ot||Rt.numClippingPlanes!==void 0&&(Rt.numClippingPlanes!==st.numPlanes||Rt.numIntersection!==st.numIntersection)||Rt.vertexAlphas!==Ft||Rt.vertexTangents!==zt||Rt.morphTargets!==wt||Rt.morphNormals!==Yt||Rt.morphColors!==jt||Rt.toneMapping!==te||Rt.morphTargetsCount!==Zt)&&(Jt=!0):(Jt=!0,Rt.__version=k.version);let Be=Rt.currentProgram;Jt===!0&&(Be=os(k,L,D));let jn=!1,we=!1,Ni=!1,ee=Be.getUniforms(),Ze=Rt.uniforms;if(ct.useProgram(Be.program)&&(jn=!0,we=!0,Ni=!0),k.id!==E&&(E=k.id,we=!0),jn||y!==v){ct.buffers.depth.getReversed()?(at.copy(v.projectionMatrix),su(at),ru(at),ee.setValue(w,"projectionMatrix",at)):ee.setValue(w,"projectionMatrix",v.projectionMatrix),ee.setValue(w,"viewMatrix",v.matrixWorldInverse);let pn=ee.map.cameraPosition;pn!==void 0&&pn.setValue(w,Lt.setFromMatrixPosition(v.matrixWorld)),yt.logarithmicDepthBuffer&&ee.setValue(w,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&ee.setValue(w,"isOrthographic",v.isOrthographicCamera===!0),y!==v&&(y=v,we=!0,Ni=!0)}if(D.isSkinnedMesh){ee.setOptional(w,D,"bindMatrix"),ee.setOptional(w,D,"bindMatrixInverse");let Ie=D.skeleton;Ie&&(Ie.boneTexture===null&&Ie.computeBoneTexture(),ee.setValue(w,"boneTexture",Ie.boneTexture,S))}D.isBatchedMesh&&(ee.setOptional(w,D,"batchingTexture"),ee.setValue(w,"batchingTexture",D._matricesTexture,S),ee.setOptional(w,D,"batchingIdTexture"),ee.setValue(w,"batchingIdTexture",D._indirectTexture,S),ee.setOptional(w,D,"batchingColorTexture"),D._colorsTexture!==null&&ee.setValue(w,"batchingColorTexture",D._colorsTexture,S));let Fi=V.morphAttributes;if((Fi.position!==void 0||Fi.normal!==void 0||Fi.color!==void 0)&&Nt.update(D,V,Be),(we||Rt.receiveShadow!==D.receiveShadow)&&(Rt.receiveShadow=D.receiveShadow,ee.setValue(w,"receiveShadow",D.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(Ze.envMap.value=Tt,Ze.flipEnvMap.value=Tt.isCubeTexture&&Tt.isRenderTargetTexture===!1?-1:1),k.isMeshStandardMaterial&&k.envMap===null&&L.environment!==null&&(Ze.envMapIntensity.value=L.environmentIntensity),we&&(ee.setValue(w,"toneMappingExposure",M.toneMappingExposure),Rt.needsLights&&eh(Ze,Ni),ot&&k.fog===!0&&ut.refreshFogUniforms(Ze,ot),ut.refreshMaterialUniforms(Ze,k,U,B,d.state.transmissionRenderTarget[v.id]),Mi.upload(w,al(Rt),Ze,S)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(Mi.upload(w,al(Rt),Ze,S),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&ee.setValue(w,"center",D.center),ee.setValue(w,"modelViewMatrix",D.modelViewMatrix),ee.setValue(w,"normalMatrix",D.normalMatrix),ee.setValue(w,"modelMatrix",D.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){let Ie=k.uniformsGroups;for(let pn=0,mn=Ie.length;pn<mn;pn++){let ll=Ie[pn];P.update(ll,Be),P.bind(ll,Be)}}return Be}function eh(v,L){v.ambientLightColor.needsUpdate=L,v.lightProbe.needsUpdate=L,v.directionalLights.needsUpdate=L,v.directionalLightShadows.needsUpdate=L,v.pointLights.needsUpdate=L,v.pointLightShadows.needsUpdate=L,v.spotLights.needsUpdate=L,v.spotLightShadows.needsUpdate=L,v.rectAreaLights.needsUpdate=L,v.hemisphereLights.needsUpdate=L}function nh(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(v,L,V){xt.get(v.texture).__webglTexture=L,xt.get(v.depthTexture).__webglTexture=V;let k=xt.get(v);k.__hasExternalTextures=!0,k.__autoAllocateDepthBuffer=V===void 0,k.__autoAllocateDepthBuffer||nt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),k.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(v,L){let V=xt.get(v);V.__webglFramebuffer=L,V.__useDefaultFramebuffer=L===void 0},this.setRenderTarget=function(v,L=0,V=0){N=v,C=L,R=V;let k=!0,D=null,ot=!1,mt=!1;if(v){let Tt=xt.get(v);if(Tt.__useDefaultFramebuffer!==void 0)ct.bindFramebuffer(w.FRAMEBUFFER,null),k=!1;else if(Tt.__webglFramebuffer===void 0)S.setupRenderTarget(v);else if(Tt.__hasExternalTextures)S.rebindTextures(v,xt.get(v.texture).__webglTexture,xt.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){let wt=v.depthTexture;if(Tt.__boundDepthTexture!==wt){if(wt!==null&&xt.has(wt)&&(v.width!==wt.image.width||v.height!==wt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");S.setupDepthRenderbuffer(v)}}let Ft=v.texture;(Ft.isData3DTexture||Ft.isDataArrayTexture||Ft.isCompressedArrayTexture)&&(mt=!0);let zt=xt.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(zt[L])?D=zt[L][V]:D=zt[L],ot=!0):v.samples>0&&S.useMultisampledRTT(v)===!1?D=xt.get(v).__webglMultisampledFramebuffer:Array.isArray(zt)?D=zt[V]:D=zt,A.copy(v.viewport),Z.copy(v.scissor),H=v.scissorTest}else A.copy(lt).multiplyScalar(U).floor(),Z.copy(_t).multiplyScalar(U).floor(),H=Pt;if(ct.bindFramebuffer(w.FRAMEBUFFER,D)&&k&&ct.drawBuffers(v,D),ct.viewport(A),ct.scissor(Z),ct.setScissorTest(H),ot){let Tt=xt.get(v.texture);w.framebufferTexture2D(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,w.TEXTURE_CUBE_MAP_POSITIVE_X+L,Tt.__webglTexture,V)}else if(mt){let Tt=xt.get(v.texture),Ft=L||0;w.framebufferTextureLayer(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,Tt.__webglTexture,V||0,Ft)}E=-1},this.readRenderTargetPixels=function(v,L,V,k,D,ot,mt){if(!(v&&v.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Et=xt.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&mt!==void 0&&(Et=Et[mt]),Et){ct.bindFramebuffer(w.FRAMEBUFFER,Et);try{let Tt=v.texture,Ft=Tt.format,zt=Tt.type;if(!yt.textureFormatReadable(Ft)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!yt.textureTypeReadable(zt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=v.width-k&&V>=0&&V<=v.height-D&&w.readPixels(L,V,k,D,kt.convert(Ft),kt.convert(zt),ot)}finally{let Tt=N!==null?xt.get(N).__webglFramebuffer:null;ct.bindFramebuffer(w.FRAMEBUFFER,Tt)}}},this.readRenderTargetPixelsAsync=async function(v,L,V,k,D,ot,mt){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Et=xt.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&mt!==void 0&&(Et=Et[mt]),Et){let Tt=v.texture,Ft=Tt.format,zt=Tt.type;if(!yt.textureFormatReadable(Ft))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!yt.textureTypeReadable(zt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(L>=0&&L<=v.width-k&&V>=0&&V<=v.height-D){ct.bindFramebuffer(w.FRAMEBUFFER,Et);let wt=w.createBuffer();w.bindBuffer(w.PIXEL_PACK_BUFFER,wt),w.bufferData(w.PIXEL_PACK_BUFFER,ot.byteLength,w.STREAM_READ),w.readPixels(L,V,k,D,kt.convert(Ft),kt.convert(zt),0);let Yt=N!==null?xt.get(N).__webglFramebuffer:null;ct.bindFramebuffer(w.FRAMEBUFFER,Yt);let jt=w.fenceSync(w.SYNC_GPU_COMMANDS_COMPLETE,0);return w.flush(),await iu(w,jt,4),w.bindBuffer(w.PIXEL_PACK_BUFFER,wt),w.getBufferSubData(w.PIXEL_PACK_BUFFER,0,ot),w.deleteBuffer(wt),w.deleteSync(jt),ot}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(v,L=null,V=0){v.isTexture!==!0&&(Hi("WebGLRenderer: copyFramebufferToTexture function signature has changed."),L=arguments[0]||null,v=arguments[1]);let k=Math.pow(2,-V),D=Math.floor(v.image.width*k),ot=Math.floor(v.image.height*k),mt=L!==null?L.x:0,Et=L!==null?L.y:0;S.setTexture2D(v,0),w.copyTexSubImage2D(w.TEXTURE_2D,V,0,0,mt,Et,D,ot),ct.unbindTexture()},this.copyTextureToTexture=function(v,L,V=null,k=null,D=0){v.isTexture!==!0&&(Hi("WebGLRenderer: copyTextureToTexture function signature has changed."),k=arguments[0]||null,v=arguments[1],L=arguments[2],D=arguments[3]||0,V=null);let ot,mt,Et,Tt,Ft,zt,wt,Yt,jt,te=v.isCompressedTexture?v.mipmaps[D]:v.image;V!==null?(ot=V.max.x-V.min.x,mt=V.max.y-V.min.y,Et=V.isBox3?V.max.z-V.min.z:1,Tt=V.min.x,Ft=V.min.y,zt=V.isBox3?V.min.z:0):(ot=te.width,mt=te.height,Et=te.depth||1,Tt=0,Ft=0,zt=0),k!==null?(wt=k.x,Yt=k.y,jt=k.z):(wt=0,Yt=0,jt=0);let Ee=kt.convert(L.format),Zt=kt.convert(L.type),Rt;L.isData3DTexture?(S.setTexture3D(L,0),Rt=w.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(S.setTexture2DArray(L,0),Rt=w.TEXTURE_2D_ARRAY):(S.setTexture2D(L,0),Rt=w.TEXTURE_2D),w.pixelStorei(w.UNPACK_FLIP_Y_WEBGL,L.flipY),w.pixelStorei(w.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),w.pixelStorei(w.UNPACK_ALIGNMENT,L.unpackAlignment);let je=w.getParameter(w.UNPACK_ROW_LENGTH),Jt=w.getParameter(w.UNPACK_IMAGE_HEIGHT),Be=w.getParameter(w.UNPACK_SKIP_PIXELS),jn=w.getParameter(w.UNPACK_SKIP_ROWS),we=w.getParameter(w.UNPACK_SKIP_IMAGES);w.pixelStorei(w.UNPACK_ROW_LENGTH,te.width),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,te.height),w.pixelStorei(w.UNPACK_SKIP_PIXELS,Tt),w.pixelStorei(w.UNPACK_SKIP_ROWS,Ft),w.pixelStorei(w.UNPACK_SKIP_IMAGES,zt);let Ni=v.isDataArrayTexture||v.isData3DTexture,ee=L.isDataArrayTexture||L.isData3DTexture;if(v.isRenderTargetTexture||v.isDepthTexture){let Ze=xt.get(v),Fi=xt.get(L),Ie=xt.get(Ze.__renderTarget),pn=xt.get(Fi.__renderTarget);ct.bindFramebuffer(w.READ_FRAMEBUFFER,Ie.__webglFramebuffer),ct.bindFramebuffer(w.DRAW_FRAMEBUFFER,pn.__webglFramebuffer);for(let mn=0;mn<Et;mn++)Ni&&w.framebufferTextureLayer(w.READ_FRAMEBUFFER,w.COLOR_ATTACHMENT0,xt.get(v).__webglTexture,D,zt+mn),v.isDepthTexture?(ee&&w.framebufferTextureLayer(w.DRAW_FRAMEBUFFER,w.COLOR_ATTACHMENT0,xt.get(L).__webglTexture,D,jt+mn),w.blitFramebuffer(Tt,Ft,ot,mt,wt,Yt,ot,mt,w.DEPTH_BUFFER_BIT,w.NEAREST)):ee?w.copyTexSubImage3D(Rt,D,wt,Yt,jt+mn,Tt,Ft,ot,mt):w.copyTexSubImage2D(Rt,D,wt,Yt,jt+mn,Tt,Ft,ot,mt);ct.bindFramebuffer(w.READ_FRAMEBUFFER,null),ct.bindFramebuffer(w.DRAW_FRAMEBUFFER,null)}else ee?v.isDataTexture||v.isData3DTexture?w.texSubImage3D(Rt,D,wt,Yt,jt,ot,mt,Et,Ee,Zt,te.data):L.isCompressedArrayTexture?w.compressedTexSubImage3D(Rt,D,wt,Yt,jt,ot,mt,Et,Ee,te.data):w.texSubImage3D(Rt,D,wt,Yt,jt,ot,mt,Et,Ee,Zt,te):v.isDataTexture?w.texSubImage2D(w.TEXTURE_2D,D,wt,Yt,ot,mt,Ee,Zt,te.data):v.isCompressedTexture?w.compressedTexSubImage2D(w.TEXTURE_2D,D,wt,Yt,te.width,te.height,Ee,te.data):w.texSubImage2D(w.TEXTURE_2D,D,wt,Yt,ot,mt,Ee,Zt,te);w.pixelStorei(w.UNPACK_ROW_LENGTH,je),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,Jt),w.pixelStorei(w.UNPACK_SKIP_PIXELS,Be),w.pixelStorei(w.UNPACK_SKIP_ROWS,jn),w.pixelStorei(w.UNPACK_SKIP_IMAGES,we),D===0&&L.generateMipmaps&&w.generateMipmap(Rt),ct.unbindTexture()},this.copyTextureToTexture3D=function(v,L,V=null,k=null,D=0){return v.isTexture!==!0&&(Hi("WebGLRenderer: copyTextureToTexture3D function signature has changed."),V=arguments[0]||null,k=arguments[1]||null,v=arguments[2],L=arguments[3],D=arguments[4]||0),Hi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(v,L,V,k,D)},this.initRenderTarget=function(v){xt.get(v).__webglFramebuffer===void 0&&S.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?S.setTextureCube(v,0):v.isData3DTexture?S.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?S.setTexture2DArray(v,0):S.setTexture2D(v,0),ct.unbindTexture()},this.resetState=function(){C=0,R=0,N=null,ct.reset(),Qt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return cn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorspace=Xt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Xt._getUnpackColorSpace()}},ir=class i{constructor(t,e=1,n=1e3){this.isFog=!0,this.name="",this.color=new Ot(t),this.near=e,this.far=n}clone(){return new i(this.color,this.near,this.far)}toJSON(){return{type:"Fog",name:this.name,color:this.color.getHex(),near:this.near,far:this.far}}},sr=class extends Re{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new dn,this.environmentIntensity=1,this.environmentRotation=new dn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){let e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}},Yn=class extends Cn{static get type(){return"LineBasicMaterial"}constructor(t){super(),this.isLineBasicMaterial=!0,this.color=new Ot(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.linewidth=t.linewidth,this.linecap=t.linecap,this.linejoin=t.linejoin,this.fog=t.fog,this}},rr=new I,ar=new I,cc=new re,ki=new Ki,Rs=new qn,ra=new I,hc=new I,uo=class extends Re{constructor(t=new ce,e=new Yn){super(),this.isLine=!0,this.type="Line",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}computeLineDistances(){let t=this.geometry;if(t.index===null){let e=t.attributes.position,n=[0];for(let s=1,r=e.count;s<r;s++)rr.fromBufferAttribute(e,s-1),ar.fromBufferAttribute(e,s),n[s]=n[s-1],n[s]+=rr.distanceTo(ar);t.setAttribute("lineDistance",new oe(n,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(t,e){let n=this.geometry,s=this.matrixWorld,r=t.params.Line.threshold,a=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),Rs.copy(n.boundingSphere),Rs.applyMatrix4(s),Rs.radius+=r,t.ray.intersectsSphere(Rs)===!1)return;cc.copy(s).invert(),ki.copy(t.ray).applyMatrix4(cc);let o=r/((this.scale.x+this.scale.y+this.scale.z)/3),l=o*o,c=this.isLineSegments?2:1,h=n.index,f=n.attributes.position;if(h!==null){let p=Math.max(0,a.start),g=Math.min(h.count,a.start+a.count);for(let _=p,m=g-1;_<m;_+=c){let d=h.getX(_),T=h.getX(_+1),b=Ps(this,t,ki,l,d,T);b&&e.push(b)}if(this.isLineLoop){let _=h.getX(g-1),m=h.getX(p),d=Ps(this,t,ki,l,_,m);d&&e.push(d)}}else{let p=Math.max(0,a.start),g=Math.min(f.count,a.start+a.count);for(let _=p,m=g-1;_<m;_+=c){let d=Ps(this,t,ki,l,_,_+1);d&&e.push(d)}if(this.isLineLoop){let _=Ps(this,t,ki,l,g-1,p);_&&e.push(_)}}}updateMorphTargets(){let e=this.geometry.morphAttributes,n=Object.keys(e);if(n.length>0){let s=e[n[0]];if(s!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let r=0,a=s.length;r<a;r++){let o=s[r].name||String(r);this.morphTargetInfluences.push(0),this.morphTargetDictionary[o]=r}}}}};Ri=class extends uo{constructor(t,e){super(t,e),this.isLineLoop=!0,this.type="LineLoop"}},ts=class extends Cn{static get type(){return"PointsMaterial"}constructor(t){super(),this.isPointsMaterial=!0,this.color=new Ot(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.alphaMap=t.alphaMap,this.size=t.size,this.sizeAttenuation=t.sizeAttenuation,this.fog=t.fog,this}},uc=new re,fo=new Ki,Is=new qn,Ls=new I,or=class extends Re{constructor(t=new ce,e=new ts){super(),this.isPoints=!0,this.type="Points",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}raycast(t,e){let n=this.geometry,s=this.matrixWorld,r=t.params.Points.threshold,a=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),Is.copy(n.boundingSphere),Is.applyMatrix4(s),Is.radius+=r,t.ray.intersectsSphere(Is)===!1)return;uc.copy(s).invert(),fo.copy(t.ray).applyMatrix4(uc);let o=r/((this.scale.x+this.scale.y+this.scale.z)/3),l=o*o,c=n.index,u=n.attributes.position;if(c!==null){let f=Math.max(0,a.start),p=Math.min(c.count,a.start+a.count);for(let g=f,_=p;g<_;g++){let m=c.getX(g);Ls.fromBufferAttribute(u,m),dc(Ls,m,l,s,t,e,this)}}else{let f=Math.max(0,a.start),p=Math.min(u.count,a.start+a.count);for(let g=f,_=p;g<_;g++)Ls.fromBufferAttribute(u,g),dc(Ls,g,l,s,t,e,this)}}updateMorphTargets(){let e=this.geometry.morphAttributes,n=Object.keys(e);if(n.length>0){let s=e[n[0]];if(s!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let r=0,a=s.length;r<a;r++){let o=s[r].name||String(r);this.morphTargetInfluences.push(0),this.morphTargetDictionary[o]=r}}}}};Fe=class{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(t,e){let n=this.getUtoTmapping(t);return this.getPoint(n,e)}getPoints(t=5){let e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return e}getSpacedPoints(t=5){let e=[];for(let n=0;n<=t;n++)e.push(this.getPointAt(n/t));return e}getLength(){let t=this.getLengths();return t[t.length-1]}getLengths(t=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===t+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;let e=[],n,s=this.getPoint(0),r=0;e.push(0);for(let a=1;a<=t;a++)n=this.getPoint(a/t),r+=n.distanceTo(s),e.push(r),s=n;return this.cacheArcLengths=e,e}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(t,e){let n=this.getLengths(),s=0,r=n.length,a;e?a=e:a=t*n[r-1];let o=0,l=r-1,c;for(;o<=l;)if(s=Math.floor(o+(l-o)/2),c=n[s]-a,c<0)o=s+1;else if(c>0)l=s-1;else{l=s;break}if(s=l,n[s]===a)return s/(r-1);let h=n[s],f=n[s+1]-h,p=(a-h)/f;return(s+p)/(r-1)}getTangent(t,e){let s=t-1e-4,r=t+1e-4;s<0&&(s=0),r>1&&(r=1);let a=this.getPoint(s),o=this.getPoint(r),l=e||(a.isVector2?new rt:new I);return l.copy(o).sub(a).normalize(),l}getTangentAt(t,e){let n=this.getUtoTmapping(t);return this.getTangent(n,e)}computeFrenetFrames(t,e){let n=new I,s=[],r=[],a=[],o=new I,l=new re;for(let p=0;p<=t;p++){let g=p/t;s[p]=this.getTangentAt(g,new I)}r[0]=new I,a[0]=new I;let c=Number.MAX_VALUE,h=Math.abs(s[0].x),u=Math.abs(s[0].y),f=Math.abs(s[0].z);h<=c&&(c=h,n.set(1,0,0)),u<=c&&(c=u,n.set(0,1,0)),f<=c&&n.set(0,0,1),o.crossVectors(s[0],n).normalize(),r[0].crossVectors(s[0],o),a[0].crossVectors(s[0],r[0]);for(let p=1;p<=t;p++){if(r[p]=r[p-1].clone(),a[p]=a[p-1].clone(),o.crossVectors(s[p-1],s[p]),o.length()>Number.EPSILON){o.normalize();let g=Math.acos(me(s[p-1].dot(s[p]),-1,1));r[p].applyMatrix4(l.makeRotationAxis(o,g))}a[p].crossVectors(s[p],r[p])}if(e===!0){let p=Math.acos(me(r[0].dot(r[t]),-1,1));p/=t,s[0].dot(o.crossVectors(r[0],r[t]))>0&&(p=-p);for(let g=1;g<=t;g++)r[g].applyMatrix4(l.makeRotationAxis(s[g],p*g)),a[g].crossVectors(s[g],r[g])}return{tangents:s,normals:r,binormals:a}}clone(){return new this.constructor().copy(this)}copy(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}toJSON(){let t={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return t.arcLengthDivisions=this.arcLengthDivisions,t.type=this.type,t}fromJSON(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}},es=class extends Fe{constructor(t=0,e=0,n=1,s=1,r=0,a=Math.PI*2,o=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=t,this.aY=e,this.xRadius=n,this.yRadius=s,this.aStartAngle=r,this.aEndAngle=a,this.aClockwise=o,this.aRotation=l}getPoint(t,e=new rt){let n=e,s=Math.PI*2,r=this.aEndAngle-this.aStartAngle,a=Math.abs(r)<Number.EPSILON;for(;r<0;)r+=s;for(;r>s;)r-=s;r<Number.EPSILON&&(a?r=0:r=s),this.aClockwise===!0&&!a&&(r===s?r=-s:r=r-s);let o=this.aStartAngle+t*r,l=this.aX+this.xRadius*Math.cos(o),c=this.aY+this.yRadius*Math.sin(o);if(this.aRotation!==0){let h=Math.cos(this.aRotation),u=Math.sin(this.aRotation),f=l-this.aX,p=c-this.aY;l=f*h-p*u+this.aX,c=f*u+p*h+this.aY}return n.set(l,c)}copy(t){return super.copy(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}toJSON(){let t=super.toJSON();return t.aX=this.aX,t.aY=this.aY,t.xRadius=this.xRadius,t.yRadius=this.yRadius,t.aStartAngle=this.aStartAngle,t.aEndAngle=this.aEndAngle,t.aClockwise=this.aClockwise,t.aRotation=this.aRotation,t}fromJSON(t){return super.fromJSON(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}},po=class extends es{constructor(t,e,n,s,r,a){super(t,e,n,n,s,r,a),this.isArcCurve=!0,this.type="ArcCurve"}};Ds=new I,aa=new Yo,oa=new Yo,la=new Yo,mo=class extends Fe{constructor(t=[],e=!1,n="centripetal",s=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=t,this.closed=e,this.curveType=n,this.tension=s}getPoint(t,e=new I){let n=e,s=this.points,r=s.length,a=(r-(this.closed?0:1))*t,o=Math.floor(a),l=a-o;this.closed?o+=o>0?0:(Math.floor(Math.abs(o)/r)+1)*r:l===0&&o===r-1&&(o=r-2,l=1);let c,h;this.closed||o>0?c=s[(o-1)%r]:(Ds.subVectors(s[0],s[1]).add(s[0]),c=Ds);let u=s[o%r],f=s[(o+1)%r];if(this.closed||o+2<r?h=s[(o+2)%r]:(Ds.subVectors(s[r-1],s[r-2]).add(s[r-1]),h=Ds),this.curveType==="centripetal"||this.curveType==="chordal"){let p=this.curveType==="chordal"?.5:.25,g=Math.pow(c.distanceToSquared(u),p),_=Math.pow(u.distanceToSquared(f),p),m=Math.pow(f.distanceToSquared(h),p);_<1e-4&&(_=1),g<1e-4&&(g=_),m<1e-4&&(m=_),aa.initNonuniformCatmullRom(c.x,u.x,f.x,h.x,g,_,m),oa.initNonuniformCatmullRom(c.y,u.y,f.y,h.y,g,_,m),la.initNonuniformCatmullRom(c.z,u.z,f.z,h.z,g,_,m)}else this.curveType==="catmullrom"&&(aa.initCatmullRom(c.x,u.x,f.x,h.x,this.tension),oa.initCatmullRom(c.y,u.y,f.y,h.y,this.tension),la.initCatmullRom(c.z,u.z,f.z,h.z,this.tension));return n.set(aa.calc(l),oa.calc(l),la.calc(l)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){let s=t.points[e];this.points.push(s.clone())}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}toJSON(){let t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){let s=this.points[e];t.points.push(s.toArray())}return t.closed=this.closed,t.curveType=this.curveType,t.tension=this.tension,t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){let s=t.points[e];this.points.push(new I().fromArray(s))}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}};lr=class extends Fe{constructor(t=new rt,e=new rt,n=new rt,s=new rt){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=t,this.v1=e,this.v2=n,this.v3=s}getPoint(t,e=new rt){let n=e,s=this.v0,r=this.v1,a=this.v2,o=this.v3;return n.set(Zi(t,s.x,r.x,a.x,o.x),Zi(t,s.y,r.y,a.y,o.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){let t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}},go=class extends Fe{constructor(t=new I,e=new I,n=new I,s=new I){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=t,this.v1=e,this.v2=n,this.v3=s}getPoint(t,e=new I){let n=e,s=this.v0,r=this.v1,a=this.v2,o=this.v3;return n.set(Zi(t,s.x,r.x,a.x,o.x),Zi(t,s.y,r.y,a.y,o.y),Zi(t,s.z,r.z,a.z,o.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){let t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}},cr=class extends Fe{constructor(t=new rt,e=new rt){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=t,this.v2=e}getPoint(t,e=new rt){let n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new rt){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){let t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}},_o=class extends Fe{constructor(t=new I,e=new I){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=t,this.v2=e}getPoint(t,e=new I){let n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new I){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){let t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}},hr=class extends Fe{constructor(t=new rt,e=new rt,n=new rt){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new rt){let n=e,s=this.v0,r=this.v1,a=this.v2;return n.set(Yi(t,s.x,r.x,a.x),Yi(t,s.y,r.y,a.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){let t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}},xo=class extends Fe{constructor(t=new I,e=new I,n=new I){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new I){let n=e,s=this.v0,r=this.v1,a=this.v2;return n.set(Yi(t,s.x,r.x,a.x),Yi(t,s.y,r.y,a.y),Yi(t,s.z,r.z,a.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){let t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}},ur=class extends Fe{constructor(t=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=t}getPoint(t,e=new rt){let n=e,s=this.points,r=(s.length-1)*t,a=Math.floor(r),o=r-a,l=s[a===0?a:a-1],c=s[a],h=s[a>s.length-2?s.length-1:a+1],u=s[a>s.length-3?s.length-1:a+2];return n.set(fc(o,l.x,c.x,h.x,u.x),fc(o,l.y,c.y,h.y,u.y)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){let s=t.points[e];this.points.push(s.clone())}return this}toJSON(){let t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){let s=this.points[e];t.points.push(s.toArray())}return t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){let s=t.points[e];this.points.push(new rt().fromArray(s))}return this}},vo=Object.freeze({__proto__:null,ArcCurve:po,CatmullRomCurve3:mo,CubicBezierCurve:lr,CubicBezierCurve3:go,EllipseCurve:es,LineCurve:cr,LineCurve3:_o,QuadraticBezierCurve:hr,QuadraticBezierCurve3:xo,SplineCurve:ur}),yo=class extends Fe{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(t){this.curves.push(t)}closePath(){let t=this.curves[0].getPoint(0),e=this.curves[this.curves.length-1].getPoint(1);if(!t.equals(e)){let n=t.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new vo[n](e,t))}return this}getPoint(t,e){let n=t*this.getLength(),s=this.getCurveLengths(),r=0;for(;r<s.length;){if(s[r]>=n){let a=s[r]-n,o=this.curves[r],l=o.getLength(),c=l===0?0:1-a/l;return o.getPointAt(c,e)}r++}return null}getLength(){let t=this.getCurveLengths();return t[t.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;let t=[],e=0;for(let n=0,s=this.curves.length;n<s;n++)e+=this.curves[n].getLength(),t.push(e);return this.cacheLengths=t,t}getSpacedPoints(t=40){let e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return this.autoClose&&e.push(e[0]),e}getPoints(t=12){let e=[],n;for(let s=0,r=this.curves;s<r.length;s++){let a=r[s],o=a.isEllipseCurve?t*2:a.isLineCurve||a.isLineCurve3?1:a.isSplineCurve?t*a.points.length:t,l=a.getPoints(o);for(let c=0;c<l.length;c++){let h=l[c];n&&n.equals(h)||(e.push(h),n=h)}}return this.autoClose&&e.length>1&&!e[e.length-1].equals(e[0])&&e.push(e[0]),e}copy(t){super.copy(t),this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){let s=t.curves[e];this.curves.push(s.clone())}return this.autoClose=t.autoClose,this}toJSON(){let t=super.toJSON();t.autoClose=this.autoClose,t.curves=[];for(let e=0,n=this.curves.length;e<n;e++){let s=this.curves[e];t.curves.push(s.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.autoClose=t.autoClose,this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){let s=t.curves[e];this.curves.push(new vo[s.type]().fromJSON(s))}return this}},dr=class extends yo{constructor(t){super(),this.type="Path",this.currentPoint=new rt,t&&this.setFromPoints(t)}setFromPoints(t){this.moveTo(t[0].x,t[0].y);for(let e=1,n=t.length;e<n;e++)this.lineTo(t[e].x,t[e].y);return this}moveTo(t,e){return this.currentPoint.set(t,e),this}lineTo(t,e){let n=new cr(this.currentPoint.clone(),new rt(t,e));return this.curves.push(n),this.currentPoint.set(t,e),this}quadraticCurveTo(t,e,n,s){let r=new hr(this.currentPoint.clone(),new rt(t,e),new rt(n,s));return this.curves.push(r),this.currentPoint.set(n,s),this}bezierCurveTo(t,e,n,s,r,a){let o=new lr(this.currentPoint.clone(),new rt(t,e),new rt(n,s),new rt(r,a));return this.curves.push(o),this.currentPoint.set(r,a),this}splineThru(t){let e=[this.currentPoint.clone()].concat(t),n=new ur(e);return this.curves.push(n),this.currentPoint.copy(t[t.length-1]),this}arc(t,e,n,s,r,a){let o=this.currentPoint.x,l=this.currentPoint.y;return this.absarc(t+o,e+l,n,s,r,a),this}absarc(t,e,n,s,r,a){return this.absellipse(t,e,n,n,s,r,a),this}ellipse(t,e,n,s,r,a,o,l){let c=this.currentPoint.x,h=this.currentPoint.y;return this.absellipse(t+c,e+h,n,s,r,a,o,l),this}absellipse(t,e,n,s,r,a,o,l){let c=new es(t,e,n,s,r,a,o,l);if(this.curves.length>0){let u=c.getPoint(0);u.equals(this.currentPoint)||this.lineTo(u.x,u.y)}this.curves.push(c);let h=c.getPoint(1);return this.currentPoint.copy(h),this}copy(t){return super.copy(t),this.currentPoint.copy(t.currentPoint),this}toJSON(){let t=super.toJSON();return t.currentPoint=this.currentPoint.toArray(),t}fromJSON(t){return super.fromJSON(t),this.currentPoint.fromArray(t.currentPoint),this}},Zn=class extends dr{constructor(t){super(t),this.uuid=Qn(),this.type="Shape",this.holes=[]}getPointsHoles(t){let e=[];for(let n=0,s=this.holes.length;n<s;n++)e[n]=this.holes[n].getPoints(t);return e}extractPoints(t){return{shape:this.getPoints(t),holes:this.getPointsHoles(t)}}copy(t){super.copy(t),this.holes=[];for(let e=0,n=t.holes.length;e<n;e++){let s=t.holes[e];this.holes.push(s.clone())}return this}toJSON(){let t=super.toJSON();t.uuid=this.uuid,t.holes=[];for(let e=0,n=this.holes.length;e<n;e++){let s=this.holes[e];t.holes.push(s.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.uuid=t.uuid,this.holes=[];for(let e=0,n=t.holes.length;e<n;e++){let s=t.holes[e];this.holes.push(new dr().fromJSON(s))}return this}},ag={triangulate:function(i,t,e=2){let n=t&&t.length,s=n?t[0]*e:i.length,r=kc(i,0,s,e,!0),a=[];if(!r||r.next===r.prev)return a;let o,l,c,h,u,f,p;if(n&&(r=ug(i,t,r,e)),i.length>80*e){o=c=i[0],l=h=i[1];for(let g=e;g<s;g+=e)u=i[g],f=i[g+1],u<o&&(o=u),f<l&&(l=f),u>c&&(c=u),f>h&&(h=f);p=Math.max(c-o,h-l),p=p!==0?32767/p:0}return ns(r,a,e,o,l,p,0),a}};En=class i{static area(t){let e=t.length,n=0;for(let s=e-1,r=0;r<e;s=r++)n+=t[s].x*t[r].y-t[r].x*t[s].y;return n*.5}static isClockWise(t){return i.area(t)<0}static triangulateShape(t,e){let n=[],s=[],r=[];mc(t),gc(n,t);let a=t.length;e.forEach(mc);for(let l=0;l<e.length;l++)s.push(a),a+=e[l].length,gc(n,e[l]);let o=ag.triangulate(n,s);for(let l=0;l<o.length;l+=3)r.push(o.slice(l,l+3));return r}};fr=class i extends ce{constructor(t=new Zn([new rt(.5,.5),new rt(-.5,.5),new rt(-.5,-.5),new rt(.5,-.5)]),e={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:t,options:e},t=Array.isArray(t)?t:[t];let n=this,s=[],r=[];for(let o=0,l=t.length;o<l;o++){let c=t[o];a(c)}this.setAttribute("position",new oe(s,3)),this.setAttribute("uv",new oe(r,2)),this.computeVertexNormals();function a(o){let l=[],c=e.curveSegments!==void 0?e.curveSegments:12,h=e.steps!==void 0?e.steps:1,u=e.depth!==void 0?e.depth:1,f=e.bevelEnabled!==void 0?e.bevelEnabled:!0,p=e.bevelThickness!==void 0?e.bevelThickness:.2,g=e.bevelSize!==void 0?e.bevelSize:p-.1,_=e.bevelOffset!==void 0?e.bevelOffset:0,m=e.bevelSegments!==void 0?e.bevelSegments:3,d=e.extrudePath,T=e.UVGenerator!==void 0?e.UVGenerator:bg,b,M=!1,O,C,R,N;d&&(b=d.getSpacedPoints(h),M=!0,f=!1,O=d.computeFrenetFrames(h,!1),C=new I,R=new I,N=new I),f||(m=0,p=0,g=0,_=0);let E=o.extractPoints(c),y=E.shape,A=E.holes;if(!En.isClockWise(y)){y=y.reverse();for(let $=0,it=A.length;$<it;$++){let w=A[$];En.isClockWise(w)&&(A[$]=w.reverse())}}let H=En.triangulateShape(y,A),G=y;for(let $=0,it=A.length;$<it;$++){let w=A[$];y=y.concat(w)}function j($,it,w){return it||console.error("THREE.ExtrudeGeometry: vec does not exist"),$.clone().addScaledVector(it,w)}let W=y.length,B=H.length;function U($,it,w){let At,nt,yt,ct=$.x-it.x,Dt=$.y-it.y,xt=w.x-$.x,S=w.y-$.y,x=ct*ct+Dt*Dt,F=ct*S-Dt*xt;if(Math.abs(F)>Number.EPSILON){let q=Math.sqrt(x),tt=Math.sqrt(xt*xt+S*S),Y=it.x-Dt/q,bt=it.y+ct/q,ut=w.x-S/tt,vt=w.y+xt/tt,Wt=((ut-Y)*S-(vt-bt)*xt)/(ct*S-Dt*xt);At=Y+ct*Wt-$.x,nt=bt+Dt*Wt-$.y;let st=At*At+nt*nt;if(st<=2)return new rt(At,nt);yt=Math.sqrt(st/2)}else{let q=!1;ct>Number.EPSILON?xt>Number.EPSILON&&(q=!0):ct<-Number.EPSILON?xt<-Number.EPSILON&&(q=!0):Math.sign(Dt)===Math.sign(S)&&(q=!0),q?(At=-Dt,nt=ct,yt=Math.sqrt(x)):(At=ct,nt=Dt,yt=Math.sqrt(x/2))}return new rt(At/yt,nt/yt)}let J=[];for(let $=0,it=G.length,w=it-1,At=$+1;$<it;$++,w++,At++)w===it&&(w=0),At===it&&(At=0),J[$]=U(G[$],G[w],G[At]);let et=[],lt,_t=J.concat();for(let $=0,it=A.length;$<it;$++){let w=A[$];lt=[];for(let At=0,nt=w.length,yt=nt-1,ct=At+1;At<nt;At++,yt++,ct++)yt===nt&&(yt=0),ct===nt&&(ct=0),lt[At]=U(w[At],w[yt],w[ct]);et.push(lt),_t=_t.concat(lt)}for(let $=0;$<m;$++){let it=$/m,w=p*Math.cos(it*Math.PI/2),At=g*Math.sin(it*Math.PI/2)+_;for(let nt=0,yt=G.length;nt<yt;nt++){let ct=j(G[nt],J[nt],At);at(ct.x,ct.y,-w)}for(let nt=0,yt=A.length;nt<yt;nt++){let ct=A[nt];lt=et[nt];for(let Dt=0,xt=ct.length;Dt<xt;Dt++){let S=j(ct[Dt],lt[Dt],At);at(S.x,S.y,-w)}}}let Pt=g+_;for(let $=0;$<W;$++){let it=f?j(y[$],_t[$],Pt):y[$];M?(R.copy(O.normals[0]).multiplyScalar(it.x),C.copy(O.binormals[0]).multiplyScalar(it.y),N.copy(b[0]).add(R).add(C),at(N.x,N.y,N.z)):at(it.x,it.y,0)}for(let $=1;$<=h;$++)for(let it=0;it<W;it++){let w=f?j(y[it],_t[it],Pt):y[it];M?(R.copy(O.normals[$]).multiplyScalar(w.x),C.copy(O.binormals[$]).multiplyScalar(w.y),N.copy(b[$]).add(R).add(C),at(N.x,N.y,N.z)):at(w.x,w.y,u/h*$)}for(let $=m-1;$>=0;$--){let it=$/m,w=p*Math.cos(it*Math.PI/2),At=g*Math.sin(it*Math.PI/2)+_;for(let nt=0,yt=G.length;nt<yt;nt++){let ct=j(G[nt],J[nt],At);at(ct.x,ct.y,u+w)}for(let nt=0,yt=A.length;nt<yt;nt++){let ct=A[nt];lt=et[nt];for(let Dt=0,xt=ct.length;Dt<xt;Dt++){let S=j(ct[Dt],lt[Dt],At);M?at(S.x,S.y+b[h-1].y,b[h-1].x+w):at(S.x,S.y,u+w)}}}z(),K();function z(){let $=s.length/3;if(f){let it=0,w=W*it;for(let At=0;At<B;At++){let nt=H[At];Ct(nt[2]+w,nt[1]+w,nt[0]+w)}it=h+m*2,w=W*it;for(let At=0;At<B;At++){let nt=H[At];Ct(nt[0]+w,nt[1]+w,nt[2]+w)}}else{for(let it=0;it<B;it++){let w=H[it];Ct(w[2],w[1],w[0])}for(let it=0;it<B;it++){let w=H[it];Ct(w[0]+W*h,w[1]+W*h,w[2]+W*h)}}n.addGroup($,s.length/3-$,0)}function K(){let $=s.length/3,it=0;ft(G,it),it+=G.length;for(let w=0,At=A.length;w<At;w++){let nt=A[w];ft(nt,it),it+=nt.length}n.addGroup($,s.length/3-$,1)}function ft($,it){let w=$.length;for(;--w>=0;){let At=w,nt=w-1;nt<0&&(nt=$.length-1);for(let yt=0,ct=h+m*2;yt<ct;yt++){let Dt=W*yt,xt=W*(yt+1),S=it+At+Dt,x=it+nt+Dt,F=it+nt+xt,q=it+At+xt;Lt(S,x,F,q)}}}function at($,it,w){l.push($),l.push(it),l.push(w)}function Ct($,it,w){It($),It(it),It(w);let At=s.length/3,nt=T.generateTopUV(n,s,At-3,At-2,At-1);Gt(nt[0]),Gt(nt[1]),Gt(nt[2])}function Lt($,it,w,At){It($),It(it),It(At),It(it),It(w),It(At);let nt=s.length/3,yt=T.generateSideWallUV(n,s,nt-6,nt-3,nt-2,nt-1);Gt(yt[0]),Gt(yt[1]),Gt(yt[3]),Gt(yt[1]),Gt(yt[2]),Gt(yt[3])}function It($){s.push(l[$*3+0]),s.push(l[$*3+1]),s.push(l[$*3+2])}function Gt($){r.push($.x),r.push($.y)}}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}toJSON(){let t=super.toJSON(),e=this.parameters.shapes,n=this.parameters.options;return Eg(e,n,t)}static fromJSON(t,e){let n=[];for(let r=0,a=t.shapes.length;r<a;r++){let o=e[t.shapes[r]];n.push(o)}let s=t.options.extrudePath;return s!==void 0&&(t.options.extrudePath=new vo[s.type]().fromJSON(s)),new i(n,t.options)}},bg={generateTopUV:function(i,t,e,n,s){let r=t[e*3],a=t[e*3+1],o=t[n*3],l=t[n*3+1],c=t[s*3],h=t[s*3+1];return[new rt(r,a),new rt(o,l),new rt(c,h)]},generateSideWallUV:function(i,t,e,n,s,r){let a=t[e*3],o=t[e*3+1],l=t[e*3+2],c=t[n*3],h=t[n*3+1],u=t[n*3+2],f=t[s*3],p=t[s*3+1],g=t[s*3+2],_=t[r*3],m=t[r*3+1],d=t[r*3+2];return Math.abs(o-h)<Math.abs(a-c)?[new rt(a,1-l),new rt(c,1-u),new rt(f,1-g),new rt(_,1-d)]:[new rt(o,1-l),new rt(h,1-u),new rt(p,1-g),new rt(m,1-d)]}};pr=class i extends ce{constructor(t=.5,e=1,n=32,s=1,r=0,a=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:t,outerRadius:e,thetaSegments:n,phiSegments:s,thetaStart:r,thetaLength:a},n=Math.max(3,n),s=Math.max(1,s);let o=[],l=[],c=[],h=[],u=t,f=(e-t)/s,p=new I,g=new rt;for(let _=0;_<=s;_++){for(let m=0;m<=n;m++){let d=r+m/n*a;p.x=u*Math.cos(d),p.y=u*Math.sin(d),l.push(p.x,p.y,p.z),c.push(0,0,1),g.x=(p.x/e+1)/2,g.y=(p.y/e+1)/2,h.push(g.x,g.y)}u+=f}for(let _=0;_<s;_++){let m=_*(n+1);for(let d=0;d<n;d++){let T=d+m,b=T,M=T+n+1,O=T+n+2,C=T+1;o.push(b,M,C),o.push(M,O,C)}}this.setIndex(o),this.setAttribute("position",new oe(l,3)),this.setAttribute("normal",new oe(c,3)),this.setAttribute("uv",new oe(h,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new i(t.innerRadius,t.outerRadius,t.thetaSegments,t.phiSegments,t.thetaStart,t.thetaLength)}},mr=class i extends ce{constructor(t=new Zn([new rt(0,.5),new rt(-.5,-.5),new rt(.5,-.5)]),e=12){super(),this.type="ShapeGeometry",this.parameters={shapes:t,curveSegments:e};let n=[],s=[],r=[],a=[],o=0,l=0;if(Array.isArray(t)===!1)c(t);else for(let h=0;h<t.length;h++)c(t[h]),this.addGroup(o,l,h),o+=l,l=0;this.setIndex(n),this.setAttribute("position",new oe(s,3)),this.setAttribute("normal",new oe(r,3)),this.setAttribute("uv",new oe(a,2));function c(h){let u=s.length/3,f=h.extractPoints(e),p=f.shape,g=f.holes;En.isClockWise(p)===!1&&(p=p.reverse());for(let m=0,d=g.length;m<d;m++){let T=g[m];En.isClockWise(T)===!0&&(g[m]=T.reverse())}let _=En.triangulateShape(p,g);for(let m=0,d=g.length;m<d;m++){let T=g[m];p=p.concat(T)}for(let m=0,d=p.length;m<d;m++){let T=p[m];s.push(T.x,T.y,0),r.push(0,0,1),a.push(T.x,T.y)}for(let m=0,d=_.length;m<d;m++){let T=_[m],b=T[0]+u,M=T[1]+u,O=T[2]+u;n.push(b,M,O),l+=3}}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}toJSON(){let t=super.toJSON(),e=this.parameters.shapes;return Tg(e,t)}static fromJSON(t,e){let n=[];for(let s=0,r=t.shapes.length;s<r;s++){let a=e[t.shapes[s]];n.push(a)}return new i(n,t.curveSegments)}};gr=class extends ue{static get type(){return"RawShaderMaterial"}constructor(t){super(t),this.isRawShaderMaterial=!0}},_r=class extends Yn{static get type(){return"LineDashedMaterial"}constructor(t){super(),this.isLineDashedMaterial=!0,this.scale=1,this.dashSize=3,this.gapSize=1,this.setValues(t)}copy(t){return super.copy(t),this.scale=t.scale,this.dashSize=t.dashSize,this.gapSize=t.gapSize,this}};Pi=class{constructor(t,e,n,s){this.parameterPositions=t,this._cachedIndex=0,this.resultBuffer=s!==void 0?s:new e.constructor(n),this.sampleValues=e,this.valueSize=n,this.settings=null,this.DefaultSettings_={}}evaluate(t){let e=this.parameterPositions,n=this._cachedIndex,s=e[n],r=e[n-1];n:{t:{let a;e:{i:if(!(t<s)){for(let o=n+2;;){if(s===void 0){if(t<r)break i;return n=e.length,this._cachedIndex=n,this.copySampleValue_(n-1)}if(n===o)break;if(r=s,s=e[++n],t<s)break t}a=e.length;break e}if(!(t>=r)){let o=e[1];t<o&&(n=2,r=o);for(let l=n-2;;){if(r===void 0)return this._cachedIndex=0,this.copySampleValue_(0);if(n===l)break;if(s=r,r=e[--n-1],t>=r)break t}a=n,n=0;break e}break n}for(;n<a;){let o=n+a>>>1;t<e[o]?a=o:n=o+1}if(s=e[n],r=e[n-1],r===void 0)return this._cachedIndex=0,this.copySampleValue_(0);if(s===void 0)return n=e.length,this._cachedIndex=n,this.copySampleValue_(n-1)}this._cachedIndex=n,this.intervalChanged_(n,r,s)}return this.interpolate_(n,r,t,s)}getSettings_(){return this.settings||this.DefaultSettings_}copySampleValue_(t){let e=this.resultBuffer,n=this.sampleValues,s=this.valueSize,r=t*s;for(let a=0;a!==s;++a)e[a]=n[r+a];return e}interpolate_(){throw new Error("call to abstract method")}intervalChanged_(){}},bo=class extends Pi{constructor(t,e,n,s){super(t,e,n,s),this._weightPrev=-0,this._offsetPrev=-0,this._weightNext=-0,this._offsetNext=-0,this.DefaultSettings_={endingStart:dl,endingEnd:dl}}intervalChanged_(t,e,n){let s=this.parameterPositions,r=t-2,a=t+1,o=s[r],l=s[a];if(o===void 0)switch(this.getSettings_().endingStart){case fl:r=t,o=2*e-n;break;case pl:r=s.length-2,o=e+s[r]-s[r+1];break;default:r=t,o=n}if(l===void 0)switch(this.getSettings_().endingEnd){case fl:a=t,l=2*n-e;break;case pl:a=1,l=n+s[1]-s[0];break;default:a=t-1,l=e}let c=(n-e)*.5,h=this.valueSize;this._weightPrev=c/(e-o),this._weightNext=c/(l-n),this._offsetPrev=r*h,this._offsetNext=a*h}interpolate_(t,e,n,s){let r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=t*o,c=l-o,h=this._offsetPrev,u=this._offsetNext,f=this._weightPrev,p=this._weightNext,g=(n-e)/(s-e),_=g*g,m=_*g,d=-f*m+2*f*_-f*g,T=(1+f)*m+(-1.5-2*f)*_+(-.5+f)*g+1,b=(-1-p)*m+(1.5+p)*_+.5*g,M=p*m-p*_;for(let O=0;O!==o;++O)r[O]=d*a[h+O]+T*a[c+O]+b*a[l+O]+M*a[u+O];return r}},Eo=class extends Pi{constructor(t,e,n,s){super(t,e,n,s)}interpolate_(t,e,n,s){let r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=t*o,c=l-o,h=(n-e)/(s-e),u=1-h;for(let f=0;f!==o;++f)r[f]=a[c+f]*u+a[l+f]*h;return r}},To=class extends Pi{constructor(t,e,n,s){super(t,e,n,s)}interpolate_(t){return this.copySampleValue_(t-1)}},qe=class{constructor(t,e,n,s){if(t===void 0)throw new Error("THREE.KeyframeTrack: track name is undefined");if(e===void 0||e.length===0)throw new Error("THREE.KeyframeTrack: no keyframes in track named "+t);this.name=t,this.times=Fs(e,this.TimeBufferType),this.values=Fs(n,this.ValueBufferType),this.setInterpolation(s||this.DefaultInterpolation)}static toJSON(t){let e=t.constructor,n;if(e.toJSON!==this.toJSON)n=e.toJSON(t);else{n={name:t.name,times:Fs(t.times,Array),values:Fs(t.values,Array)};let s=t.getInterpolation();s!==t.DefaultInterpolation&&(n.interpolation=s)}return n.type=t.ValueTypeName,n}InterpolantFactoryMethodDiscrete(t){return new To(this.times,this.values,this.getValueSize(),t)}InterpolantFactoryMethodLinear(t){return new Eo(this.times,this.values,this.getValueSize(),t)}InterpolantFactoryMethodSmooth(t){return new bo(this.times,this.values,this.getValueSize(),t)}setInterpolation(t){let e;switch(t){case Gs:e=this.InterpolantFactoryMethodDiscrete;break;case Za:e=this.InterpolantFactoryMethodLinear;break;case Lr:e=this.InterpolantFactoryMethodSmooth;break}if(e===void 0){let n="unsupported interpolation for "+this.ValueTypeName+" keyframe track named "+this.name;if(this.createInterpolant===void 0)if(t!==this.DefaultInterpolation)this.setInterpolation(this.DefaultInterpolation);else throw new Error(n);return console.warn("THREE.KeyframeTrack:",n),this}return this.createInterpolant=e,this}getInterpolation(){switch(this.createInterpolant){case this.InterpolantFactoryMethodDiscrete:return Gs;case this.InterpolantFactoryMethodLinear:return Za;case this.InterpolantFactoryMethodSmooth:return Lr}}getValueSize(){return this.values.length/this.times.length}shift(t){if(t!==0){let e=this.times;for(let n=0,s=e.length;n!==s;++n)e[n]+=t}return this}scale(t){if(t!==1){let e=this.times;for(let n=0,s=e.length;n!==s;++n)e[n]*=t}return this}trim(t,e){let n=this.times,s=n.length,r=0,a=s-1;for(;r!==s&&n[r]<t;)++r;for(;a!==-1&&n[a]>e;)--a;if(++a,r!==0||a!==s){r>=a&&(a=Math.max(a,1),r=a-1);let o=this.getValueSize();this.times=n.slice(r,a),this.values=this.values.slice(r*o,a*o)}return this}validate(){let t=!0,e=this.getValueSize();e-Math.floor(e)!==0&&(console.error("THREE.KeyframeTrack: Invalid value size in track.",this),t=!1);let n=this.times,s=this.values,r=n.length;r===0&&(console.error("THREE.KeyframeTrack: Track is empty.",this),t=!1);let a=null;for(let o=0;o!==r;o++){let l=n[o];if(typeof l=="number"&&isNaN(l)){console.error("THREE.KeyframeTrack: Time is not a valid number.",this,o,l),t=!1;break}if(a!==null&&a>l){console.error("THREE.KeyframeTrack: Out of order keys.",this,o,l,a),t=!1;break}a=l}if(s!==void 0&&wg(s))for(let o=0,l=s.length;o!==l;++o){let c=s[o];if(isNaN(c)){console.error("THREE.KeyframeTrack: Value is not a valid number.",this,o,c),t=!1;break}}return t}optimize(){let t=this.times.slice(),e=this.values.slice(),n=this.getValueSize(),s=this.getInterpolation()===Lr,r=t.length-1,a=1;for(let o=1;o<r;++o){let l=!1,c=t[o],h=t[o+1];if(c!==h&&(o!==1||c!==t[0]))if(s)l=!0;else{let u=o*n,f=u-n,p=u+n;for(let g=0;g!==n;++g){let _=e[u+g];if(_!==e[f+g]||_!==e[p+g]){l=!0;break}}}if(l){if(o!==a){t[a]=t[o];let u=o*n,f=a*n;for(let p=0;p!==n;++p)e[f+p]=e[u+p]}++a}}if(r>0){t[a]=t[r];for(let o=r*n,l=a*n,c=0;c!==n;++c)e[l+c]=e[o+c];++a}return a!==t.length?(this.times=t.slice(0,a),this.values=e.slice(0,a*n)):(this.times=t,this.values=e),this}clone(){let t=this.times.slice(),e=this.values.slice(),n=this.constructor,s=new n(this.name,t,e);return s.createInterpolant=this.createInterpolant,s}};qe.prototype.TimeBufferType=Float32Array;qe.prototype.ValueBufferType=Float32Array;qe.prototype.DefaultInterpolation=Za;$n=class extends qe{constructor(t,e,n){super(t,e,n)}};$n.prototype.ValueTypeName="bool";$n.prototype.ValueBufferType=Array;$n.prototype.DefaultInterpolation=Gs;$n.prototype.InterpolantFactoryMethodLinear=void 0;$n.prototype.InterpolantFactoryMethodSmooth=void 0;wo=class extends qe{};wo.prototype.ValueTypeName="color";Ao=class extends qe{};Ao.prototype.ValueTypeName="number";Co=class extends Pi{constructor(t,e,n,s){super(t,e,n,s)}interpolate_(t,e,n,s){let r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=(n-e)/(s-e),c=t*o;for(let h=c+o;c!==h;c+=4)An.slerpFlat(r,0,a,c-o,a,c,l);return r}},xr=class extends qe{InterpolantFactoryMethodLinear(t){return new Co(this.times,this.values,this.getValueSize(),t)}};xr.prototype.ValueTypeName="quaternion";xr.prototype.InterpolantFactoryMethodSmooth=void 0;Kn=class extends qe{constructor(t,e,n){super(t,e,n)}};Kn.prototype.ValueTypeName="string";Kn.prototype.ValueBufferType=Array;Kn.prototype.DefaultInterpolation=Gs;Kn.prototype.InterpolantFactoryMethodLinear=void 0;Kn.prototype.InterpolantFactoryMethodSmooth=void 0;Ro=class extends qe{};Ro.prototype.ValueTypeName="vector";Po=class{constructor(t,e,n){let s=this,r=!1,a=0,o=0,l,c=[];this.onStart=void 0,this.onLoad=t,this.onProgress=e,this.onError=n,this.itemStart=function(h){o++,r===!1&&s.onStart!==void 0&&s.onStart(h,a,o),r=!0},this.itemEnd=function(h){a++,s.onProgress!==void 0&&s.onProgress(h,a,o),a===o&&(r=!1,s.onLoad!==void 0&&s.onLoad())},this.itemError=function(h){s.onError!==void 0&&s.onError(h)},this.resolveURL=function(h){return l?l(h):h},this.setURLModifier=function(h){return l=h,this},this.addHandler=function(h,u){return c.push(h,u),this},this.removeHandler=function(h){let u=c.indexOf(h);return u!==-1&&c.splice(u,2),this},this.getHandler=function(h){for(let u=0,f=c.length;u<f;u+=2){let p=c[u],g=c[u+1];if(p.global&&(p.lastIndex=0),p.test(h))return g}return null}}},Ag=new Po,Io=class{constructor(t){this.manager=t!==void 0?t:Ag,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(t,e){let n=this;return new Promise(function(s,r){n.load(t,s,e,r)})}parse(){}setCrossOrigin(t){return this.crossOrigin=t,this}setWithCredentials(t){return this.withCredentials=t,this}setPath(t){return this.path=t,this}setResourcePath(t){return this.resourcePath=t,this}setRequestHeader(t){return this.requestHeader=t,this}};Io.DEFAULT_MATERIAL_NAME="__DEFAULT";vr=class{constructor(t=!0){this.autoStart=t,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=_c(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let t=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){let e=_c();t=(e-this.oldTime)/1e3,this.oldTime=e,this.elapsedTime+=t}return t}};Zo="\\[\\]\\.:\\/",Cg=new RegExp("["+Zo+"]","g"),Jo="[^"+Zo+"]",Rg="[^"+Zo.replace("\\.","")+"]",Pg=/((?:WC+[\/:])*)/.source.replace("WC",Jo),Ig=/(WCOD+)?/.source.replace("WCOD",Rg),Lg=/(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC",Jo),Dg=/\.(WC+)(?:\[(.+)\])?/.source.replace("WC",Jo),Ug=new RegExp("^"+Pg+Ig+Lg+Dg+"$"),Ng=["material","materials","bones","map"],Lo=class{constructor(t,e,n){let s=n||ne.parseTrackName(e);this._targetGroup=t,this._bindings=t.subscribe_(e,s)}getValue(t,e){this.bind();let n=this._targetGroup.nCachedObjects_,s=this._bindings[n];s!==void 0&&s.getValue(t,e)}setValue(t,e){let n=this._bindings;for(let s=this._targetGroup.nCachedObjects_,r=n.length;s!==r;++s)n[s].setValue(t,e)}bind(){let t=this._bindings;for(let e=this._targetGroup.nCachedObjects_,n=t.length;e!==n;++e)t[e].bind()}unbind(){let t=this._bindings;for(let e=this._targetGroup.nCachedObjects_,n=t.length;e!==n;++e)t[e].unbind()}},ne=class i{constructor(t,e,n){this.path=e,this.parsedPath=n||i.parseTrackName(e),this.node=i.findNode(t,this.parsedPath.nodeName),this.rootNode=t,this.getValue=this._getValue_unbound,this.setValue=this._setValue_unbound}static create(t,e,n){return t&&t.isAnimationObjectGroup?new i.Composite(t,e,n):new i(t,e,n)}static sanitizeNodeName(t){return t.replace(/\s/g,"_").replace(Cg,"")}static parseTrackName(t){let e=Ug.exec(t);if(e===null)throw new Error("PropertyBinding: Cannot parse trackName: "+t);let n={nodeName:e[2],objectName:e[3],objectIndex:e[4],propertyName:e[5],propertyIndex:e[6]},s=n.nodeName&&n.nodeName.lastIndexOf(".");if(s!==void 0&&s!==-1){let r=n.nodeName.substring(s+1);Ng.indexOf(r)!==-1&&(n.nodeName=n.nodeName.substring(0,s),n.objectName=r)}if(n.propertyName===null||n.propertyName.length===0)throw new Error("PropertyBinding: can not parse propertyName from trackName: "+t);return n}static findNode(t,e){if(e===void 0||e===""||e==="."||e===-1||e===t.name||e===t.uuid)return t;if(t.skeleton){let n=t.skeleton.getBoneByName(e);if(n!==void 0)return n}if(t.children){let n=function(r){for(let a=0;a<r.length;a++){let o=r[a];if(o.name===e||o.uuid===e)return o;let l=n(o.children);if(l)return l}return null},s=n(t.children);if(s)return s}return null}_getValue_unavailable(){}_setValue_unavailable(){}_getValue_direct(t,e){t[e]=this.targetObject[this.propertyName]}_getValue_array(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)t[e++]=n[s]}_getValue_arrayElement(t,e){t[e]=this.resolvedProperty[this.propertyIndex]}_getValue_toArray(t,e){this.resolvedProperty.toArray(t,e)}_setValue_direct(t,e){this.targetObject[this.propertyName]=t[e]}_setValue_direct_setNeedsUpdate(t,e){this.targetObject[this.propertyName]=t[e],this.targetObject.needsUpdate=!0}_setValue_direct_setMatrixWorldNeedsUpdate(t,e){this.targetObject[this.propertyName]=t[e],this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_array(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)n[s]=t[e++]}_setValue_array_setNeedsUpdate(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)n[s]=t[e++];this.targetObject.needsUpdate=!0}_setValue_array_setMatrixWorldNeedsUpdate(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)n[s]=t[e++];this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_arrayElement(t,e){this.resolvedProperty[this.propertyIndex]=t[e]}_setValue_arrayElement_setNeedsUpdate(t,e){this.resolvedProperty[this.propertyIndex]=t[e],this.targetObject.needsUpdate=!0}_setValue_arrayElement_setMatrixWorldNeedsUpdate(t,e){this.resolvedProperty[this.propertyIndex]=t[e],this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_fromArray(t,e){this.resolvedProperty.fromArray(t,e)}_setValue_fromArray_setNeedsUpdate(t,e){this.resolvedProperty.fromArray(t,e),this.targetObject.needsUpdate=!0}_setValue_fromArray_setMatrixWorldNeedsUpdate(t,e){this.resolvedProperty.fromArray(t,e),this.targetObject.matrixWorldNeedsUpdate=!0}_getValue_unbound(t,e){this.bind(),this.getValue(t,e)}_setValue_unbound(t,e){this.bind(),this.setValue(t,e)}bind(){let t=this.node,e=this.parsedPath,n=e.objectName,s=e.propertyName,r=e.propertyIndex;if(t||(t=i.findNode(this.rootNode,e.nodeName),this.node=t),this.getValue=this._getValue_unavailable,this.setValue=this._setValue_unavailable,!t){console.warn("THREE.PropertyBinding: No target node found for track: "+this.path+".");return}if(n){let c=e.objectIndex;switch(n){case"materials":if(!t.material){console.error("THREE.PropertyBinding: Can not bind to material as node does not have a material.",this);return}if(!t.material.materials){console.error("THREE.PropertyBinding: Can not bind to material.materials as node.material does not have a materials array.",this);return}t=t.material.materials;break;case"bones":if(!t.skeleton){console.error("THREE.PropertyBinding: Can not bind to bones as node does not have a skeleton.",this);return}t=t.skeleton.bones;for(let h=0;h<t.length;h++)if(t[h].name===c){c=h;break}break;case"map":if("map"in t){t=t.map;break}if(!t.material){console.error("THREE.PropertyBinding: Can not bind to material as node does not have a material.",this);return}if(!t.material.map){console.error("THREE.PropertyBinding: Can not bind to material.map as node.material does not have a map.",this);return}t=t.material.map;break;default:if(t[n]===void 0){console.error("THREE.PropertyBinding: Can not bind to objectName of node undefined.",this);return}t=t[n]}if(c!==void 0){if(t[c]===void 0){console.error("THREE.PropertyBinding: Trying to bind to objectIndex of objectName, but is undefined.",this,t);return}t=t[c]}}let a=t[s];if(a===void 0){let c=e.nodeName;console.error("THREE.PropertyBinding: Trying to update property for track: "+c+"."+s+" but it wasn't found.",t);return}let o=this.Versioning.None;this.targetObject=t,t.needsUpdate!==void 0?o=this.Versioning.NeedsUpdate:t.matrixWorldNeedsUpdate!==void 0&&(o=this.Versioning.MatrixWorldNeedsUpdate);let l=this.BindingType.Direct;if(r!==void 0){if(s==="morphTargetInfluences"){if(!t.geometry){console.error("THREE.PropertyBinding: Can not bind to morphTargetInfluences because node does not have a geometry.",this);return}if(!t.geometry.morphAttributes){console.error("THREE.PropertyBinding: Can not bind to morphTargetInfluences because node does not have a geometry.morphAttributes.",this);return}t.morphTargetDictionary[r]!==void 0&&(r=t.morphTargetDictionary[r])}l=this.BindingType.ArrayElement,this.resolvedProperty=a,this.propertyIndex=r}else a.fromArray!==void 0&&a.toArray!==void 0?(l=this.BindingType.HasFromToArray,this.resolvedProperty=a):Array.isArray(a)?(l=this.BindingType.EntireArray,this.resolvedProperty=a):this.propertyName=s;this.getValue=this.GetterByBindingType[l],this.setValue=this.SetterByBindingTypeAndVersioning[l][o]}unbind(){this.node=null,this.getValue=this._getValue_unbound,this.setValue=this._setValue_unbound}};ne.Composite=Lo;ne.prototype.BindingType={Direct:0,EntireArray:1,ArrayElement:2,HasFromToArray:3};ne.prototype.Versioning={None:0,NeedsUpdate:1,MatrixWorldNeedsUpdate:2};ne.prototype.GetterByBindingType=[ne.prototype._getValue_direct,ne.prototype._getValue_array,ne.prototype._getValue_arrayElement,ne.prototype._getValue_toArray];ne.prototype.SetterByBindingTypeAndVersioning=[[ne.prototype._setValue_direct,ne.prototype._setValue_direct_setNeedsUpdate,ne.prototype._setValue_direct_setMatrixWorldNeedsUpdate],[ne.prototype._setValue_array,ne.prototype._setValue_array_setNeedsUpdate,ne.prototype._setValue_array_setMatrixWorldNeedsUpdate],[ne.prototype._setValue_arrayElement,ne.prototype._setValue_arrayElement_setNeedsUpdate,ne.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate],[ne.prototype._setValue_fromArray,ne.prototype._setValue_fromArray_setNeedsUpdate,ne.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate]];kg=new Float32Array(1);typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:"170"}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__="170")});var Er,$o=ze(()=>{Er={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Ui.BlurDirectionX=new rt(1,0);Ui.BlurDirectionY=new rt(0,1)});var $c,Kc=ze(()=>{$c={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		...
		}`}});var Rr,Qc=ze(()=>{fn();Di();Kc();Rr=class extends Pe{constructor(){super();let t=$c;this.uniforms=Rn.clone(t.uniforms),this.material=new gr({name:t.name,uniforms:this.uniforms,vertexShader:t.vertexShader,fragmentShader:t.fragmentShader}),this.fsQuad=new Pn(this.material),this._outputColorSpace=null,this._toneMapping=null}render(t,e,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=t.toneMappingExposure,(this._outputColorSpace!==t.outputColorSpace||this._toneMapping!==t.toneMapping)&&(this._outputColorSpace=t.outputColorSpace,this._toneMapping=t.toneMapping,this.material.defines={},Xt.getTransfer(this._outputColorSpace)===$t&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===Do?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===Uo?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===No?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Fo?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===Oo?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===Bo&&(this.material.defines.NEUTRAL_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(t.setRenderTarget(null),this.fsQuad.render(t)):(t.setRenderTarget(e),this.clear&&t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil),this.fsQuad.render(t))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}});var zg=ih(()=>{fn();Xc();qc();Jc();Qc();var jc=(i,t=0,e=1)=>Math.max(t,Math.min(e,i)),jo=(i,t,e)=>i+(t-i)*e;function tl(i,t){let e;try{e=new nr({canvas:i,antialias:!0,powerPreference:"high-performance"}),e.debug.checkShaderErrors=!1}catch{return null}if(!e.getContext())return null;let{polys:n,boundary:s,dots:r,W:a,H:o,ramp:l,danube:c=[]}=t,h=4e3,u=a/2,f=o/2,p=B=>(B-u)*h,g=B=>(B-f)*h,_=new sr;_.background=new Ot(329487);let m=o*h*.94;_.fog=new ir(329487,m*1.5,m*3.4);let d=new Me(38,1,h*.01,m*6);{let B=new Ci(a*h*4,o*h*4),U=new Ne({color:329487}),J=new he(B,U);J.rotation.x=-Math.PI/2,J.position.y=-2,_.add(J)}{let B=new Zn(s.map(([Pt,z])=>new rt(p(Pt),-g(z)))),U=new mr(B);U.rotateX(-Math.PI/2);let J=new Ne({color:790559}),et=new he(U,J);et.position.y=-1,_.add(et);let lt=new ce().setFromPoints(s.map(([Pt,z])=>new I(p(Pt),.5,g(z)))),_t=new Ri(lt,new Yn({color:4015464,transparent:!0,opacity:0}));_.add(_t),tl.boundLine=_t}{let B=a*h*.006;for(let U of c){if(U.length<2)continue;let J=[];for(let _t=0;_t<U.length;_t++){let[Pt,z]=U[_t],[K,ft]=U[Math.min(_t+1,U.length-1)],[at,Ct]=U[Math.max(_t-1,0)],Lt=p(K)-p(at),It=g(ft)-g(Ct),Gt=Math.hypot(Lt,It)||1;Lt/=Gt,It/=Gt;let $=-It*B,it=Lt*B;J.push(p(Pt)+$,.4,g(z)+it,p(Pt)-$,.4,g(z)-it)}let et=[];for(let _t=0;_t<U.length-1;_t++){let Pt=_t*2;et.push(Pt,Pt+1,Pt+2,Pt+1,Pt+3,Pt+2)}let lt=new ce;lt.setAttribute("position",new Se(new Float32Array(J),3)),lt.setIndex(et),_.add(new he(lt,new Ne({color:2768504,transparent:!0,opacity:.95,depthWrite:!1,side:Ge})))}}let T;{let B=new Float32Array(r.length*3);r.forEach((J,et)=>{B[et*3]=p(J.x),B[et*3+1]=1.5,B[et*3+2]=g(J.y)});let U=new ce;U.setAttribute("position",new Se(B,3)),T=new ts({color:16771512,size:2.4,sizeAttenuation:!1,transparent:!0,opacity:0,depthWrite:!1}),_.add(new or(U,T))}let b=[],M=o*h*.006;for(let B of n){let U=B.pts.map(([lt,_t])=>new rt(p(lt),-g(_t))),J=null,et=null;try{let lt=new Zn(U),_t=new fr(lt,{depth:M,bevelEnabled:!1});_t.rotateX(-Math.PI/2);let Pt=new Ne({transparent:!0,opacity:.5,depthWrite:!1});J=new he(_t,Pt),_.add(J);let z=new ce().setFromPoints(B.pts.map(([K,ft])=>new I(p(K),M+.6,g(ft))));if(J.userData.edge=new Ri(z,new Yn({color:16774883,transparent:!0,opacity:0,depthWrite:!1})),_.add(J.userData.edge),B.own==="private"){let K=B.pts.map(([Ct,Lt])=>new I(p(Ct),M+1,g(Lt))),ft=new ce().setFromPoints(K),at=new _r({color:16771512,dashSize:h*.002,gapSize:h*.0012,transparent:!0,opacity:0});et=new Ri(ft,at),et.computeLineDistances(),_.add(et)}}catch{}b.push({mesh:J,dash:et,t:B.t,phase:B.phase,big:B.big,cx:B.cx,cy:B.cy,col:new Ot,prevS:0})}function O(B,U){let J=jc(B)*3,et=Math.min(2,Math.floor(J)),lt=J-et,_t=l[et],Pt=l[et+1];return U.setRGB(jo(_t[0],Pt[0],lt)/255,jo(_t[1],Pt[1],lt)/255,jo(_t[2],Pt[2],lt)/255),U}let C=[];{let B=new pr(.86,1,40);B.rotateX(-Math.PI/2);for(let U=0;U<18;U++){let J=new he(B,new Ne({color:16771512,transparent:!0,opacity:0,depthWrite:!1}));J.visible=!1,J.position.y=M+1,_.add(J),C.push({m:J,t0:-1})}}let R=0;function N(B,U,J){let et=C[R++%C.length];et.t0=J,et.m.position.x=B,et.m.position.z=U,et.m.visible=!0}let E=new Ar(e);E.addPass(new Cr(_,d));let y=new Ui(new rt(2,2),.42,.4,.74);E.addPass(y),E.addPass(new Rr);let A=2,Z=2;function H(B,U,J){A=B,Z=U,e.setPixelRatio(Math.min(J||1,1.5)),e.setSize(B,U,!1),E.setSize(B,U),d.aspect=B/U,d.updateProjectionMatrix()}let G=new I;function j(B,U){return G.set(p(B),M+2,g(U)).project(d),{x:(G.x*.5+.5)*A,y:(-G.y*.5+.5)*Z,vis:G.z<1}}function W(B){let U=B.smx*.11+Math.sin(B.t*4e-5)*.022,J=Lc.degToRad(53)-B.smy*.07,et=m/B.camZ,lt=-B.camX*a*h*.9,_t=-B.camY*o*h*.9;d.position.set(lt+Math.sin(U)*et*Math.cos(J),Math.sin(J)*et,_t+Math.cos(U)*et*Math.cos(J)),d.lookAt(lt,0,_t),T.opacity=B.ctxA*.55,tl.boundLine.material.opacity=.25+B.ctxA*.5;let Pt=0;for(let z of b){let K=jc((B.wave*1.22-z.t)*3.2);if(K>.55&&Pt++,!z.mesh)continue;let ft=K<.15?.5+.28*Math.sin(B.t*.0016+z.phase):1;O(K,z.col),z.col.multiplyScalar(.4+K*.78),z.mesh.material.color.copy(z.col),z.mesh.material.opacity=Math.min(1,(.62+K*.38)*ft*B.hb),z.mesh.userData.edge.material.opacity=K*.8,z.dash&&(z.dash.material.opacity=(K<.2?B.own:0)*.95),K>=.5&&z.prevS<.5&&B.wave>0&&B.wave<1&&N(p(z.cx),g(z.cy),B.t),z.prevS=K}for(let z of C){if(z.t0<0)continue;let K=(B.t-z.t0)/950;if(K>=1){z.m.visible=!1,z.t0=-1;continue}let ft=a*h*(.012+K*.05);z.m.scale.set(ft,1,ft),z.m.material.opacity=(1-K)*(1-K)*.55}return E.render(),Pt}return{frame:W,project:j,resize:H}}window.ZazniGL={init:tl}});zg();})();
