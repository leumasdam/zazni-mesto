...
`)+`
`+d);let b=T+m+a,M=T+d+o,B=Ql(s,s.VERTEX_SHADER,b),C=Ql(s,s.FRAGMENT_SHADER,M);s.attachShader(_,B),s.attachShader(_,C),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function R(A){if(i.debug.checkShaderErrors){let J=s.getProgramInfoLog(_).trim(),k=s.getShaderInfoLog(B).trim(),H=s.getShaderInfoLog(C).trim(),j=!0,G=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,B,C);else{let O=tc(s,B,"vertex"),U=tc(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
	...
	if ( coord.x >= 1.0 ) {
...
}`,co=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){let s=new Ue,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new ue({vertexShader:Zm,fragmentShader:Jm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new he(new Ci(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},ho=class extends wn{constructor(t,e){super();let n=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,f=null,p=null,g=null,_=new co,m=e.getContextAttributes(),d=null,T=null,b=[],M=[],B=new at,C=null,R=new Me;R.viewport=new ae;let N=new Me;N.viewport=new ae;let E=[R,N],y=new lo,A=null,J=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let q=b[X];return q===void 0&&(q=new qi,b[X]=q),q.getTargetRaySpace()},this.getControllerGrip=function(X){let q=b[X];return q===void 0&&(q=new qi,b[X]=q),q.getGripSpace()},this.getHand=function(X){let q=b[X];return q===void 0&&(q=new qi,b[X]=q),q.getHandSpace()};function k(X){let q=M.indexOf(X.inputSource);if(q===-1)return;let lt=b[q];lt!==void 0&&(lt.update(X.inputSource,X.frame,c||a),lt.dispatchEvent({type:X.type,data:X.inputSource}))}function H(){s.removeEventListener("select",k),s.removeEventListener("selectstart",k),s.removeEventListener("selectend",k),s.removeEventListener("squeeze",k),s.removeEventListener("squeezestart",k),s.removeEventListener("squeezeend",k),s.removeEventListener("end",H),s.removeEventListener("inputsourceschange",j);for(let X=0;X<b.length;X++){let q=M[X];q!==null&&(M[X]=null,b[X].disconnect(q))}A=null,J=null,_.reset(),t.setRenderTarget(d),p=null,f=null,u=null,s=null,T=null,Pt.stop(),n.isPresenting=!1,t.setPixelRatio(C),t.setSize(B.width,B.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){r=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){o=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(X){c=X},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return u},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(X){if(s=X,s!==null){if(d=t.getRenderTarget(),s.addEventListener("select",k),s.addEventListener("selectstart",k),s.addEventListener("selectend",k),s.addEventListener("squeeze",k),s.addEventListener("squeezestart",k),s.addEventListener("squeezeend",k),s.addEventListener("end",H),s.addEventListener("inputsourceschange",j),m.xrCompatible!==!0&&await e.makeXRCompatible(),C=t.getPixelRatio(),t.getSize(B),s.renderState.layers===void 0){let q={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,e,q),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),T=new be(p.framebufferWidth,p.framebufferHeight,{format:We,type:un,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil})}else{let q=null,lt=null,it=null;m.depth&&(it=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,q=m.stencil?wi:vi,lt=m.stencil?Ti:Wn);let Et={colorFormat:e.RGBA8,depthFormat:it,scaleFactor:r};u=new XRWebGLBinding(s,e),f=u.createProjectionLayer(Et),s.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),T=new be(f.textureWidth,f.textureHeight,{format:We,type:un,depthTexture:new er(f.textureWidth,f.textureHeight,lt,void 0,void 0,void 0,void 0,void 0,void 0,q),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),Pt.setContext(s),Pt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function j(X){for(let q=0;q<X.removed.length;q++){let lt=X.removed[q],it=M.indexOf(lt);it>=0&&(M[it]=null,b[it].disconnect(lt))}for(let q=0;q<X.added.length;q++){let lt=X.added[q],it=M.indexOf(lt);if(it===-1){for(let It=0;It<b.length;It++)if(It>=M.length){M.push(lt),it=It;break}else if(M[It]===null){M[It]=lt,it=It;break}if(it===-1)break}let Et=b[it];Et&&Et.connect(lt)}}let G=new I,O=new I;function U(X,q,lt){G.setFromMatrixPosition(q.matrixWorld),O.setFromMatrixPosition(lt.matrixWorld);let it=G.distanceTo(O),Et=q.projectionMatrix.elements,It=lt.projectionMatrix.elements,Lt=Et[14]/(Et[10]-1),Gt=Et[14]/(Et[10]+1),K=(Et[9]+1)/Et[5],st=(Et[9]-1)/Et[5],w=(Et[8]-1)/Et[0],Ct=(It[8]+1)/It[0],nt=Lt*w,yt=Lt*Ct,ht=it/(-w+Ct),Dt=ht*-w;if(q.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(Dt),X.translateZ(ht),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),Et[10]===-1)X.projectionMatrix.copy(q.projectionMatrix),X.projectionMatrixInverse.copy(q.projectionMatrixInverse);else{let xt=Lt+ht,S=Gt+ht,x=nt-Dt,F=yt+(it-Dt),Y=K*Gt/S*xt,tt=st*Gt/S*xt;X.projectionMatrix.makePerspective(x,F,Y,tt,xt,S),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function $(X,q){q===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(q.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(s===null)return;let q=X.near,lt=X.far;_.texture!==null&&(_.depthNear>0&&(q=_.depthNear),_.depthFar>0&&(lt=_.depthFar)),y.near=N.near=R.near=q,y.far=N.far=R.far=lt,(A!==y.near||J!==y.far)&&(s.updateRenderState({depthNear:y.near,depthFar:y.far}),A=y.near,J=y.far),R.layers.mask=X.layers.mask|2,N.layers.mask=X.layers.mask|4,y.layers.mask=R.layers.mask|N.layers.mask;let it=X.parent,Et=y.cameras;$(y,it);for(let It=0;It<Et.length;It++)$(Et[It],it);Et.length===2?U(y,R,N):y.projectionMatrix.copy(R.projectionMatrix),et(X,y,it)};function et(X,q,lt){lt===null?X.matrix.copy(q.matrixWorld):(X.matrix.copy(lt.matrixWorld),X.matrix.invert(),X.matrix.multiply(q.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(q.projectionMatrix),X.projectionMatrixInverse.copy(q.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=$i*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(X){l=X,f!==null&&(f.fixedFoveation=X),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=X)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(y)};let ct=null;function _t(X,q){if(h=q.getViewerPose(c||a),g=q,h!==null){let lt=h.views;p!==null&&(t.setRenderTargetFramebuffer(T,p.framebuffer),t.setRenderTarget(T));let it=!1;lt.length!==y.cameras.length&&(y.cameras.length=0,it=!0);for(let It=0;It<lt.length;It++){let Lt=lt[It],Gt=null;if(p!==null)Gt=p.getViewport(Lt);else{let st=u.getViewSubImage(f,Lt);Gt=st.viewport,It===0&&(t.setRenderTargetTextures(T,st.colorTexture,f.ignoreDepthValues?void 0:st.depthStencilTexture),t.setRenderTarget(T))}let K=E[It];K===void 0&&(K=new Me,K.layers.enable(It),K.viewport=new ae,E[It]=K),K.matrix.fromArray(Lt.transform.matrix),K.matrix.decompose(K.position,K.quaternion,K.scale),K.projectionMatrix.fromArray(Lt.projectionMatrix),K.projectionMatrixInverse.copy(K.projectionMatrix).invert(),K.viewport.set(Gt.x,Gt.y,Gt.width,Gt.height),It===0&&(y.matrix.copy(K.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),it===!0&&y.cameras.push(K)}let Et=s.enabledFeatures;if(Et&&Et.includes("depth-sensing")){let It=u.getDepthInformation(lt[0]);It&&It.isValid&&It.texture&&_.init(t,It,s.renderState)}}for(let lt=0;lt<b.length;lt++){let it=M[lt],Et=b[lt];it!==null&&Et!==void 0&&Et.update(it,q,c||a)}ct&&ct(X,q),q.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:q}),g=null}let Pt=new Fc;Pt.setAnimationLoop(_t),this.setAnimationLoop=function(X){ct=X},this.dispose=function(){}}},On=new dn,$m=new re;nr=class{constructor(t={}){let{canvas:e=nu(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reverseDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=a;let g=new Uint32Array(4),_=new Int32Array(4),m=null,d=null,T=[],b=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=De,this.toneMapping=bn,this.toneMappingExposure=1;let M=this,B=!1,C=0,R=0,N=null,E=-1,y=null,A=new ae,J=new ae,k=null,H=new Ot(0),j=0,G=e.width,O=e.height,U=1,$=null,et=null,ct=new ae(0,0,G,O),_t=new ae(0,0,G,O),Pt=!1,X=new js,q=!1,lt=!1,it=new re,Et=new re,It=new I,Lt=new ae,Gt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},K=!1;function st(){return N===null?U:1}let w=n;function Ct(v,L){return e.getContext(v,L)}try{let v={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine","three.js r170"),e.addEventListener("webglcontextlost",Q,!1),e.addEventListener("webglcontextrestored",gt,!1),e.addEventListener("webglcontextcreationerror",pt,!1),w===null){let L="webgl2";if(w=Ct(L,v),w===null)throw Ct(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw console.error("THREE.WebGLRenderer: "+v.message),v}let nt,yt,ht,Dt,xt,S,x,F,Y,tt,Z,bt,dt,vt,Wt,rt,Mt,Ut,Nt,St,qt,kt,Qt,P;function ft(){nt=new pp(w),nt.init(),kt=new qm(w,nt),yt=new lp(w,nt,t,kt),ht=new Gm(w,nt),yt.reverseDepthBuffer&&f&&ht.buffers.depth.setReversed(!0),Dt=new _p(w),xt=new Pm,S=new Xm(w,nt,ht,xt,yt,kt,Dt),x=new hp(M),F=new fp(M),Y=new bu(w),Qt=new ap(w,Y),tt=new mp(w,Y,Dt,Qt),Z=new vp(w,tt,Y,Dt),Nt=new xp(w,yt,S),rt=new cp(xt),bt=new Rm(M,x,F,nt,yt,Qt,rt),dt=new Km(M,xt),vt=new Lm,Wt=new Bm(nt),Ut=new rp(M,x,F,ht,Z,p,l),Mt=new km(M,Z,yt),P=new Qm(w,Dt,yt,ht),St=new op(w,nt,Dt),qt=new gp(w,nt,Dt),Dt.programs=bt.programs,M.capabilities=yt,M.extensions=nt,M.properties=xt,M.renderLists=vt,M.shadowMap=Mt,M.state=ht,M.info=Dt}ft();let W=new ho(M,w);this.xr=W,this.getContext=function(){return w},this.getContextAttributes=function(){return w.getContextAttributes()},this.forceContextLoss=function(){let v=nt.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){let v=nt.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return U},this.setPixelRatio=function(v){v!==void 0&&(U=v,this.setSize(G,O,!1))},this.getSize=function(v){return v.set(G,O)},this.setSize=function(v,L,z=!0){if(W.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}G=v,O=L,e.width=Math.floor(v*U),e.height=Math.floor(L*U),z===!0&&(e.style.width=v+"px",e.style.height=L+"px"),this.setViewport(0,0,v,L)},this.getDrawingBufferSize=function(v){return v.set(G*U,O*U).floor()},this.setDrawingBufferSize=function(v,L,z){G=v,O=L,U=z,e.width=Math.floor(v*z),e.height=Math.floor(L*z),this.setViewport(0,0,v,L)},this.getCurrentViewport=function(v){return v.copy(A)},this.getViewport=function(v){return v.copy(ct)},this.setViewport=function(v,L,z,V){v.isVector4?ct.set(v.x,v.y,v.z,v.w):ct.set(v,L,z,V),ht.viewport(A.copy(ct).multiplyScalar(U).round())},this.getScissor=function(v){return v.copy(_t)},this.setScissor=function(v,L,z,V){v.isVector4?_t.set(v.x,v.y,v.z,v.w):_t.set(v,L,z,V),ht.scissor(J.copy(_t).multiplyScalar(U).round())},this.getScissorTest=function(){return Pt},this.setScissorTest=function(v){ht.setScissorTest(Pt=v)},this.setOpaqueSort=function(v){$=v},this.setTransparentSort=function(v){et=v},this.getClearColor=function(v){return v.copy(Ut.getClearColor())},this.setClearColor=function(){Ut.setClearColor.apply(Ut,arguments)},this.getClearAlpha=function(){return Ut.getClearAlpha()},this.setClearAlpha=function(){Ut.setClearAlpha.apply(Ut,arguments)},this.clear=function(v=!0,L=!0,z=!0){let V=0;if(v){let D=!1;if(N!==null){let ot=N.texture.format;D=ot===Wo||ot===Go||ot===Ho}if(D){let ot=N.texture.type,mt=ot===un||ot===Wn||ot===Ji||ot===Ti||ot===Vo||ot===ko,Tt=Ut.getClearColor(),wt=Ut.getClearAlpha(),Ft=Tt.r,zt=Tt.g,At=Tt.b;mt?(g[0]=Ft,g[1]=zt,g[2]=At,g[3]=wt,w.clearBufferuiv(w.COLOR,0,g)):(_[0]=Ft,_[1]=zt,_[2]=At,_[3]=wt,w.clearBufferiv(w.COLOR,0,_))}else V|=w.COLOR_BUFFER_BIT}L&&(V|=w.DEPTH_BUFFER_BIT),z&&(V|=w.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),w.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Q,!1),e.removeEventListener("webglcontextrestored",gt,!1),e.removeEventListener("webglcontextcreationerror",pt,!1),vt.dispose(),Wt.dispose(),xt.dispose(),x.dispose(),F.dispose(),Z.dispose(),Qt.dispose(),P.dispose(),bt.dispose(),W.dispose(),W.removeEventListener("sessionstart",el),W.removeEventListener("sessionend",nl),In.stop()};function Q(v){v.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),B=!0}function gt(){console.log("THREE.WebGLRenderer: Context Restored."),B=!1;let v=Dt.autoReset,L=Mt.enabled,z=Mt.autoUpdate,V=Mt.needsUpdate,D=Mt.type;ft(),Dt.autoReset=v,Mt.enabled=L,Mt.autoUpdate=z,Mt.needsUpdate=V,Mt.type=D}function pt(v){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function Bt(v){let L=v.target;L.removeEventListener("dispose",Bt),se(L)}function se(v){ge(v),xt.remove(v)}function ge(v){let L=xt.get(v).programs;L!==void 0&&(L.forEach(function(z){bt.releaseProgram(z)}),v.isShaderMaterial&&bt.releaseShaderCache(v))}this.renderBufferDirect=function(v,L,z,V,D,ot){L===null&&(L=Gt);let mt=D.isMesh&&D.matrixWorld.determinant()<0,Tt=th(v,L,z,V,D);ht.setMaterial(V,mt);let wt=z.index,Ft=1;if(V.wireframe===!0){if(wt=tt.getWireframeAttribute(z),wt===void 0)return;Ft=2}let zt=z.drawRange,At=z.attributes.position,Yt=zt.start*Ft,jt=(zt.start+zt.count)*Ft;ot!==null&&(Yt=Math.max(Yt,ot.start*Ft),jt=Math.min(jt,(ot.start+ot.count)*Ft)),wt!==null?(Yt=Math.max(Yt,0),jt=Math.min(jt,wt.count)):At!=null&&(Yt=Math.max(Yt,0),jt=Math.min(jt,At.count));let te=jt-Yt;if(te<0||te===1/0)return;Qt.setup(D,V,Tt,z,wt);let Ee,Zt=St;if(wt!==null&&(Ee=Y.get(wt),Zt=qt,Zt.setIndex(Ee)),D.isMesh)V.wireframe===!0?(ht.setLineWidth(V.wireframeLinewidth*st()),Zt.setMode(w.LINES)):Zt.setMode(w.TRIANGLES);else if(D.isLine){let Rt=V.linewidth;Rt===void 0&&(Rt=1),ht.setLineWidth(Rt*st()),D.isLineSegments?Zt.setMode(w.LINES):D.isLineLoop?Zt.setMode(w.LINE_LOOP):Zt.setMode(w.LINE_STRIP)}else D.isPoints?Zt.setMode(w.POINTS):D.isSprite&&Zt.setMode(w.TRIANGLES);if(D.isBatchedMesh)if(D._multiDrawInstances!==null)Zt.renderMultiDrawInstances(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount,D._multiDrawInstances);else if(nt.get("WEBGL_multi_draw"))Zt.renderMultiDraw(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount);else{let Rt=D._multiDrawStarts,je=D._multiDrawCounts,Jt=D._multiDrawCount,Be=wt?Y.get(wt).bytesPerElement:1,jn=xt.get(V).currentProgram.getUniforms();for(let we=0;we<Jt;we++)jn.setValue(w,"_gl_DrawID",we),Zt.render(Rt[we]/Be,je[we])}else if(D.isInstancedMesh)Zt.renderInstances(Yt,te,D.count);else if(z.isInstancedBufferGeometry){let Rt=z._maxInstanceCount!==void 0?z._maxInstanceCount:1/0,je=Math.min(z.instanceCount,Rt);Zt.renderInstances(Yt,te,je)}else Zt.render(Yt,te)};function Kt(v,L,z){v.transparent===!0&&v.side===Ge&&v.forceSinglePass===!1?(v.side=Te,v.needsUpdate=!0,os(v,L,z),v.side=Tn,v.needsUpdate=!0,os(v,L,z),v.side=Ge):os(v,L,z)}this.compile=function(v,L,z=null){z===null&&(z=v),d=Wt.get(z),d.init(L),b.push(d),z.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(d.pushLight(D),D.castShadow&&d.pushShadow(D))}),v!==z&&v.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(d.pushLight(D),D.castShadow&&d.pushShadow(D))}),d.setupLights();let V=new Set;return v.traverse(function(D){if(!(D.isMesh||D.isPoints||D.isLine||D.isSprite))return;let ot=D.material;if(ot)if(Array.isArray(ot))for(let mt=0;mt<ot.length;mt++){let Tt=ot[mt];Kt(Tt,z,D),V.add(Tt)}else Kt(ot,z,D),V.add(ot)}),b.pop(),d=null,V},this.compileAsync=function(v,L,z=null){let V=this.compile(v,L,z);return new Promise(D=>{function ot(){if(V.forEach(function(mt){xt.get(mt).currentProgram.isReady()&&V.delete(mt)}),V.size===0){D(v);return}setTimeout(ot,10)}nt.get("KHR_parallel_shader_compile")!==null?ot():setTimeout(ot,10)})};let Oe=null;function Qe(v){Oe&&Oe(v)}function el(){In.stop()}function nl(){In.start()}let In=new Fc;In.setAnimationLoop(Qe),typeof self<"u"&&In.setContext(self),this.setAnimationLoop=function(v){Oe=v,W.setAnimationLoop(v),v===null?In.stop():In.start()},W.addEventListener("sessionstart",el),W.addEventListener("sessionend",nl),this.render=function(v,L){if(L!==void 0&&L.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(B===!0)return;if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),W.enabled===!0&&W.isPresenting===!0&&(W.cameraAutoUpdate===!0&&W.updateCamera(L),L=W.getCamera()),v.isScene===!0&&v.onBeforeRender(M,v,L,N),d=Wt.get(v,b.length),d.init(L),b.push(d),Et.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),X.setFromProjectionMatrix(Et),lt=this.localClippingEnabled,q=rt.init(this.clippingPlanes,lt),m=vt.get(v,T.length),m.init(),T.push(m),W.enabled===!0&&W.isPresenting===!0){let ot=M.xr.getDepthSensingMesh();ot!==null&&Pr(ot,L,-1/0,M.sortObjects)}Pr(v,L,0,M.sortObjects),m.finish(),M.sortObjects===!0&&m.sort($,et),K=W.enabled===!1||W.isPresenting===!1||W.hasDepthSensing()===!1,K&&Ut.addToRenderList(m,v),this.info.render.frame++,q===!0&&rt.beginShadows();let z=d.state.shadowsArray;Mt.render(z,v,L),q===!0&&rt.endShadows(),this.info.autoReset===!0&&this.info.reset();let V=m.opaque,D=m.transmissive;if(d.setupLights(),L.isArrayCamera){let ot=L.cameras;if(D.length>0)for(let mt=0,Tt=ot.length;mt<Tt;mt++){let wt=ot[mt];sl(V,D,v,wt)}K&&Ut.render(v);for(let mt=0,Tt=ot.length;mt<Tt;mt++){let wt=ot[mt];il(m,v,wt,wt.viewport)}}else D.length>0&&sl(V,D,v,L),K&&Ut.render(v),il(m,v,L);N!==null&&(S.updateMultisampleRenderTarget(N),S.updateRenderTargetMipmap(N)),v.isScene===!0&&v.onAfterRender(M,v,L),Qt.resetDefaultState(),E=-1,y=null,b.pop(),b.length>0?(d=b[b.length-1],q===!0&&rt.setGlobalState(M.clippingPlanes,d.state.camera)):d=null,T.pop(),T.length>0?m=T[T.length-1]:m=null};function Pr(v,L,z,V){if(v.visible===!1)return;if(v.layers.test(L.layers)){if(v.isGroup)z=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(L);else if(v.isLight)d.pushLight(v),v.castShadow&&d.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||X.intersectsSprite(v)){V&&Lt.setFromMatrixPosition(v.matrixWorld).applyMatrix4(Et);let mt=Z.update(v),Tt=v.material;Tt.visible&&m.push(v,mt,Tt,z,Lt.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||X.intersectsObject(v))){let mt=Z.update(v),Tt=v.material;if(V&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),Lt.copy(v.boundingSphere.center)):(mt.boundingSphere===null&&mt.computeBoundingSphere(),Lt.copy(mt.boundingSphere.center)),Lt.applyMatrix4(v.matrixWorld).applyMatrix4(Et)),Array.isArray(Tt)){let wt=mt.groups;for(let Ft=0,zt=wt.length;Ft<zt;Ft++){let At=wt[Ft],Yt=Tt[At.materialIndex];Yt&&Yt.visible&&m.push(v,mt,Yt,z,Lt.z,At)}}else Tt.visible&&m.push(v,mt,Tt,z,Lt.z,null)}}let ot=v.children;for(let mt=0,Tt=ot.length;mt<Tt;mt++)Pr(ot[mt],L,z,V)}function il(v,L,z,V){let D=v.opaque,ot=v.transmissive,mt=v.transparent;d.setupLightsView(z),q===!0&&rt.setGlobalState(M.clippingPlanes,z),V&&ht.viewport(A.copy(V)),D.length>0&&as(D,L,z),ot.length>0&&as(ot,L,z),mt.length>0&&as(mt,L,z),ht.buffers.depth.setTest(!0),ht.buffers.depth.setMask(!0),ht.buffers.color.setMask(!0),ht.setPolygonOffset(!1)}function sl(v,L,z,V){if((z.isScene===!0?z.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[V.id]===void 0&&(d.state.transmissionRenderTarget[V.id]=new be(1,1,{generateMipmaps:!0,type:nt.has("EXT_color_buffer_half_float")||nt.has("EXT_color_buffer_float")?Ye:un,minFilter:Gn,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Xt.workingColorSpace}));let ot=d.state.transmissionRenderTarget[V.id],mt=V.viewport||A;ot.setSize(mt.z,mt.w);let Tt=M.getRenderTarget();M.setRenderTarget(ot),M.getClearColor(H),j=M.getClearAlpha(),j<1&&M.setClearColor(16777215,.5),M.clear(),K&&Ut.render(z);let wt=M.toneMapping;M.toneMapping=bn;let Ft=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),d.setupLightsView(V),q===!0&&rt.setGlobalState(M.clippingPlanes,V),as(v,z,V),S.updateMultisampleRenderTarget(ot),S.updateRenderTargetMipmap(ot),nt.has("WEBGL_multisampled_render_to_texture")===!1){let zt=!1;for(let At=0,Yt=L.length;At<Yt;At++){let jt=L[At],te=jt.object,Ee=jt.geometry,Zt=jt.material,Rt=jt.group;if(Zt.side===Ge&&te.layers.test(V.layers)){let je=Zt.side;Zt.side=Te,Zt.needsUpdate=!0,rl(te,z,V,Ee,Zt,Rt),Zt.side=je,Zt.needsUpdate=!0,zt=!0}}zt===!0&&(S.updateMultisampleRenderTarget(ot),S.updateRenderTargetMipmap(ot))}M.setRenderTarget(Tt),M.setClearColor(H,j),Ft!==void 0&&(V.viewport=Ft),M.toneMapping=wt}function as(v,L,z){let V=L.isScene===!0?L.overrideMaterial:null;for(let D=0,ot=v.length;D<ot;D++){let mt=v[D],Tt=mt.object,wt=mt.geometry,Ft=V===null?mt.material:V,zt=mt.group;Tt.layers.test(z.layers)&&rl(Tt,L,z,wt,Ft,zt)}}function rl(v,L,z,V,D,ot){v.onBeforeRender(M,L,z,V,D,ot),v.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),D.onBeforeRender(M,L,z,V,v,ot),D.transparent===!0&&D.side===Ge&&D.forceSinglePass===!1?(D.side=Te,D.needsUpdate=!0,M.renderBufferDirect(z,L,V,D,v,ot),D.side=Tn,D.needsUpdate=!0,M.renderBufferDirect(z,L,V,D,v,ot),D.side=Ge):M.renderBufferDirect(z,L,V,D,v,ot),v.onAfterRender(M,L,z,V,D,ot)}function os(v,L,z){L.isScene!==!0&&(L=Gt);let V=xt.get(v),D=d.state.lights,ot=d.state.shadowsArray,mt=D.state.version,Tt=bt.getParameters(v,D.state,ot,L,z),wt=bt.getProgramCacheKey(Tt),Ft=V.programs;V.environment=v.isMeshStandardMaterial?L.environment:null,V.fog=L.fog,V.envMap=(v.isMeshStandardMaterial?F:x).get(v.envMap||V.environment),V.envMapRotation=V.environment!==null&&v.envMap===null?L.environmentRotation:v.envMapRotation,Ft===void 0&&(v.addEventListener("dispose",Bt),Ft=new Map,V.programs=Ft);let zt=Ft.get(wt);if(zt!==void 0){if(V.currentProgram===zt&&V.lightsStateVersion===mt)return ol(v,Tt),zt}else Tt.uniforms=bt.getUniforms(v),v.onBeforeCompile(Tt,M),zt=bt.acquireProgram(Tt,wt),Ft.set(wt,zt),V.uniforms=Tt.uniforms;let At=V.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(At.clippingPlanes=rt.uniform),ol(v,Tt),V.needsLights=nh(v),V.lightsStateVersion=mt,V.needsLights&&(At.ambientLightColor.value=D.state.ambient,At.lightProbe.value=D.state.probe,At.directionalLights.value=D.state.directional,At.directionalLightShadows.value=D.state.directionalShadow,At.spotLights.value=D.state.spot,At.spotLightShadows.value=D.state.spotShadow,At.rectAreaLights.value=D.state.rectArea,At.ltc_1.value=D.state.rectAreaLTC1,At.ltc_2.value=D.state.rectAreaLTC2,At.pointLights.value=D.state.point,At.pointLightShadows.value=D.state.pointShadow,At.hemisphereLights.value=D.state.hemi,At.directionalShadowMap.value=D.state.directionalShadowMap,At.directionalShadowMatrix.value=D.state.directionalShadowMatrix,At.spotShadowMap.value=D.state.spotShadowMap,At.spotLightMatrix.value=D.state.spotLightMatrix,At.spotLightMap.value=D.state.spotLightMap,At.pointShadowMap.value=D.state.pointShadowMap,At.pointShadowMatrix.value=D.state.pointShadowMatrix),V.currentProgram=zt,V.uniformsList=null,zt}function al(v){if(v.uniformsList===null){let L=v.currentProgram.getUniforms();v.uniformsList=Mi.seqWithValue(L.seq,v.uniforms)}return v.uniformsList}function ol(v,L){let z=xt.get(v);z.outputColorSpace=L.outputColorSpace,z.batching=L.batching,z.batchingColor=L.batchingColor,z.instancing=L.instancing,z.instancingColor=L.instancingColor,z.instancingMorph=L.instancingMorph,z.skinning=L.skinning,z.morphTargets=L.morphTargets,z.morphNormals=L.morphNormals,z.morphColors=L.morphColors,z.morphTargetsCount=L.morphTargetsCount,z.numClippingPlanes=L.numClippingPlanes,z.numIntersection=L.numClipIntersection,z.vertexAlphas=L.vertexAlphas,z.vertexTangents=L.vertexTangents,z.toneMapping=L.toneMapping}function th(v,L,z,V,D){L.isScene!==!0&&(L=Gt),S.resetTextureUnits();let ot=L.fog,mt=V.isMeshStandardMaterial?L.environment:null,Tt=N===null?M.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:Ii,wt=(V.isMeshStandardMaterial?F:x).get(V.envMap||mt),Ft=V.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,zt=!!z.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),At=!!z.morphAttributes.position,Yt=!!z.morphAttributes.normal,jt=!!z.morphAttributes.color,te=bn;V.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(te=M.toneMapping);let Ee=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,Zt=Ee!==void 0?Ee.length:0,Rt=xt.get(V),je=d.state.lights;if(q===!0&&(lt===!0||v!==y)){let Ie=v===y&&V.id===E;rt.setState(V,v,Ie)}let Jt=!1;V.version===Rt.__version?(Rt.needsLights&&Rt.lightsStateVersion!==je.state.version||Rt.outputColorSpace!==Tt||D.isBatchedMesh&&Rt.batching===!1||!D.isBatchedMesh&&Rt.batching===!0||D.isBatchedMesh&&Rt.batchingColor===!0&&D.colorTexture===null||D.isBatchedMesh&&Rt.batchingColor===!1&&D.colorTexture!==null||D.isInstancedMesh&&Rt.instancing===!1||!D.isInstancedMesh&&Rt.instancing===!0||D.isSkinnedMesh&&Rt.skinning===!1||!D.isSkinnedMesh&&Rt.skinning===!0||D.isInstancedMesh&&Rt.instancingColor===!0&&D.instanceColor===null||D.isInstancedMesh&&Rt.instancingColor===!1&&D.instanceColor!==null||D.isInstancedMesh&&Rt.instancingMorph===!0&&D.morphTexture===null||D.isInstancedMesh&&Rt.instancingMorph===!1&&D.morphTexture!==null||Rt.envMap!==wt||V.fog===!0&&Rt.fog!==ot||Rt.numClippingPlanes!==void 0&&(Rt.numClippingPlanes!==rt.numPlanes||Rt.numIntersection!==rt.numIntersection)||Rt.vertexAlphas!==Ft||Rt.vertexTangents!==zt||Rt.morphTargets!==At||Rt.morphNormals!==Yt||Rt.morphColors!==jt||Rt.toneMapping!==te||Rt.morphTargetsCount!==Zt)&&(Jt=!0):(Jt=!0,Rt.__version=V.version);let Be=Rt.currentProgram;Jt===!0&&(Be=os(V,L,D));let jn=!1,we=!1,Ni=!1,ee=Be.getUniforms(),Ze=Rt.uniforms;if(ht.useProgram(Be.program)&&(jn=!0,we=!0,Ni=!0),V.id!==E&&(E=V.id,we=!0),jn||y!==v){ht.buffers.depth.getReversed()?(it.copy(v.projectionMatrix),su(it),ru(it),ee.setValue(w,"projectionMatrix",it)):ee.setValue(w,"projectionMatrix",v.projectionMatrix),ee.setValue(w,"viewMatrix",v.matrixWorldInverse);let pn=ee.map.cameraPosition;pn!==void 0&&pn.setValue(w,It.setFromMatrixPosition(v.matrixWorld)),yt.logarithmicDepthBuffer&&ee.setValue(w,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&ee.setValue(w,"isOrthographic",v.isOrthographicCamera===!0),y!==v&&(y=v,we=!0,Ni=!0)}if(D.isSkinnedMesh){ee.setOptional(w,D,"bindMatrix"),ee.setOptional(w,D,"bindMatrixInverse");let Ie=D.skeleton;Ie&&(Ie.boneTexture===null&&Ie.computeBoneTexture(),ee.setValue(w,"boneTexture",Ie.boneTexture,S))}D.isBatchedMesh&&(ee.setOptional(w,D,"batchingTexture"),ee.setValue(w,"batchingTexture",D._matricesTexture,S),ee.setOptional(w,D,"batchingIdTexture"),ee.setValue(w,"batchingIdTexture",D._indirectTexture,S),ee.setOptional(w,D,"batchingColorTexture"),D._colorsTexture!==null&&ee.setValue(w,"batchingColorTexture",D._colorsTexture,S));let Fi=z.morphAttributes;if((Fi.position!==void 0||Fi.normal!==void 0||Fi.color!==void 0)&&Nt.update(D,z,Be),(we||Rt.receiveShadow!==D.receiveShadow)&&(Rt.receiveShadow=D.receiveShadow,ee.setValue(w,"receiveShadow",D.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(Ze.envMap.value=wt,Ze.flipEnvMap.value=wt.isCubeTexture&&wt.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&L.environment!==null&&(Ze.envMapIntensity.value=L.environmentIntensity),we&&(ee.setValue(w,"toneMappingExposure",M.toneMappingExposure),Rt.needsLights&&eh(Ze,Ni),ot&&V.fog===!0&&dt.refreshFogUniforms(Ze,ot),dt.refreshMaterialUniforms(Ze,V,U,O,d.state.transmissionRenderTarget[v.id]),Mi.upload(w,al(Rt),Ze,S)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(Mi.upload(w,al(Rt),Ze,S),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&ee.setValue(w,"center",D.center),ee.setValue(w,"modelViewMatrix",D.modelViewMatrix),ee.setValue(w,"normalMatrix",D.normalMatrix),ee.setValue(w,"modelMatrix",D.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){let Ie=V.uniformsGroups;for(let pn=0,mn=Ie.length;pn<mn;pn++){let ll=Ie[pn];P.update(ll,Be),P.bind(ll,Be)}}return Be}function eh(v,L){v.ambientLightColor.needsUpdate=L,v.lightProbe.needsUpdate=L,v.directionalLights.needsUpdate=L,v.directionalLightShadows.needsUpdate=L,v.pointLights.needsUpdate=L,v.pointLightShadows.needsUpdate=L,v.spotLights.needsUpdate=L,v.spotLightShadows.needsUpdate=L,v.rectAreaLights.needsUpdate=L,v.hemisphereLights.needsUpdate=L}function nh(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(v,L,z){xt.get(v.texture).__webglTexture=L,xt.get(v.depthTexture).__webglTexture=z;let V=xt.get(v);V.__hasExternalTextures=!0,V.__autoAllocateDepthBuffer=z===void 0,V.__autoAllocateDepthBuffer||nt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),V.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(v,L){let z=xt.get(v);z.__webglFramebuffer=L,z.__useDefaultFramebuffer=L===void 0},this.setRenderTarget=function(v,L=0,z=0){N=v,C=L,R=z;let V=!0,D=null,ot=!1,mt=!1;if(v){let wt=xt.get(v);if(wt.__useDefaultFramebuffer!==void 0)ht.bindFramebuffer(w.FRAMEBUFFER,null),V=!1;else if(wt.__webglFramebuffer===void 0)S.setupRenderTarget(v);else if(wt.__hasExternalTextures)S.rebindTextures(v,xt.get(v.texture).__webglTexture,xt.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){let At=v.depthTexture;if(wt.__boundDepthTexture!==At){if(At!==null&&xt.has(At)&&(v.width!==At.image.width||v.height!==At.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");S.setupDepthRenderbuffer(v)}}let Ft=v.texture;(Ft.isData3DTexture||Ft.isDataArrayTexture||Ft.isCompressedArrayTexture)&&(mt=!0);let zt=xt.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(zt[L])?D=zt[L][z]:D=zt[L],ot=!0):v.samples>0&&S.useMultisampledRTT(v)===!1?D=xt.get(v).__webglMultisampledFramebuffer:Array.isArray(zt)?D=zt[z]:D=zt,A.copy(v.viewport),J.copy(v.scissor),k=v.scissorTest}else A.copy(ct).multiplyScalar(U).floor(),J.copy(_t).multiplyScalar(U).floor(),k=Pt;if(ht.bindFramebuffer(w.FRAMEBUFFER,D)&&V&&ht.drawBuffers(v,D),ht.viewport(A),ht.scissor(J),ht.setScissorTest(k),ot){let wt=xt.get(v.texture);w.framebufferTexture2D(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,w.TEXTURE_CUBE_MAP_POSITIVE_X+L,wt.__webglTexture,z)}else if(mt){let wt=xt.get(v.texture),Ft=L||0;w.framebufferTextureLayer(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,wt.__webglTexture,z||0,Ft)}E=-1},this.readRenderTargetPixels=function(v,L,z,V,D,ot,mt){if(!(v&&v.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Tt=xt.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&mt!==void 0&&(Tt=Tt[mt]),Tt){ht.bindFramebuffer(w.FRAMEBUFFER,Tt);try{let wt=v.texture,Ft=wt.format,zt=wt.type;if(!yt.textureFormatReadable(Ft)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!yt.textureTypeReadable(zt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=v.width-V&&z>=0&&z<=v.height-D&&w.readPixels(L,z,V,D,kt.convert(Ft),kt.convert(zt),ot)}finally{let wt=N!==null?xt.get(N).__webglFramebuffer:null;ht.bindFramebuffer(w.FRAMEBUFFER,wt)}}},this.readRenderTargetPixelsAsync=async function(v,L,z,V,D,ot,mt){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Tt=xt.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&mt!==void 0&&(Tt=Tt[mt]),Tt){let wt=v.texture,Ft=wt.format,zt=wt.type;if(!yt.textureFormatReadable(Ft))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!yt.textureTypeReadable(zt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(L>=0&&L<=v.width-V&&z>=0&&z<=v.height-D){ht.bindFramebuffer(w.FRAMEBUFFER,Tt);let At=w.createBuffer();w.bindBuffer(w.PIXEL_PACK_BUFFER,At),w.bufferData(w.PIXEL_PACK_BUFFER,ot.byteLength,w.STREAM_READ),w.readPixels(L,z,V,D,kt.convert(Ft),kt.convert(zt),0);let Yt=N!==null?xt.get(N).__webglFramebuffer:null;ht.bindFramebuffer(w.FRAMEBUFFER,Yt);let jt=w.fenceSync(w.SYNC_GPU_COMMANDS_COMPLETE,0);return w.flush(),await iu(w,jt,4),w.bindBuffer(w.PIXEL_PACK_BUFFER,At),w.getBufferSubData(w.PIXEL_PACK_BUFFER,0,ot),w.deleteBuffer(At),w.deleteSync(jt),ot}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(v,L=null,z=0){v.isTexture!==!0&&(Hi("WebGLRenderer: copyFramebufferToTexture function signature has changed."),L=arguments[0]||null,v=arguments[1]);let V=Math.pow(2,-z),D=Math.floor(v.image.width*V),ot=Math.floor(v.image.height*V),mt=L!==null?L.x:0,Tt=L!==null?L.y:0;S.setTexture2D(v,0),w.copyTexSubImage2D(w.TEXTURE_2D,z,0,0,mt,Tt,D,ot),ht.unbindTexture()},this.copyTextureToTexture=function(v,L,z=null,V=null,D=0){v.isTexture!==!0&&(Hi("WebGLRenderer: copyTextureToTexture function signature has changed."),V=arguments[0]||null,v=arguments[1],L=arguments[2],D=arguments[3]||0,z=null);let ot,mt,Tt,wt,Ft,zt,At,Yt,jt,te=v.isCompressedTexture?v.mipmaps[D]:v.image;z!==null?(ot=z.max.x-z.min.x,mt=z.max.y-z.min.y,Tt=z.isBox3?z.max.z-z.min.z:1,wt=z.min.x,Ft=z.min.y,zt=z.isBox3?z.min.z:0):(ot=te.width,mt=te.height,Tt=te.depth||1,wt=0,Ft=0,zt=0),V!==null?(At=V.x,Yt=V.y,jt=V.z):(At=0,Yt=0,jt=0);let Ee=kt.convert(L.format),Zt=kt.convert(L.type),Rt;L.isData3DTexture?(S.setTexture3D(L,0),Rt=w.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(S.setTexture2DArray(L,0),Rt=w.TEXTURE_2D_ARRAY):(S.setTexture2D(L,0),Rt=w.TEXTURE_2D),w.pixelStorei(w.UNPACK_FLIP_Y_WEBGL,L.flipY),w.pixelStorei(w.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),w.pixelStorei(w.UNPACK_ALIGNMENT,L.unpackAlignment);let je=w.getParameter(w.UNPACK_ROW_LENGTH),Jt=w.getParameter(w.UNPACK_IMAGE_HEIGHT),Be=w.getParameter(w.UNPACK_SKIP_PIXELS),jn=w.getParameter(w.UNPACK_SKIP_ROWS),we=w.getParameter(w.UNPACK_SKIP_IMAGES);w.pixelStorei(w.UNPACK_ROW_LENGTH,te.width),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,te.height),w.pixelStorei(w.UNPACK_SKIP_PIXELS,wt),w.pixelStorei(w.UNPACK_SKIP_ROWS,Ft),w.pixelStorei(w.UNPACK_SKIP_IMAGES,zt);let Ni=v.isDataArrayTexture||v.isData3DTexture,ee=L.isDataArrayTexture||L.isData3DTexture;if(v.isRenderTargetTexture||v.isDepthTexture){let Ze=xt.get(v),Fi=xt.get(L),Ie=xt.get(Ze.__renderTarget),pn=xt.get(Fi.__renderTarget);ht.bindFramebuffer(w.READ_FRAMEBUFFER,Ie.__webglFramebuffer),ht.bindFramebuffer(w.DRAW_FRAMEBUFFER,pn.__webglFramebuffer);for(let mn=0;mn<Tt;mn++)Ni&&w.framebufferTextureLayer(w.READ_FRAMEBUFFER,w.COLOR_ATTACHMENT0,xt.get(v).__webglTexture,D,zt+mn),v.isDepthTexture?(ee&&w.framebufferTextureLayer(w.DRAW_FRAMEBUFFER,w.COLOR_ATTACHMENT0,xt.get(L).__webglTexture,D,jt+mn),w.blitFramebuffer(wt,Ft,ot,mt,At,Yt,ot,mt,w.DEPTH_BUFFER_BIT,w.NEAREST)):ee?w.copyTexSubImage3D(Rt,D,At,Yt,jt+mn,wt,Ft,ot,mt):w.copyTexSubImage2D(Rt,D,At,Yt,jt+mn,wt,Ft,ot,mt);ht.bindFramebuffer(w.READ_FRAMEBUFFER,null),ht.bindFramebuffer(w.DRAW_FRAMEBUFFER,null)}else ee?v.isDataTexture||v.isData3DTexture?w.texSubImage3D(Rt,D,At,Yt,jt,ot,mt,Tt,Ee,Zt,te.data):L.isCompressedArrayTexture?w.compressedTexSubImage3D(Rt,D,At,Yt,jt,ot,mt,Tt,Ee,te.data):w.texSubImage3D(Rt,D,At,Yt,jt,ot,mt,Tt,Ee,Zt,te):v.isDataTexture?w.texSubImage2D(w.TEXTURE_2D,D,At,Yt,ot,mt,Ee,Zt,te.data):v.isCompressedTexture?w.compressedTexSubImage2D(w.TEXTURE_2D,D,At,Yt,te.width,te.height,Ee,te.data):w.texSubImage2D(w.TEXTURE_2D,D,At,Yt,ot,mt,Ee,Zt,te);w.pixelStorei(w.UNPACK_ROW_LENGTH,je),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,Jt),w.pixelStorei(w.UNPACK_SKIP_PIXELS,Be),w.pixelStorei(w.UNPACK_SKIP_ROWS,jn),w.pixelStorei(w.UNPACK_SKIP_IMAGES,we),D===0&&L.generateMipmaps&&w.generateMipmap(Rt),ht.unbindTexture()},this.copyTextureToTexture3D=function(v,L,z=null,V=null,D=0){return v.isTexture!==!0&&(Hi("WebGLRenderer: copyTextureToTexture3D function signature has changed."),z=arguments[0]||null,V=arguments[1]||null,v=arguments[2],L=arguments[3],D=arguments[4]||0),Hi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(v,L,z,V,D)},this.initRenderTarget=function(v){xt.get(v).__webglFramebuffer===void 0&&S.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?S.setTextureCube(v,0):v.isData3DTexture?S.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?S.setTexture2DArray(v,0):S.setTexture2D(v,0),ht.unbindTexture()},this.resetState=function(){C=0,R=0,N=null,ht.reset(),Qt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return cn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorspace=Xt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Xt._getUnpackColorSpace()}},ir=class i{constructor(t,e=1,n=1e3){this.isFog=!0,this.name="",this.color=new Ot(t),this.near=e,this.far=n}clone(){return new i(this.color,this.near,this.far)}toJSON(){return{type:"Fog",name:this.name,color:this.color.getHex(),near:this.near,far:this.far}}},sr=class extends Re{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new dn,this.environmentIntensity=1,this.environmentRotation=new dn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){let e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}},Yn=class extends Cn{static get type(){return"LineBasicMaterial"}constructor(t){super(),this.isLineBasicMaterial=!0,this.color=new Ot(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.linewidth=t.linewidth,this.linecap=t.linecap,this.linejoin=t.linejoin,this.fog=t.fog,this}},rr=new I,ar=new I,cc=new re,ki=new Ki,Rs=new qn,ra=new I,hc=new I,uo=class extends Re{constructor(t=new ce,e=new Yn){super(),this.isLine=!0,this.type="Line",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}computeLineDistances(){let t=this.geometry;if(t.index===null){let e=t.attributes.position,n=[0];for(let s=1,r=e.count;s<r;s++)rr.fromBufferAttribute(e,s-1),ar.fromBufferAttribute(e,s),n[s]=n[s-1],n[s]+=rr.distanceTo(ar);t.setAttribute("lineDistance",new oe(n,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(t,e){let n=this.geometry,s=this.matrixWorld,r=t.params.Line.threshold,a=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),Rs.copy(n.boundingSphere),Rs.applyMatrix4(s),Rs.radius+=r,t.ray.intersectsSphere(Rs)===!1)return;cc.copy(s).invert(),ki.copy(t.ray).applyMatrix4(cc);let o=r/((this.scale.x+this.scale.y+this.scale.z)/3),l=o*o,c=this.isLineSegments?2:1,h=n.index,f=n.attributes.position;if(h!==null){let p=Math.max(0,a.start),g=Math.min(h.count,a.start+a.count);for(let _=p,m=g-1;_<m;_+=c){let d=h.getX(_),T=h.getX(_+1),b=Ps(this,t,ki,l,d,T);b&&e.push(b)}if(this.isLineLoop){let _=h.getX(g-1),m=h.getX(p),d=Ps(this,t,ki,l,_,m);d&&e.push(d)}}else{let p=Math.max(0,a.start),g=Math.min(f.count,a.start+a.count);for(let _=p,m=g-1;_<m;_+=c){let d=Ps(this,t,ki,l,_,_+1);d&&e.push(d)}if(this.isLineLoop){let _=Ps(this,t,ki,l,g-1,p);_&&e.push(_)}}}updateMorphTargets(){let e=this.geometry.morphAttributes,n=Object.keys(e);if(n.length>0){let s=e[n[0]];if(s!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let r=0,a=s.length;r<a;r++){let o=s[r].name||String(r);this.morphTargetInfluences.push(0),this.morphTargetDictionary[o]=r}}}}};Ri=class extends uo{constructor(t,e){super(t,e),this.isLineLoop=!0,this.type="LineLoop"}},ts=class extends Cn{static get type(){return"PointsMaterial"}constructor(t){super(),this.isPointsMaterial=!0,this.color=new Ot(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.alphaMap=t.alphaMap,this.size=t.size,this.sizeAttenuation=t.sizeAttenuation,this.fog=t.fog,this}},uc=new re,fo=new Ki,Is=new qn,Ls=new I,or=class extends Re{constructor(t=new ce,e=new ts){super(),this.isPoints=!0,this.type="Points",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}raycast(t,e){let n=this.geometry,s=this.matrixWorld,r=t.params.Points.threshold,a=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),Is.copy(n.boundingSphere),Is.applyMatrix4(s),Is.radius+=r,t.ray.intersectsSphere(Is)===!1)return;uc.copy(s).invert(),fo.copy(t.ray).applyMatrix4(uc);let o=r/((this.scale.x+this.scale.y+this.scale.z)/3),l=o*o,c=n.index,u=n.attributes.position;if(c!==null){let f=Math.max(0,a.start),p=Math.min(c.count,a.start+a.count);for(let g=f,_=p;g<_;g++){let m=c.getX(g);Ls.fromBufferAttribute(u,m),dc(Ls,m,l,s,t,e,this)}}else{let f=Math.max(0,a.start),p=Math.min(u.count,a.start+a.count);for(let g=f,_=p;g<_;g++)Ls.fromBufferAttribute(u,g),dc(Ls,g,l,s,t,e,this)}}updateMorphTargets(){let e=this.geometry.morphAttributes,n=Object.keys(e);if(n.length>0){let s=e[n[0]];if(s!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let r=0,a=s.length;r<a;r++){let o=s[r].name||String(r);this.morphTargetInfluences.push(0),this.morphTargetDictionary[o]=r}}}}};Fe=class{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(t,e){let n=this.getUtoTmapping(t);return this.getPoint(n,e)}getPoints(t=5){let e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return e}getSpacedPoints(t=5){let e=[];for(let n=0;n<=t;n++)e.push(this.getPointAt(n/t));return e}getLength(){let t=this.getLengths();return t[t.length-1]}getLengths(t=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===t+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;let e=[],n,s=this.getPoint(0),r=0;e.push(0);for(let a=1;a<=t;a++)n=this.getPoint(a/t),r+=n.distanceTo(s),e.push(r),s=n;return this.cacheArcLengths=e,e}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(t,e){let n=this.getLengths(),s=0,r=n.length,a;e?a=e:a=t*n[r-1];let o=0,l=r-1,c;for(;o<=l;)if(s=Math.floor(o+(l-o)/2),c=n[s]-a,c<0)o=s+1;else if(c>0)l=s-1;else{l=s;break}if(s=l,n[s]===a)return s/(r-1);let h=n[s],f=n[s+1]-h,p=(a-h)/f;return(s+p)/(r-1)}getTangent(t,e){let s=t-1e-4,r=t+1e-4;s<0&&(s=0),r>1&&(r=1);let a=this.getPoint(s),o=this.getPoint(r),l=e||(a.isVector2?new at:new I);return l.copy(o).sub(a).normalize(),l}getTangentAt(t,e){let n=this.getUtoTmapping(t);return this.getTangent(n,e)}computeFrenetFrames(t,e){let n=new I,s=[],r=[],a=[],o=new I,l=new re;for(let p=0;p<=t;p++){let g=p/t;s[p]=this.getTangentAt(g,new I)}r[0]=new I,a[0]=new I;let c=Number.MAX_VALUE,h=Math.abs(s[0].x),u=Math.abs(s[0].y),f=Math.abs(s[0].z);h<=c&&(c=h,n.set(1,0,0)),u<=c&&(c=u,n.set(0,1,0)),f<=c&&n.set(0,0,1),o.crossVectors(s[0],n).normalize(),r[0].crossVectors(s[0],o),a[0].crossVectors(s[0],r[0]);for(let p=1;p<=t;p++){if(r[p]=r[p-1].clone(),a[p]=a[p-1].clone(),o.crossVectors(s[p-1],s[p]),o.length()>Number.EPSILON){o.normalize();let g=Math.acos(me(s[p-1].dot(s[p]),-1,1));r[p].applyMatrix4(l.makeRotationAxis(o,g))}a[p].crossVectors(s[p],r[p])}if(e===!0){let p=Math.acos(me(r[0].dot(r[t]),-1,1));p/=t,s[0].dot(o.crossVectors(r[0],r[t]))>0&&(p=-p);for(let g=1;g<=t;g++)r[g].applyMatrix4(l.makeRotationAxis(s[g],p*g)),a[g].crossVectors(s[g],r[g])}return{tangents:s,normals:r,binormals:a}}clone(){return new this.constructor().copy(this)}copy(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}toJSON(){let t={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return t.arcLengthDivisions=this.arcLengthDivisions,t.type=this.type,t}fromJSON(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}},es=class extends Fe{constructor(t=0,e=0,n=1,s=1,r=0,a=Math.PI*2,o=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=t,this.aY=e,this.xRadius=n,this.yRadius=s,this.aStartAngle=r,this.aEndAngle=a,this.aClockwise=o,this.aRotation=l}getPoint(t,e=new at){let n=e,s=Math.PI*2,r=this.aEndAngle-this.aStartAngle,a=Math.abs(r)<Number.EPSILON;for(;r<0;)r+=s;for(;r>s;)r-=s;r<Number.EPSILON&&(a?r=0:r=s),this.aClockwise===!0&&!a&&(r===s?r=-s:r=r-s);let o=this.aStartAngle+t*r,l=this.aX+this.xRadius*Math.cos(o),c=this.aY+this.yRadius*Math.sin(o);if(this.aRotation!==0){let h=Math.cos(this.aRotation),u=Math.sin(this.aRotation),f=l-this.aX,p=c-this.aY;l=f*h-p*u+this.aX,c=f*u+p*h+this.aY}return n.set(l,c)}copy(t){return super.copy(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}toJSON(){let t=super.toJSON();return t.aX=this.aX,t.aY=this.aY,t.xRadius=this.xRadius,t.yRadius=this.yRadius,t.aStartAngle=this.aStartAngle,t.aEndAngle=this.aEndAngle,t.aClockwise=this.aClockwise,t.aRotation=this.aRotation,t}fromJSON(t){return super.fromJSON(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}},po=class extends es{constructor(t,e,n,s,r,a){super(t,e,n,n,s,r,a),this.isArcCurve=!0,this.type="ArcCurve"}};Ds=new I,aa=new Yo,oa=new Yo,la=new Yo,mo=class extends Fe{constructor(t=[],e=!1,n="centripetal",s=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=t,this.closed=e,this.curveType=n,this.tension=s}getPoint(t,e=new I){let n=e,s=this.points,r=s.length,a=(r-(this.closed?0:1))*t,o=Math.floor(a),l=a-o;this.closed?o+=o>0?0:(Math.floor(Math.abs(o)/r)+1)*r:l===0&&o===r-1&&(o=r-2,l=1);let c,h;this.closed||o>0?c=s[(o-1)%r]:(Ds.subVectors(s[0],s[1]).add(s[0]),c=Ds);let u=s[o%r],f=s[(o+1)%r];if(this.closed||o+2<r?h=s[(o+2)%r]:(Ds.subVectors(s[r-1],s[r-2]).add(s[r-1]),h=Ds),this.curveType==="centripetal"||this.curveType==="chordal"){let p=this.curveType==="chordal"?.5:.25,g=Math.pow(c.distanceToSquared(u),p),_=Math.pow(u.distanceToSquared(f),p),m=Math.pow(f.distanceToSquared(h),p);_<1e-4&&(_=1),g<1e-4&&(g=_),m<1e-4&&(m=_),aa.initNonuniformCatmullRom(c.x,u.x,f.x,h.x,g,_,m),oa.initNonuniformCatmullRom(c.y,u.y,f.y,h.y,g,_,m),la.initNonuniformCatmullRom(c.z,u.z,f.z,h.z,g,_,m)}else this.curveType==="catmullrom"&&(aa.initCatmullRom(c.x,u.x,f.x,h.x,this.tension),oa.initCatmullRom(c.y,u.y,f.y,h.y,this.tension),la.initCatmullRom(c.z,u.z,f.z,h.z,this.tension));return n.set(aa.calc(l),oa.calc(l),la.calc(l)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){let s=t.points[e];this.points.push(s.clone())}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}toJSON(){let t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){let s=this.points[e];t.points.push(s.toArray())}return t.closed=this.closed,t.curveType=this.curveType,t.tension=this.tension,t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){let s=t.points[e];this.points.push(new I().fromArray(s))}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}};lr=class extends Fe{constructor(t=new at,e=new at,n=new at,s=new at){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=t,this.v1=e,this.v2=n,this.v3=s}getPoint(t,e=new at){let n=e,s=this.v0,r=this.v1,a=this.v2,o=this.v3;return n.set(Zi(t,s.x,r.x,a.x,o.x),Zi(t,s.y,r.y,a.y,o.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){let t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}},go=class extends Fe{constructor(t=new I,e=new I,n=new I,s=new I){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=t,this.v1=e,this.v2=n,this.v3=s}getPoint(t,e=new I){let n=e,s=this.v0,r=this.v1,a=this.v2,o=this.v3;return n.set(Zi(t,s.x,r.x,a.x,o.x),Zi(t,s.y,r.y,a.y,o.y),Zi(t,s.z,r.z,a.z,o.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){let t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}},cr=class extends Fe{constructor(t=new at,e=new at){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=t,this.v2=e}getPoint(t,e=new at){let n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new at){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){let t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}},_o=class extends Fe{constructor(t=new I,e=new I){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=t,this.v2=e}getPoint(t,e=new I){let n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new I){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){let t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}},hr=class extends Fe{constructor(t=new at,e=new at,n=new at){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new at){let n=e,s=this.v0,r=this.v1,a=this.v2;return n.set(Yi(t,s.x,r.x,a.x),Yi(t,s.y,r.y,a.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){let t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}},xo=class extends Fe{constructor(t=new I,e=new I,n=new I){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new I){let n=e,s=this.v0,r=this.v1,a=this.v2;return n.set(Yi(t,s.x,r.x,a.x),Yi(t,s.y,r.y,a.y),Yi(t,s.z,r.z,a.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){let t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}},ur=class extends Fe{constructor(t=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=t}getPoint(t,e=new at){let n=e,s=this.points,r=(s.length-1)*t,a=Math.floor(r),o=r-a,l=s[a===0?a:a-1],c=s[a],h=s[a>s.length-2?s.length-1:a+1],u=s[a>s.length-3?s.length-1:a+2];return n.set(fc(o,l.x,c.x,h.x,u.x),fc(o,l.y,c.y,h.y,u.y)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){let s=t.points[e];this.points.push(s.clone())}return this}toJSON(){let t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){let s=this.points[e];t.points.push(s.toArray())}return t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){let s=t.points[e];this.points.push(new at().fromArray(s))}return this}},vo=Object.freeze({__proto__:null,ArcCurve:po,CatmullRomCurve3:mo,CubicBezierCurve:lr,CubicBezierCurve3:go,EllipseCurve:es,LineCurve:cr,LineCurve3:_o,QuadraticBezierCurve:hr,QuadraticBezierCurve3:xo,SplineCurve:ur}),yo=class extends Fe{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(t){this.curves.push(t)}closePath(){let t=this.curves[0].getPoint(0),e=this.curves[this.curves.length-1].getPoint(1);if(!t.equals(e)){let n=t.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new vo[n](e,t))}return this}getPoint(t,e){let n=t*this.getLength(),s=this.getCurveLengths(),r=0;for(;r<s.length;){if(s[r]>=n){let a=s[r]-n,o=this.curves[r],l=o.getLength(),c=l===0?0:1-a/l;return o.getPointAt(c,e)}r++}return null}getLength(){let t=this.getCurveLengths();return t[t.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;let t=[],e=0;for(let n=0,s=this.curves.length;n<s;n++)e+=this.curves[n].getLength(),t.push(e);return this.cacheLengths=t,t}getSpacedPoints(t=40){let e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return this.autoClose&&e.push(e[0]),e}getPoints(t=12){let e=[],n;for(let s=0,r=this.curves;s<r.length;s++){let a=r[s],o=a.isEllipseCurve?t*2:a.isLineCurve||a.isLineCurve3?1:a.isSplineCurve?t*a.points.length:t,l=a.getPoints(o);for(let c=0;c<l.length;c++){let h=l[c];n&&n.equals(h)||(e.push(h),n=h)}}return this.autoClose&&e.length>1&&!e[e.length-1].equals(e[0])&&e.push(e[0]),e}copy(t){super.copy(t),this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){let s=t.curves[e];this.curves.push(s.clone())}return this.autoClose=t.autoClose,this}toJSON(){let t=super.toJSON();t.autoClose=this.autoClose,t.curves=[];for(let e=0,n=this.curves.length;e<n;e++){let s=this.curves[e];t.curves.push(s.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.autoClose=t.autoClose,this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){let s=t.curves[e];this.curves.push(new vo[s.type]().fromJSON(s))}return this}},dr=class extends yo{constructor(t){super(),this.type="Path",this.currentPoint=new at,t&&this.setFromPoints(t)}setFromPoints(t){this.moveTo(t[0].x,t[0].y);for(let e=1,n=t.length;e<n;e++)this.lineTo(t[e].x,t[e].y);return this}moveTo(t,e){return this.currentPoint.set(t,e),this}lineTo(t,e){let n=new cr(this.currentPoint.clone(),new at(t,e));return this.curves.push(n),this.currentPoint.set(t,e),this}quadraticCurveTo(t,e,n,s){let r=new hr(this.currentPoint.clone(),new at(t,e),new at(n,s));return this.curves.push(r),this.currentPoint.set(n,s),this}bezierCurveTo(t,e,n,s,r,a){let o=new lr(this.currentPoint.clone(),new at(t,e),new at(n,s),new at(r,a));return this.curves.push(o),this.currentPoint.set(r,a),this}splineThru(t){let e=[this.currentPoint.clone()].concat(t),n=new ur(e);return this.curves.push(n),this.currentPoint.copy(t[t.length-1]),this}arc(t,e,n,s,r,a){let o=this.currentPoint.x,l=this.currentPoint.y;return this.absarc(t+o,e+l,n,s,r,a),this}absarc(t,e,n,s,r,a){return this.absellipse(t,e,n,n,s,r,a),this}ellipse(t,e,n,s,r,a,o,l){let c=this.currentPoint.x,h=this.currentPoint.y;return this.absellipse(t+c,e+h,n,s,r,a,o,l),this}absellipse(t,e,n,s,r,a,o,l){let c=new es(t,e,n,s,r,a,o,l);if(this.curves.length>0){let u=c.getPoint(0);u.equals(this.currentPoint)||this.lineTo(u.x,u.y)}this.curves.push(c);let h=c.getPoint(1);return this.currentPoint.copy(h),this}copy(t){return super.copy(t),this.currentPoint.copy(t.currentPoint),this}toJSON(){let t=super.toJSON();return t.currentPoint=this.currentPoint.toArray(),t}fromJSON(t){return super.fromJSON(t),this.currentPoint.fromArray(t.currentPoint),this}},Zn=class extends dr{constructor(t){super(t),this.uuid=Qn(),this.type="Shape",this.holes=[]}getPointsHoles(t){let e=[];for(let n=0,s=this.holes.length;n<s;n++)e[n]=this.holes[n].getPoints(t);return e}extractPoints(t){return{shape:this.getPoints(t),holes:this.getPointsHoles(t)}}copy(t){super.copy(t),this.holes=[];for(let e=0,n=t.holes.length;e<n;e++){let s=t.holes[e];this.holes.push(s.clone())}return this}toJSON(){let t=super.toJSON();t.uuid=this.uuid,t.holes=[];for(let e=0,n=this.holes.length;e<n;e++){let s=this.holes[e];t.holes.push(s.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.uuid=t.uuid,this.holes=[];for(let e=0,n=t.holes.length;e<n;e++){let s=t.holes[e];this.holes.push(new dr().fromJSON(s))}return this}},ag={triangulate:function(i,t,e=2){let n=t&&t.length,s=n?t[0]*e:i.length,r=kc(i,0,s,e,!0),a=[];if(!r||r.next===r.prev)return a;let o,l,c,h,u,f,p;if(n&&(r=ug(i,t,r,e)),i.length>80*e){o=c=i[0],l=h=i[1];for(let g=e;g<s;g+=e)u=i[g],f=i[g+1],u<o&&(o=u),f<l&&(l=f),u>c&&(c=u),f>h&&(h=f);p=Math.max(c-o,h-l),p=p!==0?32767/p:0}return ns(r,a,e,o,l,p,0),a}};En=class i{static area(t){let e=t.length,n=0;for(let s=e-1,r=0;r<e;s=r++)n+=t[s].x*t[r].y-t[r].x*t[s].y;return n*.5}static isClockWise(t){return i.area(t)<0}static triangulateShape(t,e){let n=[],s=[],r=[];mc(t),gc(n,t);let a=t.length;e.forEach(mc);for(let l=0;l<e.length;l++)s.push(a),a+=e[l].length,gc(n,e[l]);let o=ag.triangulate(n,s);for(let l=0;l<o.length;l+=3)r.push(o.slice(l,l+3));return r}};fr=class i extends ce{constructor(t=new Zn([new at(.5,.5),new at(-.5,.5),new at(-.5,-.5),new at(.5,-.5)]),e={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:t,options:e},t=Array.isArray(t)?t:[t];let n=this,s=[],r=[];for(let o=0,l=t.length;o<l;o++){let c=t[o];a(c)}this.setAttribute("position",new oe(s,3)),this.setAttribute("uv",new oe(r,2)),this.computeVertexNormals();function a(o){let l=[],c=e.curveSegments!==void 0?e.curveSegments:12,h=e.steps!==void 0?e.steps:1,u=e.depth!==void 0?e.depth:1,f=e.bevelEnabled!==void 0?e.bevelEnabled:!0,p=e.bevelThickness!==void 0?e.bevelThickness:.2,g=e.bevelSize!==void 0?e.bevelSize:p-.1,_=e.bevelOffset!==void 0?e.bevelOffset:0,m=e.bevelSegments!==void 0?e.bevelSegments:3,d=e.extrudePath,T=e.UVGenerator!==void 0?e.UVGenerator:bg,b,M=!1,B,C,R,N;d&&(b=d.getSpacedPoints(h),M=!0,f=!1,B=d.computeFrenetFrames(h,!1),C=new I,R=new I,N=new I),f||(m=0,p=0,g=0,_=0);let E=o.extractPoints(c),y=E.shape,A=E.holes;if(!En.isClockWise(y)){y=y.reverse();for(let K=0,st=A.length;K<st;K++){let w=A[K];En.isClockWise(w)&&(A[K]=w.reverse())}}let k=En.triangulateShape(y,A),H=y;for(let K=0,st=A.length;K<st;K++){let w=A[K];y=y.concat(w)}function j(K,st,w){return st||console.error("THREE.ExtrudeGeometry: vec does not exist"),K.clone().addScaledVector(st,w)}let G=y.length,O=k.length;function U(K,st,w){let Ct,nt,yt,ht=K.x-st.x,Dt=K.y-st.y,xt=w.x-K.x,S=w.y-K.y,x=ht*ht+Dt*Dt,F=ht*S-Dt*xt;if(Math.abs(F)>Number.EPSILON){let Y=Math.sqrt(x),tt=Math.sqrt(xt*xt+S*S),Z=st.x-Dt/Y,bt=st.y+ht/Y,dt=w.x-S/tt,vt=w.y+xt/tt,Wt=((dt-Z)*S-(vt-bt)*xt)/(ht*S-Dt*xt);Ct=Z+ht*Wt-K.x,nt=bt+Dt*Wt-K.y;let rt=Ct*Ct+nt*nt;if(rt<=2)return new at(Ct,nt);yt=Math.sqrt(rt/2)}else{let Y=!1;ht>Number.EPSILON?xt>Number.EPSILON&&(Y=!0):ht<-Number.EPSILON?xt<-Number.EPSILON&&(Y=!0):Math.sign(Dt)===Math.sign(S)&&(Y=!0),Y?(Ct=-Dt,nt=ht,yt=Math.sqrt(x)):(Ct=ht,nt=Dt,yt=Math.sqrt(x/2))}return new at(Ct/yt,nt/yt)}let $=[];for(let K=0,st=H.length,w=st-1,Ct=K+1;K<st;K++,w++,Ct++)w===st&&(w=0),Ct===st&&(Ct=0),$[K]=U(H[K],H[w],H[Ct]);let et=[],ct,_t=$.concat();for(let K=0,st=A.length;K<st;K++){let w=A[K];ct=[];for(let Ct=0,nt=w.length,yt=nt-1,ht=Ct+1;Ct<nt;Ct++,yt++,ht++)yt===nt&&(yt=0),ht===nt&&(ht=0),ct[Ct]=U(w[Ct],w[yt],w[ht]);et.push(ct),_t=_t.concat(ct)}for(let K=0;K<m;K++){let st=K/m,w=p*Math.cos(st*Math.PI/2),Ct=g*Math.sin(st*Math.PI/2)+_;for(let nt=0,yt=H.length;nt<yt;nt++){let ht=j(H[nt],$[nt],Ct);it(ht.x,ht.y,-w)}for(let nt=0,yt=A.length;nt<yt;nt++){let ht=A[nt];ct=et[nt];for(let Dt=0,xt=ht.length;Dt<xt;Dt++){let S=j(ht[Dt],ct[Dt],Ct);it(S.x,S.y,-w)}}}let Pt=g+_;for(let K=0;K<G;K++){let st=f?j(y[K],_t[K],Pt):y[K];M?(R.copy(B.normals[0]).multiplyScalar(st.x),C.copy(B.binormals[0]).multiplyScalar(st.y),N.copy(b[0]).add(R).add(C),it(N.x,N.y,N.z)):it(st.x,st.y,0)}for(let K=1;K<=h;K++)for(let st=0;st<G;st++){let w=f?j(y[st],_t[st],Pt):y[st];M?(R.copy(B.normals[K]).multiplyScalar(w.x),C.copy(B.binormals[K]).multiplyScalar(w.y),N.copy(b[K]).add(R).add(C),it(N.x,N.y,N.z)):it(w.x,w.y,u/h*K)}for(let K=m-1;K>=0;K--){let st=K/m,w=p*Math.cos(st*Math.PI/2),Ct=g*Math.sin(st*Math.PI/2)+_;for(let nt=0,yt=H.length;nt<yt;nt++){let ht=j(H[nt],$[nt],Ct);it(ht.x,ht.y,u+w)}for(let nt=0,yt=A.length;nt<yt;nt++){let ht=A[nt];ct=et[nt];for(let Dt=0,xt=ht.length;Dt<xt;Dt++){let S=j(ht[Dt],ct[Dt],Ct);M?it(S.x,S.y+b[h-1].y,b[h-1].x+w):it(S.x,S.y,u+w)}}}X(),q();function X(){let K=s.length/3;if(f){let st=0,w=G*st;for(let Ct=0;Ct<O;Ct++){let nt=k[Ct];Et(nt[2]+w,nt[1]+w,nt[0]+w)}st=h+m*2,w=G*st;for(let Ct=0;Ct<O;Ct++){let nt=k[Ct];Et(nt[0]+w,nt[1]+w,nt[2]+w)}}else{for(let st=0;st<O;st++){let w=k[st];Et(w[2],w[1],w[0])}for(let st=0;st<O;st++){let w=k[st];Et(w[0]+G*h,w[1]+G*h,w[2]+G*h)}}n.addGroup(K,s.length/3-K,0)}function q(){let K=s.length/3,st=0;lt(H,st),st+=H.length;for(let w=0,Ct=A.length;w<Ct;w++){let nt=A[w];lt(nt,st),st+=nt.length}n.addGroup(K,s.length/3-K,1)}function lt(K,st){let w=K.length;for(;--w>=0;){let Ct=w,nt=w-1;nt<0&&(nt=K.length-1);for(let yt=0,ht=h+m*2;yt<ht;yt++){let Dt=G*yt,xt=G*(yt+1),S=st+Ct+Dt,x=st+nt+Dt,F=st+nt+xt,Y=st+Ct+xt;It(S,x,F,Y)}}}function it(K,st,w){l.push(K),l.push(st),l.push(w)}function Et(K,st,w){Lt(K),Lt(st),Lt(w);let Ct=s.length/3,nt=T.generateTopUV(n,s,Ct-3,Ct-2,Ct-1);Gt(nt[0]),Gt(nt[1]),Gt(nt[2])}function It(K,st,w,Ct){Lt(K),Lt(st),Lt(Ct),Lt(st),Lt(w),Lt(Ct);let nt=s.length/3,yt=T.generateSideWallUV(n,s,nt-6,nt-3,nt-2,nt-1);Gt(yt[0]),Gt(yt[1]),Gt(yt[3]),Gt(yt[1]),Gt(yt[2]),Gt(yt[3])}function Lt(K){s.push(l[K*3+0]),s.push(l[K*3+1]),s.push(l[K*3+2])}function Gt(K){r.push(K.x),r.push(K.y)}}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}toJSON(){let t=super.toJSON(),e=this.parameters.shapes,n=this.parameters.options;return Eg(e,n,t)}static fromJSON(t,e){let n=[];for(let r=0,a=t.shapes.length;r<a;r++){let o=e[t.shapes[r]];n.push(o)}let s=t.options.extrudePath;return s!==void 0&&(t.options.extrudePath=new vo[s.type]().fromJSON(s)),new i(n,t.options)}},bg={generateTopUV:function(i,t,e,n,s){let r=t[e*3],a=t[e*3+1],o=t[n*3],l=t[n*3+1],c=t[s*3],h=t[s*3+1];return[new at(r,a),new at(o,l),new at(c,h)]},generateSideWallUV:function(i,t,e,n,s,r){let a=t[e*3],o=t[e*3+1],l=t[e*3+2],c=t[n*3],h=t[n*3+1],u=t[n*3+2],f=t[s*3],p=t[s*3+1],g=t[s*3+2],_=t[r*3],m=t[r*3+1],d=t[r*3+2];return Math.abs(o-h)<Math.abs(a-c)?[new at(a,1-l),new at(c,1-u),new at(f,1-g),new at(_,1-d)]:[new at(o,1-l),new at(h,1-u),new at(p,1-g),new at(m,1-d)]}};pr=class i extends ce{constructor(t=.5,e=1,n=32,s=1,r=0,a=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:t,outerRadius:e,thetaSegments:n,phiSegments:s,thetaStart:r,thetaLength:a},n=Math.max(3,n),s=Math.max(1,s);let o=[],l=[],c=[],h=[],u=t,f=(e-t)/s,p=new I,g=new at;for(let _=0;_<=s;_++){for(let m=0;m<=n;m++){let d=r+m/n*a;p.x=u*Math.cos(d),p.y=u*Math.sin(d),l.push(p.x,p.y,p.z),c.push(0,0,1),g.x=(p.x/e+1)/2,g.y=(p.y/e+1)/2,h.push(g.x,g.y)}u+=f}for(let _=0;_<s;_++){let m=_*(n+1);for(let d=0;d<n;d++){let T=d+m,b=T,M=T+n+1,B=T+n+2,C=T+1;o.push(b,M,C),o.push(M,B,C)}}this.setIndex(o),this.setAttribute("position",new oe(l,3)),this.setAttribute("normal",new oe(c,3)),this.setAttribute("uv",new oe(h,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new i(t.innerRadius,t.outerRadius,t.thetaSegments,t.phiSegments,t.thetaStart,t.thetaLength)}},mr=class i extends ce{constructor(t=new Zn([new at(0,.5),new at(-.5,-.5),new at(.5,-.5)]),e=12){super(),this.type="ShapeGeometry",this.parameters={shapes:t,curveSegments:e};let n=[],s=[],r=[],a=[],o=0,l=0;if(Array.isArray(t)===!1)c(t);else for(let h=0;h<t.length;h++)c(t[h]),this.addGroup(o,l,h),o+=l,l=0;this.setIndex(n),this.setAttribute("position",new oe(s,3)),this.setAttribute("normal",new oe(r,3)),this.setAttribute("uv",new oe(a,2));function c(h){let u=s.length/3,f=h.extractPoints(e),p=f.shape,g=f.holes;En.isClockWise(p)===!1&&(p=p.reverse());for(let m=0,d=g.length;m<d;m++){let T=g[m];En.isClockWise(T)===!0&&(g[m]=T.reverse())}let _=En.triangulateShape(p,g);for(let m=0,d=g.length;m<d;m++){let T=g[m];p=p.concat(T)}for(let m=0,d=p.length;m<d;m++){let T=p[m];s.push(T.x,T.y,0),r.push(0,0,1),a.push(T.x,T.y)}for(let m=0,d=_.length;m<d;m++){let T=_[m],b=T[0]+u,M=T[1]+u,B=T[2]+u;n.push(b,M,B),l+=3}}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}toJSON(){let t=super.toJSON(),e=this.parameters.shapes;return Tg(e,t)}static fromJSON(t,e){let n=[];for(let s=0,r=t.shapes.length;s<r;s++){let a=e[t.shapes[s]];n.push(a)}return new i(n,t.curveSegments)}};gr=class extends ue{static get type(){return"RawShaderMaterial"}constructor(t){super(t),this.isRawShaderMaterial=!0}},_r=class extends Yn{static get type(){return"LineDashedMaterial"}constructor(t){super(),this.isLineDashedMaterial=!0,this.scale=1,this.dashSize=3,this.gapSize=1,this.setValues(t)}copy(t){return super.copy(t),this.scale=t.scale,this.dashSize=t.dashSize,this.gapSize=t.gapSize,this}};Pi=class{constructor(t,e,n,s){this.parameterPositions=t,this._cachedIndex=0,this.resultBuffer=s!==void 0?s:new e.constructor(n),this.sampleValues=e,this.valueSize=n,this.settings=null,this.DefaultSettings_={}}evaluate(t){let e=this.parameterPositions,n=this._cachedIndex,s=e[n],r=e[n-1];n:{t:{let a;e:{i:if(!(t<s)){for(let o=n+2;;){if(s===void 0){if(t<r)break i;return n=e.length,this._cachedIndex=n,this.copySampleValue_(n-1)}if(n===o)break;if(r=s,s=e[++n],t<s)break t}a=e.length;break e}if(!(t>=r)){let o=e[1];t<o&&(n=2,r=o);for(let l=n-2;;){if(r===void 0)return this._cachedIndex=0,this.copySampleValue_(0);if(n===l)break;if(s=r,r=e[--n-1],t>=r)break t}a=n,n=0;break e}break n}for(;n<a;){let o=n+a>>>1;t<e[o]?a=o:n=o+1}if(s=e[n],r=e[n-1],r===void 0)return this._cachedIndex=0,this.copySampleValue_(0);if(s===void 0)return n=e.length,this._cachedIndex=n,this.copySampleValue_(n-1)}this._cachedIndex=n,this.intervalChanged_(n,r,s)}return this.interpolate_(n,r,t,s)}getSettings_(){return this.settings||this.DefaultSettings_}copySampleValue_(t){let e=this.resultBuffer,n=this.sampleValues,s=this.valueSize,r=t*s;for(let a=0;a!==s;++a)e[a]=n[r+a];return e}interpolate_(){throw new Error("call to abstract method")}intervalChanged_(){}},bo=class extends Pi{constructor(t,e,n,s){super(t,e,n,s),this._weightPrev=-0,this._offsetPrev=-0,this._weightNext=-0,this._offsetNext=-0,this.DefaultSettings_={endingStart:dl,endingEnd:dl}}intervalChanged_(t,e,n){let s=this.parameterPositions,r=t-2,a=t+1,o=s[r],l=s[a];if(o===void 0)switch(this.getSettings_().endingStart){case fl:r=t,o=2*e-n;break;case pl:r=s.length-2,o=e+s[r]-s[r+1];break;default:r=t,o=n}if(l===void 0)switch(this.getSettings_().endingEnd){case fl:a=t,l=2*n-e;break;case pl:a=1,l=n+s[1]-s[0];break;default:a=t-1,l=e}let c=(n-e)*.5,h=this.valueSize;this._weightPrev=c/(e-o),this._weightNext=c/(l-n),this._offsetPrev=r*h,this._offsetNext=a*h}interpolate_(t,e,n,s){let r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=t*o,c=l-o,h=this._offsetPrev,u=this._offsetNext,f=this._weightPrev,p=this._weightNext,g=(n-e)/(s-e),_=g*g,m=_*g,d=-f*m+2*f*_-f*g,T=(1+f)*m+(-1.5-2*f)*_+(-.5+f)*g+1,b=(-1-p)*m+(1.5+p)*_+.5*g,M=p*m-p*_;for(let B=0;B!==o;++B)r[B]=d*a[h+B]+T*a[c+B]+b*a[l+B]+M*a[u+B];return r}},Eo=class extends Pi{constructor(t,e,n,s){super(t,e,n,s)}interpolate_(t,e,n,s){let r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=t*o,c=l-o,h=(n-e)/(s-e),u=1-h;for(let f=0;f!==o;++f)r[f]=a[c+f]*u+a[l+f]*h;return r}},To=class extends Pi{constructor(t,e,n,s){super(t,e,n,s)}interpolate_(t){return this.copySampleValue_(t-1)}},qe=class{constructor(t,e,n,s){if(t===void 0)throw new Error("THREE.KeyframeTrack: track name is undefined");if(e===void 0||e.length===0)throw new Error("THREE.KeyframeTrack: no keyframes in track named "+t);this.name=t,this.times=Fs(e,this.TimeBufferType),this.values=Fs(n,this.ValueBufferType),this.setInterpolation(s||this.DefaultInterpolation)}static toJSON(t){let e=t.constructor,n;if(e.toJSON!==this.toJSON)n=e.toJSON(t);else{n={name:t.name,times:Fs(t.times,Array),values:Fs(t.values,Array)};let s=t.getInterpolation();s!==t.DefaultInterpolation&&(n.interpolation=s)}return n.type=t.ValueTypeName,n}InterpolantFactoryMethodDiscrete(t){return new To(this.times,this.values,this.getValueSize(),t)}InterpolantFactoryMethodLinear(t){return new Eo(this.times,this.values,this.getValueSize(),t)}InterpolantFactoryMethodSmooth(t){return new bo(this.times,this.values,this.getValueSize(),t)}setInterpolation(t){let e;switch(t){case Gs:e=this.InterpolantFactoryMethodDiscrete;break;case Za:e=this.InterpolantFactoryMethodLinear;break;case Lr:e=this.InterpolantFactoryMethodSmooth;break}if(e===void 0){let n="unsupported interpolation for "+this.ValueTypeName+" keyframe track named "+this.name;if(this.createInterpolant===void 0)if(t!==this.DefaultInterpolation)this.setInterpolation(this.DefaultInterpolation);else throw new Error(n);return console.warn("THREE.KeyframeTrack:",n),this}return this.createInterpolant=e,this}getInterpolation(){switch(this.createInterpolant){case this.InterpolantFactoryMethodDiscrete:return Gs;case this.InterpolantFactoryMethodLinear:return Za;case this.InterpolantFactoryMethodSmooth:return Lr}}getValueSize(){return this.values.length/this.times.length}shift(t){if(t!==0){let e=this.times;for(let n=0,s=e.length;n!==s;++n)e[n]+=t}return this}scale(t){if(t!==1){let e=this.times;for(let n=0,s=e.length;n!==s;++n)e[n]*=t}return this}trim(t,e){let n=this.times,s=n.length,r=0,a=s-1;for(;r!==s&&n[r]<t;)++r;for(;a!==-1&&n[a]>e;)--a;if(++a,r!==0||a!==s){r>=a&&(a=Math.max(a,1),r=a-1);let o=this.getValueSize();this.times=n.slice(r,a),this.values=this.values.slice(r*o,a*o)}return this}validate(){let t=!0,e=this.getValueSize();e-Math.floor(e)!==0&&(console.error("THREE.KeyframeTrack: Invalid value size in track.",this),t=!1);let n=this.times,s=this.values,r=n.length;r===0&&(console.error("THREE.KeyframeTrack: Track is empty.",this),t=!1);let a=null;for(let o=0;o!==r;o++){let l=n[o];if(typeof l=="number"&&isNaN(l)){console.error("THREE.KeyframeTrack: Time is not a valid number.",this,o,l),t=!1;break}if(a!==null&&a>l){console.error("THREE.KeyframeTrack: Out of order keys.",this,o,l,a),t=!1;break}a=l}if(s!==void 0&&wg(s))for(let o=0,l=s.length;o!==l;++o){let c=s[o];if(isNaN(c)){console.error("THREE.KeyframeTrack: Value is not a valid number.",this,o,c),t=!1;break}}return t}optimize(){let t=this.times.slice(),e=this.values.slice(),n=this.getValueSize(),s=this.getInterpolation()===Lr,r=t.length-1,a=1;for(let o=1;o<r;++o){let l=!1,c=t[o],h=t[o+1];if(c!==h&&(o!==1||c!==t[0]))if(s)l=!0;else{let u=o*n,f=u-n,p=u+n;for(let g=0;g!==n;++g){let _=e[u+g];if(_!==e[f+g]||_!==e[p+g]){l=!0;break}}}if(l){if(o!==a){t[a]=t[o];let u=o*n,f=a*n;for(let p=0;p!==n;++p)e[f+p]=e[u+p]}++a}}if(r>0){t[a]=t[r];for(let o=r*n,l=a*n,c=0;c!==n;++c)e[l+c]=e[o+c];++a}return a!==t.length?(this.times=t.slice(0,a),this.values=e.slice(0,a*n)):(this.times=t,this.values=e),this}clone(){let t=this.times.slice(),e=this.values.slice(),n=this.constructor,s=new n(this.name,t,e);return s.createInterpolant=this.createInterpolant,s}};qe.prototype.TimeBufferType=Float32Array;qe.prototype.ValueBufferType=Float32Array;qe.prototype.DefaultInterpolation=Za;$n=class extends qe{constructor(t,e,n){super(t,e,n)}};$n.prototype.ValueTypeName="bool";$n.prototype.ValueBufferType=Array;$n.prototype.DefaultInterpolation=Gs;$n.prototype.InterpolantFactoryMethodLinear=void 0;$n.prototype.InterpolantFactoryMethodSmooth=void 0;wo=class extends qe{};wo.prototype.ValueTypeName="color";Ao=class extends qe{};Ao.prototype.ValueTypeName="number";Co=class extends Pi{constructor(t,e,n,s){super(t,e,n,s)}interpolate_(t,e,n,s){let r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=(n-e)/(s-e),c=t*o;for(let h=c+o;c!==h;c+=4)An.slerpFlat(r,0,a,c-o,a,c,l);return r}},xr=class extends qe{InterpolantFactoryMethodLinear(t){return new Co(this.times,this.values,this.getValueSize(),t)}};xr.prototype.ValueTypeName="quaternion";xr.prototype.InterpolantFactoryMethodSmooth=void 0;Kn=class extends qe{constructor(t,e,n){super(t,e,n)}};Kn.prototype.ValueTypeName="string";Kn.prototype.ValueBufferType=Array;Kn.prototype.DefaultInterpolation=Gs;Kn.prototype.InterpolantFactoryMethodLinear=void 0;Kn.prototype.InterpolantFactoryMethodSmooth=void 0;Ro=class extends qe{};Ro.prototype.ValueTypeName="vector";Po=class{constructor(t,e,n){let s=this,r=!1,a=0,o=0,l,c=[];this.onStart=void 0,this.onLoad=t,this.onProgress=e,this.onError=n,this.itemStart=function(h){o++,r===!1&&s.onStart!==void 0&&s.onStart(h,a,o),r=!0},this.itemEnd=function(h){a++,s.onProgress!==void 0&&s.onProgress(h,a,o),a===o&&(r=!1,s.onLoad!==void 0&&s.onLoad())},this.itemError=function(h){s.onError!==void 0&&s.onError(h)},this.resolveURL=function(h){return l?l(h):h},this.setURLModifier=function(h){return l=h,this},this.addHandler=function(h,u){return c.push(h,u),this},this.removeHandler=function(h){let u=c.indexOf(h);return u!==-1&&c.splice(u,2),this},this.getHandler=function(h){for(let u=0,f=c.length;u<f;u+=2){let p=c[u],g=c[u+1];if(p.global&&(p.lastIndex=0),p.test(h))return g}return null}}},Ag=new Po,Io=class{constructor(t){this.manager=t!==void 0?t:Ag,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(t,e){let n=this;return new Promise(function(s,r){n.load(t,s,e,r)})}parse(){}setCrossOrigin(t){return this.crossOrigin=t,this}setWithCredentials(t){return this.withCredentials=t,this}setPath(t){return this.path=t,this}setResourcePath(t){return this.resourcePath=t,this}setRequestHeader(t){return this.requestHeader=t,this}};Io.DEFAULT_MATERIAL_NAME="__DEFAULT";vr=class{constructor(t=!0){this.autoStart=t,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=_c(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let t=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){let e=_c();t=(e-this.oldTime)/1e3,this.oldTime=e,this.elapsedTime+=t}return t}};Zo="\\[\\]\\.:\\/",Cg=new RegExp("["+Zo+"]","g"),Jo="[^"+Zo+"]",Rg="[^"+Zo.replace("\\.","")+"]",Pg=/((?:WC+[\/:])*)/.source.replace("WC",Jo),Ig=/(WCOD+)?/.source.replace("WCOD",Rg),Lg=/(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC",Jo),Dg=/\.(WC+)(?:\[(.+)\])?/.source.replace("WC",Jo),Ug=new RegExp("^"+Pg+Ig+Lg+Dg+"$"),Ng=["material","materials","bones","map"],Lo=class{constructor(t,e,n){let s=n||ne.parseTrackName(e);this._targetGroup=t,this._bindings=t.subscribe_(e,s)}getValue(t,e){this.bind();let n=this._targetGroup.nCachedObjects_,s=this._bindings[n];s!==void 0&&s.getValue(t,e)}setValue(t,e){let n=this._bindings;for(let s=this._targetGroup.nCachedObjects_,r=n.length;s!==r;++s)n[s].setValue(t,e)}bind(){let t=this._bindings;for(let e=this._targetGroup.nCachedObjects_,n=t.length;e!==n;++e)t[e].bind()}unbind(){let t=this._bindings;for(let e=this._targetGroup.nCachedObjects_,n=t.length;e!==n;++e)t[e].unbind()}},ne=class i{constructor(t,e,n){this.path=e,this.parsedPath=n||i.parseTrackName(e),this.node=i.findNode(t,this.parsedPath.nodeName),this.rootNode=t,this.getValue=this._getValue_unbound,this.setValue=this._setValue_unbound}static create(t,e,n){return t&&t.isAnimationObjectGroup?new i.Composite(t,e,n):new i(t,e,n)}static sanitizeNodeName(t){return t.replace(/\s/g,"_").replace(Cg,"")}static parseTrackName(t){let e=Ug.exec(t);if(e===null)throw new Error("PropertyBinding: Cannot parse trackName: "+t);let n={nodeName:e[2],objectName:e[3],objectIndex:e[4],propertyName:e[5],propertyIndex:e[6]},s=n.nodeName&&n.nodeName.lastIndexOf(".");if(s!==void 0&&s!==-1){let r=n.nodeName.substring(s+1);Ng.indexOf(r)!==-1&&(n.nodeName=n.nodeName.substring(0,s),n.objectName=r)}if(n.propertyName===null||n.propertyName.length===0)throw new Error("PropertyBinding: can not parse propertyName from trackName: "+t);return n}static findNode(t,e){if(e===void 0||e===""||e==="."||e===-1||e===t.name||e===t.uuid)return t;if(t.skeleton){let n=t.skeleton.getBoneByName(e);if(n!==void 0)return n}if(t.children){let n=function(r){for(let a=0;a<r.length;a++){let o=r[a];if(o.name===e||o.uuid===e)return o;let l=n(o.children);if(l)return l}return null},s=n(t.children);if(s)return s}return null}_getValue_unavailable(){}_setValue_unavailable(){}_getValue_direct(t,e){t[e]=this.targetObject[this.propertyName]}_getValue_array(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)t[e++]=n[s]}_getValue_arrayElement(t,e){t[e]=this.resolvedProperty[this.propertyIndex]}_getValue_toArray(t,e){this.resolvedProperty.toArray(t,e)}_setValue_direct(t,e){this.targetObject[this.propertyName]=t[e]}_setValue_direct_setNeedsUpdate(t,e){this.targetObject[this.propertyName]=t[e],this.targetObject.needsUpdate=!0}_setValue_direct_setMatrixWorldNeedsUpdate(t,e){this.targetObject[this.propertyName]=t[e],this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_array(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)n[s]=t[e++]}_setValue_array_setNeedsUpdate(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)n[s]=t[e++];this.targetObject.needsUpdate=!0}_setValue_array_setMatrixWorldNeedsUpdate(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)n[s]=t[e++];this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_arrayElement(t,e){this.resolvedProperty[this.propertyIndex]=t[e]}_setValue_arrayElement_setNeedsUpdate(t,e){this.resolvedProperty[this.propertyIndex]=t[e],this.targetObject.needsUpdate=!0}_setValue_arrayElement_setMatrixWorldNeedsUpdate(t,e){this.resolvedProperty[this.propertyIndex]=t[e],this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_fromArray(t,e){this.resolvedProperty.fromArray(t,e)}_setValue_fromArray_setNeedsUpdate(t,e){this.resolvedProperty.fromArray(t,e),this.targetObject.needsUpdate=!0}_setValue_fromArray_setMatrixWorldNeedsUpdate(t,e){this.resolvedProperty.fromArray(t,e),this.targetObject.matrixWorldNeedsUpdate=!0}_getValue_unbound(t,e){this.bind(),this.getValue(t,e)}_setValue_unbound(t,e){this.bind(),this.setValue(t,e)}bind(){let t=this.node,e=this.parsedPath,n=e.objectName,s=e.propertyName,r=e.propertyIndex;if(t||(t=i.findNode(this.rootNode,e.nodeName),this.node=t),this.getValue=this._getValue_unavailable,this.setValue=this._setValue_unavailable,!t){console.warn("THREE.PropertyBinding: No target node found for track: "+this.path+".");return}if(n){let c=e.objectIndex;switch(n){case"materials":if(!t.material){console.error("THREE.PropertyBinding: Can not bind to material as node does not have a material.",this);return}if(!t.material.materials){console.error("THREE.PropertyBinding: Can not bind to material.materials as node.material does not have a materials array.",this);return}t=t.material.materials;break;case"bones":if(!t.skeleton){console.error("THREE.PropertyBinding: Can not bind to bones as node does not have a skeleton.",this);return}t=t.skeleton.bones;for(let h=0;h<t.length;h++)if(t[h].name===c){c=h;break}break;case"map":if("map"in t){t=t.map;break}if(!t.material){console.error("THREE.PropertyBinding: Can not bind to material as node does not have a material.",this);return}if(!t.material.map){console.error("THREE.PropertyBinding: Can not bind to material.map as node.material does not have a map.",this);return}t=t.material.map;break;default:if(t[n]===void 0){console.error("THREE.PropertyBinding: Can not bind to objectName of node undefined.",this);return}t=t[n]}if(c!==void 0){if(t[c]===void 0){console.error("THREE.PropertyBinding: Trying to bind to objectIndex of objectName, but is undefined.",this,t);return}t=t[c]}}let a=t[s];if(a===void 0){let c=e.nodeName;console.error("THREE.PropertyBinding: Trying to update property for track: "+c+"."+s+" but it wasn't found.",t);return}let o=this.Versioning.None;this.targetObject=t,t.needsUpdate!==void 0?o=this.Versioning.NeedsUpdate:t.matrixWorldNeedsUpdate!==void 0&&(o=this.Versioning.MatrixWorldNeedsUpdate);let l=this.BindingType.Direct;if(r!==void 0){if(s==="morphTargetInfluences"){if(!t.geometry){console.error("THREE.PropertyBinding: Can not bind to morphTargetInfluences because node does not have a geometry.",this);return}if(!t.geometry.morphAttributes){console.error("THREE.PropertyBinding: Can not bind to morphTargetInfluences because node does not have a geometry.morphAttributes.",this);return}t.morphTargetDictionary[r]!==void 0&&(r=t.morphTargetDictionary[r])}l=this.BindingType.ArrayElement,this.resolvedProperty=a,this.propertyIndex=r}else a.fromArray!==void 0&&a.toArray!==void 0?(l=this.BindingType.HasFromToArray,this.resolvedProperty=a):Array.isArray(a)?(l=this.BindingType.EntireArray,this.resolvedProperty=a):this.propertyName=s;this.getValue=this.GetterByBindingType[l],this.setValue=this.SetterByBindingTypeAndVersioning[l][o]}unbind(){this.node=null,this.getValue=this._getValue_unbound,this.setValue=this._setValue_unbound}};ne.Composite=Lo;ne.prototype.BindingType={Direct:0,EntireArray:1,ArrayElement:2,HasFromToArray:3};ne.prototype.Versioning={None:0,NeedsUpdate:1,MatrixWorldNeedsUpdate:2};ne.prototype.GetterByBindingType=[ne.prototype._getValue_direct,ne.prototype._getValue_array,ne.prototype._getValue_arrayElement,ne.prototype._getValue_toArray];ne.prototype.SetterByBindingTypeAndVersioning=[[ne.prototype._setValue_direct,ne.prototype._setValue_direct_setNeedsUpdate,ne.prototype._setValue_direct_setMatrixWorldNeedsUpdate],[ne.prototype._setValue_array,ne.prototype._setValue_array_setNeedsUpdate,ne.prototype._setValue_array_setMatrixWorldNeedsUpdate],[ne.prototype._setValue_arrayElement,ne.prototype._setValue_arrayElement_setNeedsUpdate,ne.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate],[ne.prototype._setValue_fromArray,ne.prototype._setValue_fromArray_setNeedsUpdate,ne.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate]];Hg=new Float32Array(1);typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:"170"}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__="170")});var Er,$o=ze(()=>{Er={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Ui.BlurDirectionX=new at(1,0);Ui.BlurDirectionY=new at(0,1)});var $c,Kc=ze(()=>{$c={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		...
		}`}});var Rr,Qc=ze(()=>{fn();Di();Kc();Rr=class extends Pe{constructor(){super();let t=$c;this.uniforms=Rn.clone(t.uniforms),this.material=new gr({name:t.name,uniforms:this.uniforms,vertexShader:t.vertexShader,fragmentShader:t.fragmentShader}),this.fsQuad=new Pn(this.material),this._outputColorSpace=null,this._toneMapping=null}render(t,e,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=t.toneMappingExposure,(this._outputColorSpace!==t.outputColorSpace||this._toneMapping!==t.toneMapping)&&(this._outputColorSpace=t.outputColorSpace,this._toneMapping=t.toneMapping,this.material.defines={},Xt.getTransfer(this._outputColorSpace)===$t&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===Do?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===Uo?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===No?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Fo?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===Oo?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===Bo&&(this.material.defines.NEUTRAL_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(t.setRenderTarget(null),this.fsQuad.render(t)):(t.setRenderTarget(e),this.clear&&t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil),this.fsQuad.render(t))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}});var Vg=ih(()=>{fn();Xc();qc();Jc();Qc();var jc=(i,t=0,e=1)=>Math.max(t,Math.min(e,i)),zg=[1,.82,1,.68,1,.9,.62,1],jo=(i,t,e)=>i+(t-i)*e;function tl(i,t){let e;try{e=new nr({canvas:i,antialias:!0,powerPreference:"high-performance"}),e.debug.checkShaderErrors=!1}catch{return null}if(!e.getContext())return null;let{polys:n,boundary:s,dots:r,W:a,H:o,ramp:l,danube:c=[]}=t,h=4e3,u=a/2,f=o/2,p=O=>(O-u)*h,g=O=>(O-f)*h,_=new sr;_.background=new Ot(329487);let m=o*h*.94;_.fog=new ir(329487,m*1.6,m*4.4);let d=new Me(38,1,h*.01,m*6);{let O=new Ci(a*h*4,o*h*4),U=new Ne({color:329487}),$=new he(O,U);$.rotation.x=-Math.PI/2,$.position.y=-2,_.add($)}{let O=new Zn(s.map(([Pt,X])=>new at(p(Pt),-g(X)))),U=new mr(O);U.rotateX(-Math.PI/2);let $=new Ne({color:790559}),et=new he(U,$);et.position.y=-1,_.add(et);let ct=new ce().setFromPoints(s.map(([Pt,X])=>new I(p(Pt),.5,g(X)))),_t=new Ri(ct,new Yn({color:4015464,transparent:!0,opacity:0}));_.add(_t),tl.boundLine=_t}{let O=a*h*.006;for(let U of c){if(U.length<2)continue;let $=[];for(let _t=0;_t<U.length;_t++){let[Pt,X]=U[_t],[q,lt]=U[Math.min(_t+1,U.length-1)],[it,Et]=U[Math.max(_t-1,0)],It=p(q)-p(it),Lt=g(lt)-g(Et),Gt=Math.hypot(It,Lt)||1;It/=Gt,Lt/=Gt;let K=-Lt*O,st=It*O;$.push(p(Pt)+K,.4,g(X)+st,p(Pt)-K,.4,g(X)-st)}let et=[];for(let _t=0;_t<U.length-1;_t++){let Pt=_t*2;et.push(Pt,Pt+1,Pt+2,Pt+1,Pt+3,Pt+2)}let ct=new ce;ct.setAttribute("position",new Se(new Float32Array($),3)),ct.setIndex(et),_.add(new he(ct,new Ne({color:2768504,transparent:!0,opacity:.95,depthWrite:!1,side:Ge})))}}let T;{let O=new Float32Array(r.length*3);r.forEach(($,et)=>{O[et*3]=p($.x),O[et*3+1]=1.5,O[et*3+2]=g($.y)});let U=new ce;U.setAttribute("position",new Se(O,3)),T=new ts({color:16771512,size:2.4,sizeAttenuation:!1,transparent:!0,opacity:0,depthWrite:!1}),_.add(new or(U,T))}let b=[],M=o*h*.006;for(let O of n){let U=O.pts.map(([ct,_t])=>new at(p(ct),-g(_t))),$=null,et=null;try{let ct=new Zn(U),_t=new fr(ct,{depth:M,bevelEnabled:!1});_t.rotateX(-Math.PI/2);let Pt=new Ne({transparent:!0,opacity:.5,depthWrite:!1});$=new he(_t,Pt),_.add($);let X=new ce().setFromPoints(O.pts.map(([q,lt])=>new I(p(q),M+.6,g(lt))));if($.userData.edge=new Ri(X,new Yn({color:16774883,transparent:!0,opacity:0,depthWrite:!1})),_.add($.userData.edge),O.own==="private"){let q=O.pts.map(([Et,It])=>new I(p(Et),M+1,g(It))),lt=new ce().setFromPoints(q),it=new _r({color:16771512,dashSize:h*.002,gapSize:h*.0012,transparent:!0,opacity:0});et=new Ri(lt,it),et.computeLineDistances(),_.add(et)}}catch{}b.push({mesh:$,dash:et,t:O.t,phase:O.phase,big:O.big,cx:O.cx,cy:O.cy,col:new Ot,prevS:0})}function B(O,U){let $=jc(O)*3,et=Math.min(2,Math.floor($)),ct=$-et,_t=l[et],Pt=l[et+1];return U.setRGB(jo(_t[0],Pt[0],ct)/255,jo(_t[1],Pt[1],ct)/255,jo(_t[2],Pt[2],ct)/255),U}let C=[];{let O=new pr(.86,1,40);O.rotateX(-Math.PI/2);for(let U=0;U<18;U++){let $=new he(O,new Ne({color:16771512,transparent:!0,opacity:0,depthWrite:!1}));$.visible=!1,$.position.y=M+1,_.add($),C.push({m:$,t0:-1})}}let R=0;function N(O,U,$){let et=C[R++%C.length];et.t0=$,et.m.position.x=O,et.m.position.z=U,et.m.visible=!0}let E=new Ar(e);E.addPass(new Cr(_,d));let y=new Ui(new at(2,2),.42,.4,.74);E.addPass(y),E.addPass(new Rr);let A=2,J=2;function k(O,U,$){A=O,J=U,e.setPixelRatio(Math.min($||1,1.5)),e.setSize(O,U,!1),E.setSize(O,U),d.aspect=O/U,d.updateProjectionMatrix()}let H=new I;function j(O,U){return H.set(p(O),M+2,g(U)).project(d),{x:(H.x*.5+.5)*A,y:(-H.y*.5+.5)*J,vis:H.z<1}}function G(O){let U=O.wave<=0?0:O.wave>=1?1:O.wave*O.wave*(3-2*O.wave),$=O.smx*.11+Math.sin(O.t*4e-5)*.022+U*.6,et=Lc.degToRad(53-36*U)-O.smy*.07,ct=m/O.camZ*(1-.2*U),_t=-O.camX*a*h*.9,Pt=-O.camY*o*h*.9;d.position.set(_t+Math.sin($)*ct*Math.cos(et),Math.sin(et)*ct,Pt+Math.cos($)*ct*Math.cos(et)),d.lookAt(_t,0,Pt),T.opacity=O.ctxA*.55,tl.boundLine.material.opacity=.25+O.ctxA*.5;let X=0;for(let q of b){let lt=jc((O.wave*1.5-q.t)*2.6);if(lt>.55&&X++,!q.mesh)continue;let it=lt<.15?.5+.28*Math.sin(O.t*.00157+q.phase):1,Et=lt>.2&&lt<.55?zg[Math.floor((O.t+q.phase*875)%5500/5500*8)]:1;B(lt,q.col);let It=q.mesh.userData.edge.material;It.color.copy(q.col).multiplyScalar(1.35),It.opacity=lt*.9,q.col.multiplyScalar(.52+lt*.5+Math.max(0,lt-.82)*2.4),q.mesh.material.color.copy(q.col),q.mesh.material.opacity=Math.min(1,(.62+lt*.38)*it*Et*O.hb),q.dash&&(q.dash.material.opacity=(lt<.2?O.own:0)*.95),lt>=.5&&q.prevS<.5&&O.wave>0&&O.wave<1&&N(p(q.cx),g(q.cy),O.t),q.prevS=lt}for(let q of C){if(q.t0<0)continue;let lt=(O.t-q.t0)/950;if(lt>=1){q.m.visible=!1,q.t0=-1;continue}let it=a*h*(.012+lt*.05);q.m.scale.set(it,1,it),q.m.material.opacity=(1-lt)*(1-lt)*.55}return E.render(),X}return{frame:G,project:j,resize:k}}window.ZazniGL={init:tl}});Vg();})();
